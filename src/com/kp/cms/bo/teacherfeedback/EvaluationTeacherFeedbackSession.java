...
public class EvaluationTeacherFeedbackSession implements Serializable {
	private int id;
	private String name;
	...
	public EvaluationTeacherFeedbackSession() {
		super();
	}
	public EvaluationTeacherFeedbackSession(int id, String name, String month,
