...
public class Fee implements java.io.Serializable {
	...
	private String courseSemNo;
	private boolean isCourseSemesterWise;
	...
	public Fee(int id, ProgramType programType, String createdBy,
			...
			Set<FeeTransaction> feeTransactions, Set<FeeDetails> feeDetailses, String aidedUnaided,String courseSemNo,boolean isCourseSemesterWise) {
		this.id = id;
		...
		this.courseSemNo = courseSemNo;
		this.isCourseSemesterWise = isCourseSemesterWise;
	}
	...
	public String getCourseSemNo() {
		return courseSemNo;
	}

	public void setCourseSemNo(String courseSemNo) {
		this.courseSemNo = courseSemNo;
	}

	public boolean getIsCourseSemesterWise() {
		return isCourseSemesterWise;
	}

	public void setIsCourseSemesterWise(boolean isCourseSemesterWise) {
		this.isCourseSemesterWise = isCourseSemesterWise;
	}
