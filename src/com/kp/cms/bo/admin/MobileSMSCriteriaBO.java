...
public class MobileSMSCriteriaBO implements  java.io.Serializable{
	...
	private String year;
	public MobileSMSCriteriaBO()
	{
		
	}
	public MobileSMSCriteriaBO(int id,ClassSchemewise classSchemewise,String smsTime,Boolean isSmsBlocked
