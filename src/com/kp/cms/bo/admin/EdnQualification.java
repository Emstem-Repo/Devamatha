...
/**
 * EdnQualification generated by hbm2java
 */
public class EdnQualification implements java.io.Serializable {
	...
	private Set<EdnSemesterMarks> ednSemesterMarkses = new HashSet<EdnSemesterMarks>(0);
	private Set<ApplicantMarksDetails> applicantMarksDetailses = new HashSet<ApplicantMarksDetails>(0);
	private Set<CandidateMarks> candidateMarkses = new HashSet<CandidateMarks>(0);
	
	private Set<AdmSubjectMarkForRank> admSubjectMarkForRank = new HashSet<AdmSubjectMarkForRank>(0);
	private String ugPattern;
	
	public EdnQualification() {
	}

	public EdnQualification(int id) {
		this.id = id;
	}

	
	
	public EdnQualification(int id, String createdBy,
			DocChecklist docChecklist, String modifiedBy,
			PersonalData personalData, College college, Integer noOfAttempts,
			Integer yearPassing, Integer monthPassing,
			BigDecimal marks, BigDecimal percentage,
			University university, Date createdDate, Date lastModifiedDate,
			BigDecimal totalMarks, String institutionNameOthers,
			String previousRegNo, String universityOthers,
			BigDecimal weightageAdjustedMarks, State state,
			Boolean isOutsideIndia, DocTypeExams docTypeExams,
			Set<EdnSemesterMarks> ednSemesterMarkses,
			Set<ApplicantMarksDetails> applicantMarksDetailses,
			Set<CandidateMarks> candidateMarkses,
			Set<AdmSubjectMarkForRank> admSubjectMarkForRank, String ugPattern) {
		super();
		this.id = id;
		...
		this.admSubjectMarkForRank = admSubjectMarkForRank;
	...
	public Set<AdmSubjectMarkForRank> getAdmSubjectMarkForRank() {
		return admSubjectMarkForRank;
	}

	public void setAdmSubjectMarkForRank(
			Set<AdmSubjectMarkForRank> admSubjectMarkForRank) {
		this.admSubjectMarkForRank = admSubjectMarkForRank;
	}
