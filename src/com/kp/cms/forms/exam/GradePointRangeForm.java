...
public class GradePointRangeForm extends BaseActionForm {
	private int id = 0;
	...
	private List<GradePointRangeTO> listGradeDefinition;
	private List<AcademicYearTO> appliedYearList;
	private List<GradePointRangeTO> courseListForGradeDefinition;
	...
	public List<GradePointRangeTO> getListGradeDefinition() {
		return listGradeDefinition;
	}

	public void setListGradeDefinition(
			List<GradePointRangeTO> listGradeDefinition) {
	...
	public List<AcademicYearTO> getAppliedYearList() {
		return appliedYearList;
	}

	public void setAppliedYearList(List<AcademicYearTO> appliedYearList) {
		this.appliedYearList = appliedYearList;
	}
	...
	public List<GradePointRangeTO> getCourseListForGradeDefinition() {
		return courseListForGradeDefinition;
	}

	public void setCourseListForGradeDefinition(
			List<GradePointRangeTO> courseListForGradeDefinition) {
		this.courseListForGradeDefinition = courseListForGradeDefinition;
	}
