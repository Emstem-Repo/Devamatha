...
function cancelAction(){
	document.location.href="newSupplementaryImpApp.do?method=checkSupplementaryImpApplicationForStudentLogin";
		}
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader">Supplementary Application </strong></div>
					</td>
					...
					<table width="70%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<tr>
									...
									<bean:write name="newSupplementaryImpApplicationForm" property="nameOfStudent"/>
									</td>
								</tr>
								<tr>
									...
									<bean:write name="newSupplementaryImpApplicationForm" property="regNo"/>
									</td>
								</tr>
								<tr>
								<td class="studentrow-odd" align="right">
									...
									<td class="studentrow-even">
									<bean:write name="newSupplementaryImpApplicationForm" property="className"/>
									</td>
								</tr>
								<tr>
									<td class="studentrow-odd" align="right" width="50%" >
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2" align="center">
								...
								<tr>
									...
									<td class="studentrow-even" width="50%">
									<html:text name="newSupplementaryImpApplicationForm" property="dob" styleId="dob" size="10" maxlength="16"/>
								...
								<tr>
									...
									<td class="studentrow-even" width="50%">XXXXXXXXXXXXXX
										<html:text name="newSupplementaryImpApplicationForm" property="smartCardNo" styleId="smartCardNo" size="5" maxlength="5"></html:text>									
									</td>
								</tr>
								<tr>
									<td class="studentrow-odd" align="right" width="50%">
									...
									<td class="studentrow-even" width="50%">
										<html:text name="newSupplementaryImpApplicationForm" property="validThruMonth" styleId="validThruMonth" size="2" maxlength="2" onkeypress="return isNumberKey(event)"></html:text> /
										<html:text name="newSupplementaryImpApplicationForm" property="validThruYear" styleId="validThruYear" size="2" maxlength="2" onkeypress="return isNumberKey(event)"></html:text>
										&nbsp;&nbsp; mm/yy
									</td>
								</tr>
							</table>
