...
<html:form action="/StudentLoginAction">
	...
	<html:hidden property="method" styleId="method" value="displayInternalMarkForStudentGrievance" />
					...
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<tr class="data">
									<td height="20" class="studentrow-odd" width="50%"  align="left"><div id="dataRegularLabel">
										<span class="Mandatory">*</span>Internal Exam List	</div></td>
									<td height="25" class="studentrow-even" width="50%" ><div id="dataRegular">
										<html:select property="internalExamId" styleId="internalExamId" name="loginform">
											<html:option value=""><bean:message key="knowledgepro.select"/></html:option>
												<logic:notEmpty property="regularExamList" name="loginform">
											  		<html:optionsCollection property="regularExamList" label="examName" value="examId" name="loginform"/>
											   </logic:notEmpty>
										 </html:select> </div>
						...
						<%-- 		 <tr class="data">
									<td height="20" class="studentrow-odd" width="50%" ><div id="dataSuppLabel" align="left">
										<span class="Mandatory">*</span>Supplementary Exam List</div></td>
