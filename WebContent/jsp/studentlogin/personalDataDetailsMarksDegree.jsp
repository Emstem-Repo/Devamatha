...
<table width="80%" style="background-color: #F0F8FF" align="center">
  ...
  <tr>
    <td>     <table width="100%" height="347"  border="0" cellpadding="0" cellspacing="0">
             ...
             <tr> <td  width="20%"> </td><td height="25" colspan="5" >
             1. Single main candidates need to enter the mark/grade obtained for the
				Core One subject in the space provided for Core 1.
             </td></tr>
             <tr> <td  width="20%"> </td><td height="25" colspan="5" >
			 2. Double main candidates must enter the marks/grades obtained for the
				Core Two subjects in the space for Core 1 and 2.
			  </td></tr>
			 <tr> <td  width="20%"> </td><td height="25" colspan="5" >
			 3. Triple main students are required to enter their marks/grades
				obtained for the Core Three subject in the space provided for Core 1,2 and 3.
			  </td></tr>
			 <tr> <td  width="20%"> </td><td height="25" colspan="5" >
			 4. Cadidates with Single Complementary Subject should enter their
				MARK/GRADE in the space provided for Complementary 1 only.
			  </td></tr>
             ...
             <tr> <td height="5" colspan="6" align="center"><h3><font color="blue">Choose the pattern which you studied for UnderGraduate program</font></h3></td>
              ...
              <tr>
                        ...
                        <td width="33%" class="heading" colspan="2" id="CBCSS" align="right">
			             ...
			             <html:radio styleId="CBCSSRadio" property="patternofStudy" name="loginform" value="CBCSS"></html:radio>
                         <label for="CBCSSRadio"><span><span></span></span>CBCSS Pattern(Max grade point 4)</label> 
			             </fieldset>
                        </td>
                        
                         <td width="33%" class="heading" colspan="2" id="CBCSSNEW" align="center">
                         <fieldset style="border: 0px">
			             <html:radio styleId="CBCSSNEWRadio" property="patternofStudy" name="loginform" value="CBCSS NEW"></html:radio>
                         <label for="CBCSSNEWRadio"><span><span></span></span>CBCSS NEW Pattern</label> 
			             </fieldset>
                        </td>
                        
                         <td width="33%" class="heading" id="OTHER" colspan="2" >
                         <fieldset style="border: 0px">
			             <html:radio styleId="OTHERRadio" property="patternofStudy" name="loginform" value="OTHER"></html:radio>
                         <label for="OTHERRadio"><span><span></span></span>Pre CBCSS Pattern(Based on marks)</label> 
			             </fieldset>
                         </td>
              ...
              <tr class="CBCSS">
                   ...
                   <table width="100%" cellspacing="1" cellpadding="2">
                     ...
                     <tr >
						<td class="row-odd" width="25%"><bean:message key="admissionForm.detailmark.slno.label"/></td>
						
						<td class="row-odd" width="25%" ><div align="center"><bean:message key="knowledgepro.admin.subject.subject.name.disp"/> </div></td>
 						<td height="25" class="row-odd" width="20%"><div align="center">Obtained Grade Point</div></td>
						<td height="25" class="row-odd" width="20%"><div align="center">Max Grade Point</div></td>
					...
					%>
                     ...
                     <%if(i<=3){%>
						...
						<td  class="row-even" >
						<nested:select property="<%=propertyName%>"  name="loginform" styleId='<%=propertyName%>' styleClass="combolarge" onchange='<%="dupsub("+i+");"%>' >
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admCoreMap" name="loginform" label="value" value="key"/>
						...
						<html:text name="loginform" property="<%=obtainMarkprop %>" size="6" maxlength="6" styleId='<%=obtainMarkprop %>' onblur='<%=dynajs%>'></html:text>
						</td>
						<td class="row-even" align="center">
						<html:text name="loginform" property="<%=totalMarkprop %>" size="6" maxlength="6" styleId='<%=totalMarkprop %>' onblur='<%=dynajs%>'></html:text>
						</td>	
						<td class="row-even" align="center">
						<html:text name="loginform" property="<%=degmaxcgpa %>" size="6" maxlength="6" styleId='<%=degmaxcgpa %>' onblur='<%=dynajs%>'></html:text>
						</td>	
						...
						<td  class="row-even" >
						<nested:select property="<%=propertyName%>"  name="loginform" styleId='<%=propertyName%>' onchange='<%="displayOtherForSubject("+i+");"+"dupsub("+i+");" %>' styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admComplMap" name="loginform" label="value" value="key"/>
						   					
						</nested:select>
						 
						<br/>
						<nested:notEmpty property="<%=propertyOtherName%>" name="loginform">
						   						
								 <div id="<%=propertyOtherNameDisplay%>" style="display: block;">
								 <html:text property="<%=propertyOtherName %>" styleId='<%=propertyOtherName %>' name="loginform" size="10" maxlength="20"></html:text>
								 </div>
						</nested:notEmpty>
						<nested:empty property="<%=propertyOtherName%>" name="loginform">
						...
						<td  class="row-even" >
						<nested:select disabled="false" property="<%=propertyName%>"  name="loginform" styleId='<%=propertyName%>' onchange='<%="displayOtherForSubject("+i+")" %>' styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admCommonMap" name="loginform" label="value" value="key"/>
						...
						<nested:select property="<%=propertyName%>"  name="loginform" styleId='<%=propertyName%>' onchange='<%="displayOtherForSubject("+i+");"+"dupsub("+i+");" %>' styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admSubMap" name="loginform" label="value" value="key"/>
						...
						<nested:select property="<%=propertyName%>"  name="loginform" styleId='<%=propertyName%>' onchange='<%="displayOtherForSubject("+i+");"+"dupsub("+i+");" %>' styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admMainMap" name="loginform" label="value" value="key"/>
					...
					<tr>
						...
						&nbsp;OBTAINED CGPA:
						<html:text name="loginform" property="detailMark.totalObtainedMarksCGPA" size="7" maxlength="7" styleId="totalObtainedMarksCGPA" onblur='<%="checkObtainedCbcssMarks("+CMSConstants.MAX_CANDIDATE_DEGREE_CBCSS_SUBJECTS+");" %>'></html:text>
						&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
						MAX CGPA:
						<html:text name="loginform" property="detailMark.totalMarksCGPA" size="7" maxlength="7" styleId="totalMarksCGPA" onblur='<%="checkObtainedCbcssMarks("+CMSConstants.MAX_CANDIDATE_DEGREE_CBCSS_SUBJECTS+");" %>'></html:text>
                   ...
                   <table width="100%" cellspacing="1" cellpadding="2">
					...
					%>
                     ...
                     <%if(i<=13){%>
                         ...
                         <td  class="row-even" > <%=totalCount %>&nbsp;&nbsp;&nbsp;Main <%=mainCount%>
                          
                         </td>
                        <%-- 
						 <td  class="row-even" >
						<logic:notEmpty property="<%=propertyName %>" name="loginform">
								<logic:equal value="true" property="<%=dynaMandatory %>" name="loginform">
							 	<span class="Mandatory">*</span><bean:write property="<%=propertyName %>" name="loginform" ></bean:write>
								</logic:equal>
								<logic:equal value="false" property="<%=dynaMandatory %>" name="loginform">
									<html:text property="<%=propertyName %>" styleId='<%=propertyName %>' name="loginform" size="10" maxlength="20"></html:text>
								</logic:equal>
							</logic:notEmpty>
							<logic:empty property="<%=propertyName %>" name="loginform">
							 	<html:text property="<%=propertyName %>" styleId='<%=propertyName %>' name="loginform" size="10" maxlength="20"></html:text>
							</logic:empty>
						</td>
						--%>
						...
						<td  class="row-even" >
						<nested:select property="<%=propertyName%>"  name="loginform" styleId='<%=propertyName%>'  styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admCoreMap" name="loginform" label="value" value="key"/>
						...
						<td class="row-even" align="center">
						<html:text name="loginform" property="<%=obtainMarkprop %>" size="6" maxlength="6" styleId='<%=obtainMarkprop %>' onblur='<%=dynajs2%>'></html:text>
						</td>
						<td class="row-even" align="center">
						<html:text name="loginform" property="<%=totalMarkprop %>" size="6" maxlength="6" styleId='<%=totalMarkprop %>' onblur='<%=dynajs%>'></html:text>
						</td>	
						...
						<td  class="row-even" > <%=totalCount %>&nbsp;&nbsp;&nbsp;Sub <%=subCount%>
						...
						<td  class="row-even" >
						<nested:select disabled="true" property="<%=propertyName%>"  name="loginform" styleId='<%=propertyName%>' onchange='<%="displayOtherForSubject("+i+")" %>' styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admCommonMap" name="loginform" label="value" value="key"/>
					...
					<tr>
						...
						<td class="row-even" align="center">
						<html:text name="loginform" property="detailMark.totalObtainedMarks" size="6" maxlength="6"  styleId="ObtainedMark" readonly="true"></html:text>
						</td>
						<td class="row-even" align="center">
						<html:text name="loginform" property="detailMark.totalMarks" size="6" maxlength="6"  styleId="totalMark" readonly="true"></html:text>
						</td>
