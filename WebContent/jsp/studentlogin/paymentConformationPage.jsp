...
<table width="80%" style="background-color: #F0F8FF" align="center">
  ...
  <tr >
	<td  align="center">
     ...
     <logic:equal value="true" name="loginform" property="paymentSuccess">
      <tr>
     <td>
    <table width="100%"  align="center" cellpadding="4" class="subtable w"  >
            ...
            <tr>
             ...
             <tr>
                      ...
                      <td width="50%" height="30" ><div align="left">
                      <bean:write name="loginform" property="txnRefNo" />
                      </div></td>
             </tr>
             ...
             <tr>
                      ...
                      <td width="50%" height="30" ><div align="left">
                      <bean:write name="loginform" property="txnDate" />
                      </div></td>
             </tr>
     ...
     <logic:equal value="false" name="loginform" property="paymentSuccess">
            
     <logic:equal value="Online" name="loginform" property="mode">
