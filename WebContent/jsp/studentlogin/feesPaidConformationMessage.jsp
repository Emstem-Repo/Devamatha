...
<table width="80%" style="background-color: #F0F8FF" align="center">
  ...
  <tr >
    ...
    <table width="100%"  align="center" cellpadding="4" class="subtable w"  >
            ...
            <tr>
            <td colspan="2" height="30" height="25" class="pay"><div align="center"><b><font color="red">Candidate Already Paid Fees !!</b> </div></td>
            </tr>
     ...
     <tr>
  		   <td  width="100%" align="center">
   		   <html:button property="" onclick="cancel()" styleClass="cancelbtn" value="back"></html:button>
   		   </td>
 		   </tr>
