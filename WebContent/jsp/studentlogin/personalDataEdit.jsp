...
<script type="text/javascript">
	...
	function detailSubmitClass12()
	{
		document.loginform.method.value="initDetailMarkConfirmPageClass12";
		document.loginform.submit();
	}
	function detailSubmitDegree()
	{
		document.loginform.method.value="initDetailMarkConfirmPageDegree";
		document.loginform.submit();
	}
</script>
	...
	<div class="panel-body">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h1 class="panel-title">Edit Personal Details	</h1>
			</div>
		</div>
		<div class="col-sm-12"
			...
			<div class="form-group">
				<div class="col-sm-12">
					<%-- <logic:equal value="false" property="PDataEdited"
									name="loginform"> --%>
            ...
            <td colspan="2" width="50%" align="right">
             <img src='<%=request.getContextPath()+"/PhotoServlet?"%>' alt=""
				onerror='onImgError(this);' onLoad='setDefaultImage(this);' height="100" width="100" align="top"/>
             </td>
            <%--  <td colspan="2" width="50%" valign="middle" align="left"><html:file property="studentPhoto" styleId="editDocument"></html:file></td> --%>
												...
												<tr>
													...
													<td width="25%" valign="top"><nested:text
															readonly="false" property="personalData.firstName"
															styleId="firstNameId" name="loginform" maxlength="90"
													...
													<td width="25%"><input type="hidden" id="BGType"
														...
														<nested:select property="personalData.bloodGroup"
												...
												<tr>
													...
													<td width="25%" align="right"><bean:message
															key="knowledgepro.admission.admission.number" /><span
														class="Mandatory">*</span></td>
													<td width="25%" valign="top"><nested:text
															readonly="false" property="applicantDetails.admissionNumber"
															styleId="firstNameId" name="loginform" maxlength="90"
															styleClass="textbox"></nested:text></td>


													<td width="25%" align="right"><bean:message
															key="knowledgepro.admin.admitted.through" /><span
														class="Mandatory">*</span></td>
													<td width="25%">
												...
												<tr>
													<td align="right"><bean:message
														...
														class="Mandatory">*</span></td>
													<td><nested:text readonly="false" name="loginform"
													...
													<td><div align="left">
															...
															<nested:select property="personalData.residentCategory"
																name="loginform" styleClass="dropdown"
																styleId="residentCategory" disabled="false">
												...
												<tr>
													...
													<td>
														<fieldset style="border: 0px">
															...
															<nested:radio disabled="false"
																property="personalData.gender" styleId="MALE"
																name="loginform" value="MALE"></nested:radio>
															<label for="MALE"><span><span></span></span>
															<bean:message
																	key="admissionForm.studentinfo.sex.male.text" /></label>


															<nested:radio disabled="false"
																property="personalData.gender" name="loginform"
																styleId="FEMALE" value="FEMALE"></nested:radio>
															<label for="FEMALE"><span><span></span></span>
															<bean:message
																	key="admissionForm.studentinfo.sex.female.text" /></label>
														</fieldset>
														<fieldset style="border: 0px">
															<nested:radio disabled="true"
																property="personalData.gender" name="loginform"
																styleId="Trans Gender" value="TRANS GENDER"></nested:radio>
													...
													<td>
														<div align="left">
															...
															<nested:select property="personalData.nationality"
																styleClass="dropdown" styleId="nationality"
																name="loginform">
																<option value=""><bean:message
																		key="knowledgepro.admin.select" /></option>
																<%
																...
																<logic:iterate id="option" property="nationalities"
																	name="loginform">
																	<logic:empty property="personalData.nationality" name="loginform">
																	<logic:equal
																	...
																	<logic:notEqual
																		...
																		%>
               														   		...
               														   		<script >
               														   			var sl='<bean:write name="loginform" property="personalData.nationality"/>';
												...
												<tr>
													...
													<td><nested:text styleClass="textboxsmall" style="width:50px;"
															property="personalData.phNo2" name="loginform"
															styleId="applicantphNo2" maxlength="7" size="7"
															onkeypress="return isNumberKey(event)" /> <nested:text style="width:150px;"
													...
													<td>
														<div align="left">
															...
															<nested:select property="personalData.birthCountry"
																name="loginform" styleClass="dropdown"
												...
												<tr>
													...
													<td><nested:text styleClass="textboxsmall"
															property="personalData.mobileNo1" style="width:50px;" value="91" name="loginform"
															styleId="applicantMobileCode" maxlength="4" size="4"
															onkeypress="return isNumberKey(event)"></nested:text> <nested:text
															styleClass="textboxmedium" style="width:150px;"
															property="personalData.mobileNo2" name="loginform"
															styleId="applicantMobileNo" maxlength="10" size="10"
													...
													<td>
														...
														<div align="left">
															...
															<nested:select property="personalData.birthState"
																name="loginform" styleId="birthState"
																styleClass="dropdown"
														...
														<div align="left">
															<nested:text property="personalData.stateOthers"
																...
																styleId="otherBirthState" style="<%=dynaStyle%>"
												...
												<tr>
													<td align="right"><bean:message
														...
														class="Mandatory">*</span></td>
													<td><div align="left">
															<nested:text property="personalData.email"
													...
													<td align="right"><bean:message
														...
														class="Mandatory">*</span></td>
													<td><nested:text property="personalData.birthPlace"
												...
												<tr>
													...
													<td><nested:text
															property="personalData.aadhaarCardNumber"
													...
													<td><nested:select
															property="personalData.motherTongueId"
												...
												<tr>
													...
													<td width="25%"><nested:text
															property="personalData.currentAddressLine1"
													...
													<td width="25%">
														<div align="left">
															...
															<nested:select property="personalData.currentCountryId"
																name="loginform" styleClass="dropdown"
												...
												<tr>
													<td align="right">Post Office Name:<span
														class="Mandatory">*</span></td>
													<td><nested:text
															property="personalData.currentAddressLine2"
													...
													<td>
														<div align="left">
															...
															<nested:select property="personalData.currentStateId"
																name="loginform" styleClass="dropdown"
														...
														<div align="left">
															<nested:text
																property="personalData.currentAddressStateOthers"
												...
												<tr>
													...
													<td><nested:text property="personalData.currentStreet"
															styleId="currentStreet" styleClass="textbox"
															name="loginform" maxlength="30"
															onkeypress="IsAlpha(event)"></nested:text></td>
													...
													<td><logic:equal value="Other"
														...
														<div align="left">
															<nested:text
																property="personalData.currentAddressDistrictOthers"
												...
												<tr>
													...
													<td><nested:text
															property="personalData.currentCityName"
													...
													<td><nested:text styleClass="textbox"
												...
												<tr>
													<td height="30" align="center" class="subheading"
														colspan="4"><bean:message
															key="knowledgepro.applicationform.sameaddr.label" />
														&nbsp;

														<fieldset style="border: 0px">
															<html:radio property="sameTempAddr" styleId="sameAddr"
																value="true" onclick="disableTempAddress();"></html:radio>
															<label for="sameAddr"><span><span></span></span>
															<bean:message
																	key="knowledgepro.applicationform.yes.label" /></label>


															<html:radio property="sameTempAddr" styleId="DiffAddr"
																value="false" onclick="enableTempAddress();"></html:radio>
															<label for="DiffAddr"><span><span></span></span>
													...
													<td colspan="4" width="100%"><div id="currTable">
															<table align="center" cellpadding="4" class="subtable"
																...
																<tr>
																	...
																	<td align="right" width="25%">House Name/House
																	...
																	<td width="25%">
																		<div align="left">
																			...
																			<nested:select
																				property="personalData.permanentCountryId"
																				name="loginform" styleClass="dropdown"
																				styleId="permanentCountryName"
																...
																<tr>
																	...
																	<td><input type="hidden" id="permanentState"
																		...
																		<logic:equal value="Other"
																			property="personalData.permanentStateId"
																			name="loginform">
																			<%
																				dynaStyle = "display:block;";
																			%>
												...
												<tr>
													<td width="100%" colspan="4"><table width="100%"
															...
															<tr>
																...
																<td width="25%"><div align="left">
																		<nested:select property="personalData.titleOfFather"
																			...
																			styleClass="dropdownsmall" style="width:50px;"
																		...
																		<nested:text property="personalData.fatherName"
																			styleId="fatherName" name="loginform" style="width:150px;"
																...
																<td width="25%"><div align="left">
																		...
																		<nested:text property="personalData.motherName"
																			styleId="motherName" name="loginform" style="width:150px;"
																			styleClass="textboxmedium" maxlength="50"
																			onkeypress="IsAlphaDot(event)"></nested:text>
															...
															<tr>
																...
																<logic:equal value="Other"
																	property="personalData.fatherOccupationId"
																	name="loginform">
																	<%
																		dynaStyle = "display:block;";
																	%>
																...
																<td width="25%">
																	...
																	<div align="left">
																		...
																		<nested:select
																			property="personalData.fatherOccupationId"
																			name="loginform" styleClass="dropdown"
																			styleId="fatherOccupation"
																			onchange="funcOtherShowHide('fatherOccupation','otherOccupationFather')">
																			<html:option value="">- Select -</html:option>
																			<html:optionsCollection name="loginform"
																	...
																	<div align="left" id="displayFatherOccupation">
																		...
																		<nested:text
																			property="personalData.otherOccupationFather"
																			name="loginform" styleClass="textbox" maxlength="50"
																			styleId="otherOccupationFather" style="<%=dynaStyle %>"/>
																	</div>
																</td>

																<logic:equal value="Other"
																	property="personalData.motherOccupationId"
																	name="loginform">
																	<%
																		dynaStyle = "display:block;";
																	%>
																...
																<td width="25%">
																	...
																	<div align="left">
																		<nested:select
																			...
																			onchange="funcOtherShowHide('motherOccupation','otherOccupationMother')">
																			<html:option value="">- Select -</html:option>
																			<html:optionsCollection name="loginform"
																				property="occupations" label="occupationName"
																				value="occupationId" />
																	...
																	<div align="left" id="displayMotherOccupation">
																		...
																		<nested:text
																			property="personalData.otherOccupationMother"
																			name="loginform" styleClass="textbox" maxlength="50"
																			styleId="otherOccupationMother" style="<%=dynaStyle %>" />
																	</div>
															...
															<tr>
																...
																<td><div align="left">
																		<nested:select style="display:none"
																			property="personalData.fatherCurrencyId"
																			name="loginform" styleId="fatherCurrency">
																...
																<td align="left"><nested:text readonly="false"
																		styleId="motherMobile" style="width:50px;"
																		property="personalData.parentMob1" value="91" name="loginform"
																		size="4" maxlength="4" styleClass="textboxsmall"
																		onkeypress="return isNumberKey(event)"></nested:text>
																	<nested:text styleId="motherMobile1" style="width:150px;"
															...
															<tr>
																...
																<td align="left"><nested:text readonly="false"
																		styleId="fatherMobile" style="width:50px;"
																		property="personalData.parentMob1" value="91" name="loginform"
																		size="4" maxlength="4" styleClass="textboxsmall"
																		onkeypress="return isNumberKey(event)"></nested:text>
																	<nested:text styleId="fatherMobile1" style="width:150px;"
																...
																<td>
																	<div align="left">
																		<nested:text property="personalData.motherEmail"
															...
															<tr>
																...
																<td>
																	<div align="left">
																		<nested:text property="personalData.fatherEmail"
															...
															<tr>
																<td width="25%" align="right">Aadhaar Card Number :
																</td>
																<td width="25%">
																	<div align="left">
																		<nested:text
																			property="personalData.fatherAadhaarNumber"
														...
														<table align="center" width="100%" border="0"
															...
															<tr>
																<td height="30" align="center" class="subheading">
																	...
																	<fieldset style="border: 0px">
																		<html:radio property="sameParentAddr"
													...
													<td colspan="4" width="100%"><div id="permTable">
															<table align="center" cellpadding="4" class="subtable"
																...
																<tr>
																	...
																	<td width="25%">
																		<div align="left">
																			<nested:text readonly="false"
																				styleClass="textboxsmall"
																				property="personalData.parentMob1"
																				styleId="parentMobile" name="loginform"
																				maxlength="4" size="4" value="91" style="width:50px;"
																				onkeypress="return isNumberKey(event)"></nested:text>
																			<nested:text styleClass="textboxmedium"
																				property="personalData.parentMob2" 
																				styleId="parentMobile1" name="loginform"
																				maxlength="10" size="10" style="width:150px;"
																				onkeypress="return isNumberKey(event)"></nested:text>
																...
																<tr>
																	...
																	<td><nested:text styleId="parentAddressLine2"
																	...
																	<td><div align="left">
																			...
																			<nested:select
																				property="personalData.parentCountryId"
																				name="loginform" styleClass="dropdown"
																				styleId="parentCountryName"
																...
																<tr>
																	...
																	<td align="left"><nested:text
																			styleId="parentCityName"
																			property="personalData.parentCityName"
																			styleClass="textbox" name="loginform" size="15"
																	...
																	<td><div align="left">
																			...
																			%>
																			<logic:equal value="Other"
																				property="personalData.parentStateId"
																				name="loginform">
																				<%
																					dynastyle = "display:block;";
																				%>
																			...
																			<nested:select property="personalData.parentStateId"
																				...
																				<logic:notEmpty property="parentStateMap"
																					name="loginform">
																					<html:optionsCollection name="loginform"
																						property="parentStateMap" label="value"
																						value="key" />
																				</logic:notEmpty>
																				<html:option value="Other">Other</html:option>
																			</nested:select>
												...
												<tr height="15" align="center">
													<td colspan="4"><u><b>EDUCATION DETAILS</b></u></td>
												</tr>
												
												<tr>
												<td align="right">Exam Name:<span class="Mandatory">*</span></td>
													<td><nested:select property="ednQualification.selectedExamId" styleClass="dropdown" >
															<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
															<logic:notEmpty name="loginform" property="ednQualification.examTos">
																<html:optionsCollection name="loginform" property="ednQualification.examTos" label="name" value="id"/>
															</logic:notEmpty>	
														</nested:select></td>
													...
													<td align="right">
														...
														<input type="hidden" id="currentStateId1"
																value="<bean:write name="loginform" property="ednQualification.universityId"/>">
															<logic:equal value="Other"
																property="ednQualification.universityId" name="loginform">
																<%
																	dynaStyle = "display:block;";
																%>
															</logic:equal>
													...
													<td><nested:select property="ednQualification.universityId" styleId="uniId" styleClass="dropdown" onchange="funcOtherShowHide('uniId','Otheruniversity')">
															<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
															<logic:notEmpty name="loginform" property="ednQualification.universityList">
															<logic:iterate id="option" name="loginform" property="ednQualification.universityList">
              											 ...
              											 <script>
																document.getElementById("uniId").value='<bean:write name="loginform" property="ednQualification.universityId"/>';
														</script>
														<div align="left" id="dispalyUniversityOthers">

																		<nested:text
																			property="ednQualification.universityOthers"
																			name="loginform" styleClass="textbox" maxlength="50"
																			styleId="Otheruniversity" style="<%=dynaStyle%>"/>
																	</div>
              											 </td>
												</tr>
												...
												<tr>
												<td align="right">State:<span class="Mandatory">*</span></td>
													<td><nested:select name="loginform"  property="ednQualification.stateId" styleClass="dropdown" >
														<option value=""><bean:message key="knowledgepro.admin.select"/></option>
														<logic:notEmpty name="loginform" property="stateMap">
														 	<nested:optionsCollection name="loginform" property="stateMap" label="value" value="key"/>
														</logic:notEmpty>
															<option value="OUTSIDEINDIA"><bean:message key="admissionForm.education.outsideindia.label"/></option>
														</nested:select></td>
														
													<td align="right"><bean:message key="knowledgepro.applicationform.prevregno.label"/>:<span class="Mandatory">*</span></td>
													<td><nested:text property="ednQualification.previousRegNo" styleClass="textbox" size="18" maxlength="20"/></td>
												</tr>
												
												<tr>
												<td align="right"><logic:equal value="1" property="programTypeId" name="loginform"><bean:message
															key="knowledgepro.applicationform.secLang.label" />:<span class="Mandatory">*</span></logic:equal></td>
													<td><logic:equal value="1" property="programTypeId" name="loginform"><nested:select
															property="personalData.secondLanguage"
															styleId="studentMotherTongueId" name="loginform"
															styleClass="dropdownmedium">
															<option value=""><bean:message
																	key="knowledgepro.admin.select" /></option>
															<nested:notEmpty property="secondLanguageList"
																name="loginform">
																<nested:optionsCollection name="loginform"
																	property="secondLanguageList" label="value"
																	value="value" />
															</nested:notEmpty>
														</nested:select></logic:equal></td>
														
														<td align="right">Institute Name:<span class="Mandatory">*</span></td>
													<td><nested:text
															property="ednQualification.otherInstitute"
															styleId="applicantadhaarNo" name="loginform"
															styleClass="textbox" maxlength="50"
															></nested:text></td>
												</tr>
												<logic:equal value="1" property="programTypeId" name="loginform">
												<tr><td colspan="2" align="right"><span style="color: #374D64;font-weight: bolder;font-size: large;">  <span class="Mandatory">*</span>click here for detail mark entry</span><span class="Mandatory">*</span></td>
												<td colspan="2" align="left">
												<div class="btn btn-info ">
												<span class="form-controler" style="padding-left: 15px;padding-right: 15px" onclick='<%="detailSubmitClass12()"%>'>Go</span>
													</div>
												<td></tr>
												</logic:equal>
												<logic:equal value="2" property="programTypeId" name="loginform">
												<tr><td colspan="2" align="right"><span style="color: #374D64;font-weight: bolder;font-size: large;">  <span class="Mandatory">*</span>click here for Degree Mark Entry</span><span class="Mandatory">*</span></td>
												<td colspan="2" align="left">
												<div class="btn btn-info ">
												<span class="form-controler" style="padding-left: 15px;padding-right: 15px" onclick='<%="detailSubmitDegree()"%>'>Go</span>
													</div>
												<td></tr>
												</logic:equal>
													...
													<td width="100%" colspan="4"><table width="100%"
															...
															<tr>
																<td valign="top" align="right" width="25%"><bean:message
																	...
																	class="Mandatory">*</span></td>
																<td width="25%" valign="top"><logic:equal
																		value="Other" property="religionId" name="loginform">
																		<%
																			dynaStyle = "display:block;";
																		%>
																	...
																	<div align="left">
																		<input type="hidden" id="religionType"
																			name="religionType"
																	...
																	<div align="left">
																		<nested:text property="personalData.religionOthers"
																			styleClass="textbox" name="loginform" maxlength="30"
																	...
																	<div align="left" id="parish_description"
																		style="display: none;">
																		Dioceses:
																		<nested:text property="personalData.dioceseOthers"
																	...
																	<div align="left" id="dioces_description"
																		style="display: none;">
																		&nbsp; &nbsp; Parish:
																		<nested:text property="personalData.parishOthers"
																			styleClass="textboxmedium" name="loginform" size="10"
																...
																<logic:equal value="false" property="dateExpired"
																	...
																	<td width="25%">
																		<div align="left">
																			...
																			<fieldset style="border: 0px">
																				<nested:radio property="personalData.handicapped"
																					styleId="handicappedYes" name="loginform"
																					value="true"
																				...
																				<bean:message
																						key="knowledgepro.applicationform.yes.label" /></label>
																				<nested:radio property="personalData.handicapped"
																					styleId="handicappedNo" name="loginform"
																					value="false"
																		...
																		<div align="left" id="handicapped_description"
																			style="<%=dynaStyle4%>">
																			<span class="Mandatory">Percentage of
																				diasbilty :</span>
															...
															<tr>
																...
																<td width="25%">
																	<div align="left">
																		...
																		<nested:select property="personalData.casteId"
																			name="loginform" styleId="castCatg"
																			styleClass="dropdown"
																			...
																			<logic:notEmpty property="subCasteMap"
																				name="loginform">
																				<html:optionsCollection name="loginform"
																	...
																	<div align="left">
																		<nested:text property="personalData.casteOthers"
																			name="loginform" size="10" maxlength="30"
																...
																<logic:equal value="false" property="dateExpired"
																	...
																	<td align="left">
																		<div align="left">
																			...
																			<nested:select property="personalData.arts"
																				name="loginform" styleClass="dropdown"
																				styleId="arts1"
																	...
																	<td align="left">
																		<div align="left">
																			...
																			<nested:select disabled="true"
																				property="personalData.artsParticipate"
																				name="loginform" styleClass="dropdown"
																				styleId="artsParticipate1">
																				<html:option value="">
																					<bean:message key="knowledgepro.admin.select" />
																				</html:option>
															...
															<tr>
																...
																<td width="25%">
																	<div align="left">
																		<fieldset style="border: 0px">
																			<nested:radio styleId="exservice"
																...
																<logic:equal value="false" property="dateExpired"
																	...
																	<td align="left">
																		<div align="left">
																			...
																			<nested:select property="personalData.sports"
																				name="loginform" styleClass="dropdown"
																				styleId="sports1"
																				...
																				<html:option
																					value="Senior/Junior National Competition">Senior/Junior National Competition</html:option>
																				<html:option
															...
															<tr>
																<logic:equal name="loginform" property="programTypeId"
																	...
																	<td>
																		<div>
																			...
																			<fieldset style="border: 0px">
																				<nested:radio styleId="ncccertificate"
																					property="personalData.ncccertificate"
																					name="loginform" value="true"
																					onclick="showNcccertificate()"></nested:radio>
																				<label for="ncccertificate"><span><span></span></span>
																				<bean:message
																						key="knowledgepro.applicationform.yes.label" /></label>
																				<nested:radio styleId="ncccertificate1"
																					property="personalData.ncccertificate"
																					name="loginform" value="false"
																					onclick="hideNcccertificate()"></nested:radio>
																		...
																		<div id="ncccertificate_description"
																			...
																			<nested:select property="personalData.nccgrades"
																...
																<logic:equal name="loginform" property="programTypeId"
																	...
																	<td align="right">Holder of UG Level NCC
																		Certificate:</td>
																	<td>
																		<div align="left">
																			<input type="hidden" id="hiddenncccertificate"
																...
																<tr>
																	...
																	<td>
																		<div align="left">
																			...
																			<fieldset style="border: 0px">
																				<nested:radio styleId="nsscertificate"
																					property="personalData.nsscertificate"
																					name="loginform" value="true"
																					onclick="showNsscertificate()"></nested:radio>
																				<label for="nsscertificate"><span><span></span></span>
																				<bean:message
																						key="knowledgepro.applicationform.yes.label" /></label>
																				<nested:radio styleId="nsscertificate1"
																					property="personalData.nsscertificate"
																					name="loginform" value="false"
																					onclick="hideNsscertificate()"></nested:radio>
																		...
																		<div id="nsscertificate_description"
																			style="<%=dynaStyle7 %>">
																			Grade of Certificate: <input type="hidden"
																				id="nssgrade" name="nssgrade"
																				value='<bean:write name="loginform" property="personalData.nssgrades"/>' />
																			<nested:select property="personalData.nssgrades"
																				styleClass="dropdownmedium" name="loginform"
																				styleId="nssgrade1">
																				<html:option value="">
																					<bean:message key="knowledgepro.admin.select" />
															...
															<logic:equal name="loginform" property="programTypeId"
																value="2">
																<tr>
																	<td align="right">Holder of UG Level NSS
																		Certificate:</td>
																	<td>
																		<div align="left">
																			<fieldset style="border: 0px">
																				<nested:radio styleId="nsscertificate"
																					property="personalData.nsscertificate"
																					name="loginform" value="true"></nested:radio>
																				<label for="nsscertificate"><span><span></span></span>
																				<bean:message
																						key="knowledgepro.applicationform.yes.label" /></label>
																				<nested:radio styleId="nsscertificate1"
																					property="personalData.nsscertificate"
																					name="loginform" value="false"></nested:radio>
																				<label for="nsscertificate1"><span><span></span></span>
																				<bean:message
																						key="knowledgepro.applicationform.No.label" /></label>
																			</fieldset>
															...
															<tr style="display: none;">
																...
																<td><div align="left">
																		...
																		<fieldset style="border: 0px">
																			<nested:radio property="personalData.sportsPerson"
																				styleId="sportsPersonYes" name="loginform"
																				value="true" onclick="showSportsDescription()"></nested:radio>
																			...
																			<nested:radio property="personalData.sportsPerson"
																				styleId="sportsPersonNo" name="loginform"
																				value="false" onclick="hideSportsDescription()"></nested:radio>
									...
									<%-- <tr>
										<td>
											<table width="100%">
												<tr>
													<td width="100%" align="center"><html:button
															property="" styleClass="btn btn-success"
															styleId="SubmitPersonalDetailStudent"
			...
			<%-- <logic:equal value="false" property="PDataEdited" name="loginform"> --%>
			<logic:equal value="false" property="isUpdated" name="loginform">
			<div class="form-group">
				<div class="col-sm-12 text-center">
					...
					<html:button property="" styleClass="btn btn-success"
															styleId="SubmitPersonalDetailStudent"
															value="Save Personal Details">
														</html:button>
			...
			<%-- </logic:equal> --%>
			<%-- <logic:equal value="true" property="PDataEdited" name="loginform"> --%>
			<logic:equal value="true" property="isUpdated" name="loginform">
				<div class="form-group">
				<div class="col-sm-10 text-center">
							<div id="dataSuppLabel">
							<!-- <b>You Have Updated  Details already</b><br><br> -->
							<div class="btn btn-danger ">
						<span class="form-controler" onclick="goToHomePage()">Cancel</span>
					</div>
						</div>
