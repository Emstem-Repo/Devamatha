...
function cancel() {
	...
	if(isView!=null && isView=="view")
	{
	     document.location.href = "studentEdit.do?method=initStudentViewAfterSubmit";
	}
	else if(isView!=null && isView=="editView")
	{
		document.location.href = "studentEdit.do?method=initStudentEditAfterSubmit";
	}	
}
function Printbiodata(){
	
		var url="studentEdit.do?method=forwardPrintWindow";
...
<html:form action="/studentEdit" method="POST">
	...
	<html:hidden property="isView" styleId="isView"/>
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="admissionForm.studentview.main.label" />&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message key="admissionForm.studentview.main.label" /></strong></div>
					</td>
				...
				<tr>
					...
					<table width="100%" height="1334" border="0" cellpadding="1"
						cellspacing="2">
						<tr>
							<td colspan="2" class="heading" align="left">&nbsp;<bean:message key="admissionForm.studentview.main.label" /></td>
						</tr>
						<tr>
								...
								<tr>
									...
									<table width="100%" height="22" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<td height="20" class="row-even" align="left">&nbsp;<bean:write
												name="studentEditForm"
												property="rollNo"></bean:write></td>
											<td height="20" class="row-odd">
											<div align="right"><bean:message key="admissionForm.studentedit.regno.label"/></div>
											</td>
											<td height="20" class="row-even" align="left">&nbsp;<bean:write
												name="studentEditForm"
												property="regNo"></bean:write></td>
											<td height="20" class="row-odd">
											<div align="right"><bean:message key="admissionForm.studentedit.admissiondate.label"/></div>
											</td>
											<td height="20" class="row-even" align="left">&nbsp;<bean:write
												name="studentEditForm"
												property="applicantDetails.admissionDate"></bean:write></td>
											<td height="20" class="row-even" align="left">&nbsp;</td>
										</tr>
									</table>
									</td>
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" height="22" border="0" cellpadding="0"
										cellspacing="1">
										<tr class="row-white">
											<td colspan="2" height="20" class="row-odd">
											<div align="right"><bean:message key="admissionForm.edit.photo.label"/></div>
											</td>
											...
											<td  height="20" class="row-even" align="center">
												...
												<%} else{%>
													<img src='<%=request.getAttribute("STUDENT_IMAGE")%>' height="150Px" width="150Px" />
												<%} %>
								...
								<tr>
									...
									<table width="100%" height="76" border="0" cellpadding="0"
										...
										<tr class="row-even">
											...
											<td class="row-odd" style="width:150px;">
											<div align="right"><bean:message
										...
										<tr class="row-even">
											...
											<td height="19" align="left">&nbsp;<nested:write property="applicantDetails.bankBranch"></nested:write></td>
											<td class="row-odd">&nbsp;</td>
											<td height="19">&nbsp;</td>
										</tr>
										<tr>
								...
								<tr>
									...
									<table width="99%" cellspacing="1" cellpadding="2">
										...
										<tr>
											...
											<logic:equal  name="studentEditForm" property="viewextradetails" value="true">
<logic:equal  name="studentEditForm" property="viewparish" value="true">
												<tr>
											<td height="20" class="row-odd">
									...
									<td height="17" class="row-even" align="left">
											<logic:equal name="studentEditForm" property="applicantDetails.personalData.areaType" value='R'><bean:message key="admissionForm.studentinfo.belongsto.rural.text"/></logic:equal>
											<logic:equal name="studentEditForm" property="applicantDetails.personalData.areaType" value='U'><bean:message key="admissionForm.studentinfo.belongsto.urban.text"/></logic:equal></td>
										</tr>
										<tr>
											<td height="17" class="row-odd">
											<div align="right"><bean:message
								...
								<td height="17" class="row-even" align="left"><logic:equal name="studentEditForm" property="applicantDetails.personalData.gender" value="MALE"><bean:message key="admissionForm.studentinfo.sex.male.text"/></logic:equal>
								<logic:equal name="studentEditForm" property="applicantDetails.personalData.gender" value="FEMALE"><bean:message key="admissionForm.studentinfo.sex.female.text"/></logic:equal></td>
										</tr>
										<tr><%String dynaStyle3="display:none;"; %>
                           					...
                           					<td height="17" class="row-even" align="left"><logic:equal name="studentEditForm" property="applicantDetails.personalData.sportsPerson" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
											<logic:equal name="studentEditForm" property="applicantDetails.personalData.sportsPerson" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
 										...
 										<tr><%String dynaStyle4="display:none;"; %>
											...
											<%dynaStyle4="display:block;"; %>
                           					...
                           					<td height="17" class="row-even" align="left"><logic:equal name="studentEditForm" property="applicantDetails.personalData.handicapped" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
											<logic:equal name="studentEditForm" property="applicantDetails.personalData.handicapped" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
                           ...
                           <td height="17" class="row-even" align="left"><logic:equal name="studentEditForm" property="applicantDetails.personalData.ncccertificate" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
											<logic:equal name="studentEditForm" property="applicantDetails.personalData.ncccertificate" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
											<logic:equal value="true" property="applicantDetails.personalData.ncccertificate" name="studentEditForm"><div>grade:
                        				 ...
                        				 <tr>
                           					...
                           					<td height="17" class="row-even" align="left"><logic:equal name="studentEditForm" property="applicantDetails.personalData.nsscertificate" value="true" ><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
											<logic:equal name="studentEditForm" property="applicantDetails.personalData.nsscertificate" value="false" ><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
                        				 ...
                        				 <tr>
                           					...
                           					<td height="17" class="row-even" align="left"><logic:equal  name="studentEditForm" property="applicantDetails.personalData.exservice" value="true" ><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
											<logic:equal  name="studentEditForm"  property="applicantDetails.personalData.exservice" value="false" ><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
										...
										<tr>
											...
											<td height="20" class="row-even" align="left">
												<nested:write property="applicantDetails.personalData.universityEmail"></nested:write> <br />
											</td>
										</tr>
									</table>
									</td>
                      ...
                      <td valign="top">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1">
	                          <tr class="row-white">
								...
								<td width="50%" height="23" class="row-odd"><div align="center"><bean:message key="knowledgepro.applicationform.mothertongue.label"/></div></td>
	                            <td width="50%" height="23" class="row-even" align="left">
									<nested:write property="applicantDetails.personalData.motherTongueName"></nested:write>
										
								</td>
								</logic:equal>
								<logic:equal value="true" property="displayHeightWeight" name="studentEditForm">
								 <td width="50%" height="23" class="row-even"><bean:message key="knowledgepro.applicationform.height.label"/>&nbsp;
									<nested:write property="applicantDetails.personalData.height"></nested:write>
								</td>
								<td width="50%" height="23" class="row-even"><bean:message key="knowledgepro.applicationform.weight.label"/>&nbsp;
							...
							<tr class="row-white">
	                            <td height="23" class="row-even" align="left"><bean:message key="knowledgepro.applicationform.addninfo.label1"/> <B><bean:write property="organizationName" name="studentEditForm"/></B>:</td>
								 <td height="23" class="row-even" align="left">
								...
								<td height="23" class="row-even" align="left"><bean:message key="knowledgepro.applicationform.addninfo.label2"/> <B><bean:write property="applicantDetails.course.name" name="studentEditForm"/> </B>:</td>
								<td height="23" class="row-even" align="left">
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" height="57" border="0" cellpadding="0"
										...
										<tr class="row-white">
											<td width="365" height="23" colspan="2" class="row-odd">
                    ...
                    <tr>
                      ...
                      <td width="100%" height="29" valign="top"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="1">
                          <tr class="row-white">
                            ...
                            <td width="236" height="25" class="row-even" align="left">
								<nested:write property="applicantDetails.admittedThroughName" name="studentEditForm"/>	
							</td>
                            ...
                            <td width="244" height="25" class="row-even" align="left">
                            	<nested:write property="applicantDetails.subjectGroupNames" name="studentEditForm"/>	
							</td>
                          </tr>
                           <tr class="row-white">
                            <td width="212" height="25" class="row-odd"><div align="right"><bean:message key="admissionForm.edit.freeship.label"/></div></td>
                            <td width="236" height="25" class="row-even" align="left">
								<logic:equal name="studentEditForm" property="applicantDetails.isFreeShip" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
								<logic:equal name="studentEditForm" property="applicantDetails.isFreeShip" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
							</td>
                            <td width="224" height="25" class="row-odd" align="right"><bean:message key="knowledgepro.attendance.class.col"/> </td>
                            <td width="244" height="25" class="row-even" align="left">
								<nested:write property="classSchemeName" name="studentEditForm"/>	
							</td>
                          </tr>
						<tr class="row-white">
                            <td width="212" height="25" class="row-odd"><div align="right">Is-LIG:</div></td>
                            <td width="236" height="25" class="row-even" align="left">
								<logic:equal name="studentEditForm" property="applicantDetails.isLIG" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></logic:equal>
								<logic:equal name="studentEditForm" property="applicantDetails.isLIG" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></logic:equal>
							</td>
							<td width="212" height="25" class="row-odd"><div align="right"><bean:message key="knowledgepro.admin.feeCategory"/></div></td>
                            <td width="236" height="25" class="row-even" align="left">
								<nested:write property="applicantDetails.feeCategoryName" name="studentEditForm"/>	
							</td>
                          </tr>
                      </table></td>
                      <td  background="images/right.gif" width="5" height="29"></td>
                ...
                <tr>
                  <td colspan="2" class="heading"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td width="100%" height="29" valign="top"><table width="100%" height="24" border="0" cellpadding="0" cellspacing="1">
						<tr class="row-white">
                            <td height="25" class="row-odd"><div align="center"><bean:message key="knowledgepro.admission.prerequisite" /></div></td>
                            <td height="25" class="row-odd" align="center"><bean:message key="knowledgepro.admin.prereqdef.percentage" /></td>
							<td height="25" class="row-odd" align="center"><bean:message key="knowledgepro.attendance.rollno" /></td>
                            <td height="25" class="row-odd"><div align="center"><bean:message key="admissionForm.approveview.prereq.exammonth.label" /></div></td>
                            <td height="25" class="row-odd" align="center"><bean:message key="admissionForm.approveview.prereq.examyear.label" /></td>
                          </tr>
						
						<logic:iterate id="prereq" property="applicantDetails.prerequisiteTos" name="studentEditForm">
                          <tr class="row-white">
                            <td height="25" class="row-even"><div align="center"><nested:write property="prerequisiteName" name="prereq"/> </div></td>
                            <td height="25" class="row-even" align="center"><nested:write property="prerequisiteMarksObtained" name="prereq"/></td>
							<td height="25" class="row-even" align="center"><nested:write property="rollNo" name="prereq"/></td>
                            ...
                            <td height="25" class="row-even" align="center"><nested:write property="examYear" name="prereq"/></td>
                          </tr>
                          </logic:iterate>
                      </table></td>
                      <td  background="images/right.gif" width="5" height="29"></td>
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0"
										...
										<logic:notEmpty name="studentEditForm" property="applicantDetails.preference.firstprefCourseName">
										<tr class="row-white">
										...
										<logic:notEmpty name="studentEditForm" property="applicantDetails.preference.secondprefCourseName">
										<tr class="row-white">
										...
										<logic:notEmpty name="studentEditForm" property="applicantDetails.preference.thirdprefCourseName">
										<tr class="row-white">
                  ...
                  <td colspan="2" class="heading"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td height="31" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="1">
						...
						<nested:iterate property="applicantDetails.workExpList" id="exp" name="studentEditForm" type="com.kp.cms.to.admin.ApplicantWorkExperienceTO" indexId="count">
                          <tr class="row-white">
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										<tr>
											...
											<td class="row-odd" width="10%" align="center"><bean:message key="knowledgepro.applicationform.prevregno.label"/></td>
										</tr>
											...
											<c:choose>
												<c:when test="${temp == 0}">
													<tr>
														...
														<td width="16%" class="row-even" align="center">
															<bean:write
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr >
											...
											<td height="25" class="row-even"><div align="left">
															...
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="1">JANUARY</logic:equal>
											              	<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="2">FEBRUARY</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="3">MARCH</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="4">APRIL</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="5">MAY</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="6">JUNE</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="7">JULY</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="8">AUGUST</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="9">SEPTEMBER</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="10">OCTOBER</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="11">NOVEMBER</logic:equal>
															<logic:equal property="applicantDetails.entranceDetail.monthPassing" name="studentEditForm" value="12">DECEMBER</logic:equal>
...
<tr>
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<td height="25" class="row-odd" width="15%">
											...
											<div align="center"><nested:write property="applicantDetails.personalData.recommentedBy"/></div>
											</td>
						...
						<logic:equal value="true" property="tcDetails" name="studentEditForm">
						<tr>
							<td colspan="2" align="left"><span class="heading">&nbsp;TC Details</span></td>
						</tr>
						<tr>
							<td colspan="2" >
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										<tr>
										<td height="25" class="row-odd" width="9%">
											<div align="center"><bean:message key="knowledgepro.admission.tcno"/></div>
											</td>
											<td height="25" class="row-odd" width="9%">
											<div align="center"><bean:message key="knowledgepro.admission.tcdate"/></div>
											</td>
											<td height="25" class="row-odd" width="9%">
											<div align="center"><bean:message key="knowledgepro.admission.tctype"/></div>
											</td>
										</tr>
										<tr> 
										<td height="25" class="row-even" width="9%">
										<div align="center">
										<nested:write property="applicantDetails.studentTcNo"></nested:write>
										</div>
										</td>
										<td height="25" class="row-even" width="9%">
										<div align="center">
										<nested:write property="applicantDetails.studentTcDate"></nested:write>
										</div>
										</td>
										<td height="25" class="row-even" width="9%">
										<div align="center">
										<nested:write property="applicantDetails.studentTcType"></nested:write>
										</div>
										</td>
										</tr>
									</table>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="51%" height="45" align="left"><html:button property="" onclick="cancel()" styleClass="formbutton" value="Close"></html:button>
									<html:button property="" onclick="Printbiodata()" styleClass="formbutton" value="Print"></html:button></td>
