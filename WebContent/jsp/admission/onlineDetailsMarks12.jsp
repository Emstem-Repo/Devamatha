...
<table width="80%" style="background-color: #F0F8FF" align="center">
  ...
  <tr>
  	<td align="center">
  		<span class="Mandatory">CBSE, International and ICSE students can leave the column for Second Language empty</span>
  	</td>
  </tr>
  <tr>
              ...
              <tr>
                   ...
                   <table width="80%" align="center" cellspacing="1" cellpadding="2">
					...
					for(int i=1;i<=CMSConstants.MAX_CANDIDATE_CLASS12_SUBJECTS;i++) {
						...
						System.out.println("detailMark.subjectid"+i);
					...
					%>
                     ...
                     <%if(i==1){%>
						...
						<nested:select disabled="true" property="<%=propertyName%>"  name="onlineApplicationForm" styleId='<%=propertyName%>' styleClass="combolarge" onchange='<%=dupSub %>'>
						...
						<td  class="row-even" align="center">
						<nested:select property="<%=propertyName%>"  name="onlineApplicationForm" styleId='<%=propertyName%>' styleClass="combolarge" onchange='<%=dupSub %>'>
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admSubjectLangMap" name="onlineApplicationForm" label="value" value="key"/>
