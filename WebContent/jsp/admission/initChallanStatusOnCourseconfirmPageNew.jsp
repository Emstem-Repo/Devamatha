...
<table width="100%" border="0">
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.admission" /> <span class="Bredcrumbs">&gt;&gt; Challan Status On Date Wise </span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="100%" background="images/Tcenter.gif" class="body" ><strong class="boxheader"> Challan Status On Date Wise </strong></td>
      ...
      <tr>
        ...
        <td height="20" valign="top" background="images/Tright_03_03.gif"></td>
        <td class="heading">
			Challan Status On Date Wise Updated Successfully...<br>
		</td>
        <td valign="top" background="images/Tright_3_3.gif" class="news"></td>
      </tr>
