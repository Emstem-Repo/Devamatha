...
<html:form action="/AdmissionStatus" method="POST">
	...
	<table  width="600" border="0"  cellpadding="3" cellspacing="0" bordercolor="#E0DFDB">		
	 <tr>
		...
		<%--<img width="800" height="150"  src='<%= request.getRequestURL().toString().replace(request.getRequestURI().substring(0), request.getContextPath()).concat("/LogoServlet") %>' alt="Logo not available">
		 --%>
		<img src="images/admission/images/headerlogo.png" width="120" height="120" align="top"/>
		  </td>
	</tr>
	<tr>
	  <td>
	...
	<tr>
	  <td class="title" align="center">APPLICATION FOR ADMISSION TO UNDERGRADUATE PROGRAMME - <bean:write name="admissionFormForm" property="applicantDetails.appliedYear"/><br></br></td>
	</tr>
	</logic:equal>

	<logic:equal value="2" name="admissionFormForm" property="applicantDetails.programType">
	<tr>
	  <td class="title" align="center">APPLICATION FOR ADMISSION TO POSTGRADUATE PROGRAMME - <bean:write name="admissionFormForm" property="applicantDetails.appliedYear"/><br></br></td>
	</tr>
	</logic:equal>
	   ...
	   <tr>
	     <td>13.</td><td class="algn">Land Phone</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.landlineNo"/></td>
	   </tr>
