...
<logic:notEmpty name="conductCertificateDetailsForm" property="studentList">

<%int i=1; %>
	<logic:iterate id="studentList" name="conductCertificateDetailsForm" property="studentList" indexId="count">
			...
			<table border="0">
				...
				<tr>
					<td width="70%" class="heading3" align="left">
						...
						<bean:write name="studentList" property="regNo"/><bean:write name="studentList" property="admissionnumber"/>
					</td>	
				</tr>
				<tr>
					<td width="70%" class="heading3" align="left">
...
<logic:empty name="conductCertificateDetailsForm" property="studentList">
