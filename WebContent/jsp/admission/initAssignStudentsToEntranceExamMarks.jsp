...
function getStudentsDetails(){
	...
	document.getElementById("method").value = "getStudentsForExamMarksAssignment";
	document.applicationEditForm.submit();
}


function cancelPage(){
	document.location.href="applicationEdit.do?method=initAssignStudentsToEntranceExamMarks";
}



function assignCoursesToStudent() {
	document.getElementById("method").value = "assignStudentsToEntranceExamMarks";
	document.applicationEditForm.submit();
...
<html:hidden property="method" styleId="method" value="initAssignStudentsToEntranceExamMarks"/>
...
<table width="100%" border="0">
		<tr>
			...
			Student Entrance ExamMarks &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> Student Entrance ExamMarks</strong></td>
			...
			<tr>
						...
						<logic:notEmpty name="applicationEditForm" property="preferenceEntranceDetailsList">
						<tr>
							<td valign="top" class="news">
							...
							<table width="100%" cellspacing="1" cellpadding="2">
										...
										<td align="center" class="row-odd">Preference No</td>
										<td align="center" class="row-odd">Obtained Marks</td>
										<td align="center" class="row-odd">Max Marks</td>
										
										</tr>
											<nested:iterate id="to" property="preferenceEntranceDetailsList"	name="applicationEditForm" indexId="count">
												<tr>
													...
													<td align="center" class="row-even">
							                              <nested:text size="10" maxlength="7" property="marksObtained" />  	
							                        </td>
							                        
							                        <td align="center" class="row-even">
							                              <nested:text size="10" maxlength="7" property="totalMarks" />  	
							                        </td>
