...
function validateHideDetails()
{	
	if(document.getElementById("hidedetailsRadio1").checked == true){
		document.getElementById("hidedetailsDate").value="";
		document.getElementById("hidedetailReasons").value="";
	}
}
...
function editSubjectGroup(){
	document.studentEditForm.method.value="editSubjectGroupHistoryDetails";
	document.studentEditForm.submit();
	...
	function calculatePerc(coreMarksObt){
		var coreMarks=coreMarksObt;
		var totalMarks=document.getElementById("coreTotalMarks").value;
		var percentage=coreMarks/totalMarks;
		document.getElementById("calculatedPerc").value=percentage*100;
	}
...
<html:form action="/studentEdit" enctype="multipart/form-data"
	method="POST">
	...
	<html:hidden property="checkReligionId" styleId="checkReligionId" name="studentEditForm"/>
	<input type="hidden" name="applicationId"
		value='<bean:write name="studentEditForm" property="applicantDetails.applicationId" />' />
	<input type="hidden" name="courseId"
		value='<bean:write	name="studentEditForm" property="applicantDetails.selectedCourse.id" />' id="courseId"/>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<table width="100%"  cellpadding="1"
								...
								<tr>
									...
									<table width="100%" height="22" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<td height="20" class="row-even" align="left">&nbsp;<nested:text
												name="studentEditForm" property="regNo" size="15"
										...
										<tr>
											...
											<td height="20" class="row-even" align="left">&nbsp;<nested:text
												...
												<td height="20" class="row-even" align="left">&nbsp;<nested:text
													property="bankAccNo" name="studentEditForm" styleId="bankAccNo"
													size="25"></nested:text> </td>
												<td height="20" class="row-odd">
												<div align="right"><bean:message
													key="knowledgepro.inventory.vendor.smart.card.no"/>:</div>
												</td>
												<td height="20" class="row-even" align="left">&nbsp;
												<nested:text
													property="smartCardNo" name="studentEditForm" styleId="smartCardNo"
													size="25" maxlength="15"></nested:text>
												</td>
										...
										<bean:message
													key="knowledgepro.admission.admission.number"/>
										</div></td>
										<td height="20" colspan="1" class="row-even" align="left"><div align="left">
										<nested:text
												property="applicantDetails.admissionNumber" 
												size="10" maxlength="30"></nested:text>
										
										</div></td>
										<td height="20" class="row-odd">
											<div align="right">University Register no:</div>
											</td>
											<td height="20" class="row-even" align="left">&nbsp;<nested:text
												name="studentEditForm" property="universityRegNo" size="16"
												maxlength="10"></nested:text></td>
								...
								<tr>
									...
									<table width="100%" height="22" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<td colspan="3" height="20" class="row-even" align="right">
											<%if(CMSConstants.LINK_FOR_CJC){ %>
												<img src='<%=request.getContextPath()%>/PhotoServlet' height="150Px" width="150Px" />
											<%} else{%>
							...
							<table width="98%" border="0" align="top" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr >
                          <td height="20" class="row-odd" ><div align="right">Sports</div></td>
                        ...
                        <tr >
                          <td height="20" class="row-odd" width="40%"><div align="right">Sports Participate</div></td>
	                      <td height="20" class="row-even" align="left">
						 ...
						 <tr >
                          <td height="20" class="row-odd" width="40%"><div align="right">Arts</div></td>
	                      <td height="20" class="row-even" align="left">
                        ...
                        <tr >
                          <td height="20" class="row-odd" width="40%"><div align="right">Arts Participate</div></td>
	                      <td height="20" class="row-even" align="left">
                         <nested:select property="applicantDetails.personalData.artsParticipate" styleClass="combo" styleId="artsParticipate">
							...
							<logic:equal value="false" property="viewextradetails" name="studentEditForm">			
							 <tr>
						    <%String dynaStyle55="display:none;"; %>
									<logic:equal value="true" property="applicantDetails.personalData.ncccertificate" name="studentEditForm">
										<%dynaStyle55="display:block;"; %>
									</logic:equal>
					        <td height="17" class="row-odd" width="40%"><div align="right">Holder of PlusTwo Level NCC Certificate</div></td>
                           <td height="17" class="row-even" align="left">
                           <input type="hidden" id="hiddenncccertificate" name="hiddenncccertificate" value='<bean:write name="studentEditForm" property="applicantDetails.personalData.ncccertificate"/>'/>
                          <nested:radio property="applicantDetails.personalData.ncccertificate" value="true" onclick="showNcccertificate()"><bean:message key="knowledgepro.applicationform.yes.label"/></nested:radio>
							...
							<div id="ncccertificate_description" style="<%=dynaStyle55 %>">
							Grade of Certificate
	                      <input type="hidden" id="nccgrade" name="nccgrade" value='<bean:write name="studentEditForm" property="applicantDetails.personalData.nccgrades"/>'/>
                         <nested:select property="applicantDetails.personalData.nccgrades" styleClass="combo" styleId="nccgrade">
                        				 ...
                        				 <tr>
                           					<td height="17" class="row-odd" width="40%"><div align="right">Holder of PlusTwo Level NSS Certificate</div></td>
                        ...
                        <logic:equal value="true" property="viewextradetails" name="studentEditForm">
                        ...
                        <tr>
					        ...
					        <td height="17" class="row-odd" width="40%"><div align="right">Holder of DEGREE NCC  Certificate</div></td>
                           <td height="17" class="row-even" align="left">
                           <input type="hidden" id="hiddenncccertificate" name="hiddenncccertificate" value='<bean:write name="studentEditForm" property="applicantDetails.personalData.ncccertificate"/>'/>
                           <nested:radio property="applicantDetails.personalData.ncccertificate" value="true" onclick="showNcccertificate()"><bean:message key="knowledgepro.applicationform.yes.label"/></nested:radio>
							<nested:radio property="applicantDetails.personalData.ncccertificate" value="false" onclick="hideNcccertificate()"><bean:message key="knowledgepro.applicationform.No.label"/></nested:radio>
                         ...
                         <tr>
                           			<td height="17" class="row-odd" width="40%"><div align="right">Holder of DEGREE NSS Certificate</div></td>
                           			<td height="17" class="row-even" align="left"><nested:radio property="applicantDetails.personalData.nsscertificate" value="true" ><bean:message key="knowledgepro.applicationform.yes.label"/></nested:radio>
									<nested:radio property="applicantDetails.personalData.nsscertificate" value="false" ><bean:message key="knowledgepro.applicationform.No.label"/></nested:radio>
								...
								<tr>
									...
									<table width="99%" cellspacing="1" cellpadding="2">
												...
												<tr>
													<td><logic:notEqual value="Other"
														...
														<nested:select
															...
															onchange="getSubReligion(this.value,'Subreligions');funcOtherShowHide('religions','otherReligion');funcReligionShowHide(this.value);">
															<option value=""><bean:message
																key="knowledgepro.admin.select" /></option>
										...
										<tr>
											...
											<td height="20" class="row-even" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0">
												...
												<logic:notEqual value="Other" property="applicantDetails.personalData.religionId" name="studentEditForm">
													<%dynastyle="display:none;"; %>
												<nested:select property="applicantDetails.personalData.religionId" styleClass="combo" styleId="religions" onchange="getSubCaste(this.value,'castes');funcOtherShowHide('religions','otherReligion');funcReligionShowHide(this.value);">
										...
										<tr>
											...
											<td height="20" class="row-even" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0">
												<tr><td>
											<logic:notEqual value="Other" property="applicantDetails.personalData.subReligionId" name="studentEditForm">
											<%dynastyle="display:none;"; %>
											<nested:select property="applicantDetails.personalData.subReligionId" styleClass="combo" styleId="Subreligions"  onchange="funcOtherShowHide('Subreligions','otherSubReligion')">
												...
												<%--
													<c:if test="${studentEditForm.applicantDetails.personalData.religionId != null && studentEditForm.applicantDetails.personalData.religionId != ''}">
														...
														<c:otherwise>
															<logic:notEmpty property="subReligions" name="studentEditForm">
											...
											<!--<logic:equal value="Other" property="applicantDetails.personalData.subReligionId" name="studentEditForm">
											<%dynastyle="display:block;"; %>
											<nested:select property="applicantDetails.personalData.subReligionId" styleClass="combo" styleId="Subreligions" onchange="funcOtherShowHide('Subreligions','otherSubReligion')">
													<option value=""><bean:message key="knowledgepro.admin.select"/></option>
													<html:option value="Other">Other</html:option>
									...
									<logic:equal value="true" name="studentEditForm" property="isCjc">
										<tr>
											<td height="20" class="row-odd" align="right">Sub Caste:</td>
											<td height="20" class="row-even"><html:text property="applicantDetails.personalData.subCaste" size="10" maxlength="30"/> </td>
										</tr>
									</logic:equal>
											...
											<td height="20" class="row-even" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0">
												...
												<nested:select property="applicantDetails.personalData.casteId" styleClass="combo" styleId="castes" onchange="funcOtherShowHide('castes','otherCastCatg')">
													...
													<c:choose>
														...
														<c:otherwise>
															<logic:notEmpty property="casteList" name="studentEditForm">
															<nested:optionsCollection property="casteList" label="casteName" value="casteId"/>
															</logic:notEmpty>
															<html:option value="Other">Other</html:option>	
														</c:otherwise>
   					 ...
   					 <c:choose>
										<c:when test="${studentEditForm.applicantDetails.personalData.dioceseId != null && applicantDetails.personalData.dioceseId != ''}">
                             ...
                             <td height="20" width="50%" class="row-even" align="left">
                              <nested:select property="applicantDetails.personalData.dioceseId" styleId="diocese" styleClass="comboLarge" onchange="getParishValueByDiose(this.value);">
								...
								<html:optionsCollection property="dioceseList" name="studentEditForm" label="name" value="id"/>
							...
							<tr id="parish_description" style="display:none;">
                             ...
                             <td height="20" width="50%" class="row-even" align="left">
                              <nested:select property="applicantDetails.personalData.dioceseId" styleId="diocese" styleClass="comboLarge" onchange="getParishValueByDiose(this.value);">
								...
								<c:choose>
										<c:when test="${studentEditForm.applicantDetails.personalData.parishId != null && applicantDetails.personalData.parishId != ''}">
	                      ...
	                      <tr id="dioces_description" style="display: block;">
                              ...
                              <nested:select property="applicantDetails.personalData.parishId" styleId="parish" styleClass="comboLarge">
									<option value="">-Select-</option>
										<html:optionsCollection property="parishList" name="studentEditForm" label="name" value="id"/>
		...
		<c:if test="${studentEditForm.applicantDetails.personalData.religionId != null && studentEditForm.applicantDetails.personalData.religionId == 3}">
					
		
		<tr id="parish_description" style="display: block;">
                               <td height="20" width="50%" class="row-odd"><div align="right">Dioceses</div></td>
                              <td height="20" width="50%" class="row-even" align="left"> 
                              <nested:text property="applicantDetails.personalData.dioceseOthers" size="10" maxlength="30" styleId="otherParish" ></nested:text>
		 ...
		 <tr id="dioces_description" style="display: block;">
               <td height="20" width="50%" class="row-odd"><div align="right">Parish</div></td>
               <td height="20" width="50%" class="row-even" align="left"> 
               <nested:text property="applicantDetails.personalData.parishOthers" size="10" maxlength="30" styleId="otherDiocese" ></nested:text>
										...
										<tr>
											...
											<tr>
											<logic:equal name="studentEditForm"  property="isCjc"  value="true">
											<td height="20" class="row-odd">
											<div align="right"><bean:message
												key="knowledgepro.admission.student.edit.college.email" /></div>
											</td></logic:equal>
											<logic:equal name="studentEditForm"  property="isCjc"  value="false">
											<td height="20" class="row-odd">
											<div align="right"><bean:message
												key="knowledgepro.admission.student.edit.university.email" /></div>
											</td></logic:equal>
											<td height="20" class="row-even" align="left"><nested:text
												property="applicantDetails.personalData.universityEmail" size="15"
												maxlength="75"></nested:text> <br />
											</td>
										</tr>
									</table>
									</td>
									...
									<table width="100%" height="24" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<nested:select property="applicantDetails.subjectGroupIds"
												...
												multiple="multiple" size="4" style="width:200px;height:100px" disabled="true">
												<logic:notEmpty name="studentEditForm" property="subGroupList">
												<nested:optionsCollection property="subGroupList"
													label="name" value="id" />
													</logic:notEmpty>
											</nested:select><br/>
											<a href="javascript:void(0)" onclick="editSubjectGroup()">Edit Subject Group</a>
										...
										<tr class="row-white">
											...
											<p>
											 <a
													href="studentEdit.do?method=viewHistory_ClassGroupDetails&viewStudentId=<bean:write property="originalStudent.id" name="studentEditForm"/>"
													target="_blank">View History</a>
											</td>
										</tr>
										<tr class="row-white">
											...
											<td width="224" height="25" class="row-odd" align="right"><div align="right">
												<span class="Mandatory">*</span><bean:message key="knowledgepro.admission.aided"/> </div></td>
											<td width="244" height="25" class="row-even" align="left">
										...
										<td width="212" height="25" class="row-odd">
											...
											<td width="236" height="25" class="row-even" align="left">
											<nested:select property="applicantDetails.feeCategoryId"
												styleId="feeCategoryId" styleClass="combo">
												<html:option value="">-Select-</html:option>
												<nested:optionsCollection property="feeCategoryList"
													label="feeCategoryName" value="feeCategoryId" />
                    ...
                    <tr>
                      ...
                      <td><img src="images/06.gif" ></td>
									...
									<table width="100%" height="90" border="0" cellpadding="0"
										...
										<tr class="row-white">
											...
											<nested:text
												...
												size="45" maxlength="100"></nested:text></td>
											<td width="224" class="row-odd">
											<div align="right"><bean:message
											...
											<td width="244" class="row-even" align="left">&nbsp; <nested:text
												...
												size="55" maxlength="100"></nested:text></td>
										</tr>
										</logic:equal>
										<logic:equal value="false" name="studentEditForm" property="isCjc">
										<tr class="row-white">
											<td width="212" height="20" class="row-odd">
											<div align="right"><span class="Mandatory"></span><bean:message
												key="admissionForm.studentinfo.addrs1.label" /></div>
											...
											<nested:text
												property="applicantDetails.personalData.currentAddressLine1"
												size="45" maxlength="35"></nested:text></td>
											<td width="224" class="row-odd">
											<div align="right"><bean:message
												key="admissionForm.studentinfo.addrs2.label" /></div>
											</td>
											<td width="244" class="row-even" align="left">&nbsp; <nested:text
												property="applicantDetails.personalData.currentAddressLine2"
												size="55" maxlength="40"></nested:text></td>
										</tr>
										</logic:equal>
										<tr class="row-even">
											<td height="20" class="row-odd">
										...
										<tr class="row-even">
											...
											<%dynastyle="display:none;"; %>
											<nested:select property="applicantDetails.personalData.currentStateId" styleClass="combo" styleId="currentStateName" onchange="funcOtherShowHide('currentStateName','otherTempAddrState');getTempAddrDistrict(this.value,'tempAddrdistrict');">
												...
												<logic:notEmpty property="editCurrentStates" name="studentEditForm">
										...
										<tr class="row-even">
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="0">
												<tr><td>
											<logic:notEqual value="Other" property="applicantDetails.personalData.currentDistricId" name="studentEditForm">
											<%dynastyle="display:none;"; %>
												
											<nested:select property="applicantDetails.personalData.currentDistricId" styleClass="comboExtraLarge" styleId="tempAddrdistrict" onchange="funcOtherShowHide('tempAddrdistrict','otherTempAddrDistrict');">
									
												<option value="0"><bean:message key="knowledgepro.admin.select"/></option>
												
												<c:if test="${studentEditForm.applicantDetails.personalData.currentStateId != null && studentEditForm.applicantDetails.personalData.currentStateId!= ''}">
												...
												<logic:notEmpty property="editCurrentDistrict" name="studentEditForm">
												<nested:optionsCollection property="editCurrentDistrict" label="name" value="id"/>
												</logic:notEmpty>
												
												<html:option value="Other">Other</html:option>
											</nested:select>
											</logic:notEqual>
											<logic:equal value="Other" property="applicantDetails.personalData.currentDistricId" name="studentEditForm" >
											<%dynastyle="display:block;"; %>
										...
										<td height="20" class="row-odd" align="right">
											<span class="Mandatory">*</span>Street:
											</td>
											
											<td height="20" class="row-even" align="left">
											<nested:text property="applicantDetails.personalData.currentStreet" styleId="currentStreet" styleClass="textbox" maxlength="30" onkeypress="IsAlpha(event)"></nested:text>
											</td>
								...
								<tr>
									...
									<table width="100%" height="90" border="0" cellpadding="0"
										...
										<tr class="row-even">
											...
											<%dynastyle="display:none;"; %>
											<nested:select property="applicantDetails.personalData.permanentStateId" styleClass="combo" styleId="permanentStateName" onchange="funcOtherShowHide('permanentStateName','otherPermAddrState');getPermAddrDistrict(this.value,'permAddrdistrict');">
												<option value="0"><bean:message key="knowledgepro.admin.select"/></option>
												...
												<logic:notEmpty property="editPermanentStates" name="studentEditForm">
										 ...
										 <tr class="row-even">
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="0">
												<tr><td>
											<logic:notEqual value="Other" property="applicantDetails.personalData.permanentDistricId" name="studentEditForm">
											<%dynastyle="display:none;"; %>
												
											<nested:select property="applicantDetails.personalData.permanentDistricId" styleClass="comboExtraLarge" styleId="permAddrdistrict" onchange="funcOtherShowHide('permAddrdistrict','otherPermAddrDistrict');">
									
												<option value="0"><bean:message key="knowledgepro.admin.select"/></option>
												
												
			                        			
			                        			<c:if test="${studentEditForm.applicantDetails.personalData.permanentStateId != null && studentEditForm.applicantDetails.personalData.permanentStateId!= ''}">
												...
												<logic:notEmpty property="editPermanentDistrict" name="studentEditForm">
												<nested:optionsCollection property="editPermanentDistrict" label="name" value="id"/>
												</logic:notEmpty>
												
												<html:option value="Other">Other</html:option>
											</nested:select>
											</logic:notEqual>
											<logic:equal value="Other" property="applicantDetails.personalData.permanentDistricId" name="studentEditForm" >
											<%dynastyle="display:block;"; %>
											...
											<td height="20" class="row-even" align="left">
											<nested:text property="applicantDetails.personalData.permanentStreet" styleId="permanentStreet" styleClass="textbox" maxlength="30" onkeypress="IsAlpha(event)"></nested:text>
											</td>
										</tr>
						...
						<tr>
							...
							<tr >
                              <td colspan="5" align="right" class="row-odd">
								...
								<div align="right"><span class="Mandatory">*</span>Course which you have done for under graduate program
								</div></td>
                              <td class="row-even" colspan="6">
							<nested:select property="applicantDetails.personalData.ugcourse" styleClass="comboLarge" styleId="ugcourse">
													<option value=""><bean:message key="knowledgepro.admin.select"/></option>
										...
										<td class="row-even" colspan="6">
											<html:radio property="applicantDetails.backLogs" name="studentEditForm" styleId="backLogs" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></html:radio>
											<html:radio property="applicantDetails.backLogs" name="studentEditForm" styleId="backLogs" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></html:radio>
										</td>
									</tr>
									...
									<tr>
											...
											<td class="row-even" colspan="6">
											<html:radio property="applicantDetails.isSaypass" name="studentEditForm" styleId="isSaypass" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></html:radio>
											<html:radio property="applicantDetails.isSaypass" name="studentEditForm" styleId="isSaypass" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></html:radio>
										</td>
									</tr>
									...
									<tr>
									<td colspan="5" align="right" class="row-odd">
									<span class="Mandatory">*</span>Stream Under Class 12:
									</td>
									<td class="row-even" colspan="6">
									<nested:select property="applicantDetails.personalData.stream" styleClass="dropdownmedium" styleId="stream">
									<option value=""><bean:message key="knowledgepro.admin.select"/></option>
						...
						<tr>
							...
							<!--columns to enter the core subjects marks -->		
										<tr>
											<td height="25" class="row-odd">
											<div align="right"><bean:message
												key="knowledgepro.admission.totalMarks.core.subjects" /></div>
											</td>
											<td height="25" class="row-even">
											<div align="left"><nested:text 
												property="applicantDetails.qualifyDetailsTo.coreSubjectsTotalMarks" styleId="coreTotalMarks"
												size="10" maxlength="10" onkeypress="return isDecimalNumberKey(this.value,event)"></nested:text></div>
											</td>
											<td height="25" class="row-odd">
											<div align="right"><bean:message
												key="knowledgepro.admission.marksObtained.coreSubjects" /></div>
											</td>
											<td height="25" class="row-even">
											<div align="left"><nested:text
												property="applicantDetails.qualifyDetailsTo.coreSubjectsObtainedMarks"
												size="10" maxlength="10" onkeypress="return isDecimalNumberKey(this.value,event)" onkeyup="calculatePerc(this.value)"></nested:text></div>
											</td>
											<td height="25" class="row-odd">
											<div align="right"><bean:message
												key="admissionForm.edit.qualifydetails.perc.coreSubjects" /></div>
											</td>
											<td height="25" class="row-even">
											<div align="left"><nested:text
												property="applicantDetails.qualifyDetailsTo.coreSubjectsPercentage" styleId="calculatedPerc"
												size="6" maxlength="6" onkeypress="return isDecimalNumberKey(this.value,event)" readonly="true"></nested:text></div>
											</td>
										</tr>
										</table>
									</td>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr>
											...
											<td height="30" class="row-even" align="left">&nbsp;<nested:select
												...
												styleClass="combo" styleId="fatherOccupation" onchange="displayOtherForFather(this.value)">
												<html:option value="">- Select -</html:option>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr>
											...
											<td height="30" class="row-even" align="left">&nbsp; <nested:select
												...
												styleClass="combo" styleId="motherOccupation" onchange="displayOtherForMother(this.value)">
												<html:option value="">- Select -</html:option>
												<html:optionsCollection name="studentEditForm"
													property="occupations" label="occupationName"
													value="occupationId" />
						...
						<tr>
							...
							<table width="99%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0"	cellspacing="0">
										<tr class="row-white">
											<td height="20" class="row-odd" width="50%"><div align="right"><bean:message key="knowledgepro.admissionForm.studentinfo.communication.with"/></div>
											</td>
											<td height="20" class="row-even" align="left" width="50%">&nbsp;
											<nested:select property="applicantDetails.commSentTo" styleId="commSentTo" styleClass="comboMedium">
												<html:option value="F">Father</html:option>
								              	<html:option value="M">Mother</html:option>
								              	<html:option value="G">Guardian</html:option>
											</nested:select>
											</td>
										</tr>
										</table>
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<td height="25" class="row-odd" width="15%">
											...
											<div align="center"><html:textarea property="applicantDetails.personalData.recommentedBy" styleId="desc1" cols="30" rows="4" onkeypress="return imposeMaxLength(event,this)"/></div>
											</td>
											...
											<table width="100%" cellspacing="1" cellpadding="2">
												...
												<tr>
													...
													<td width="10%" class="row-even"><html:select
														property="batch" styleClass="body" styleId="batch" onchange="getClasses()">
								 ...
								 <tr>
									...
									<table width="100%" border="0" align="center" cellpadding="0"
										...
										<tr>
											...
											<table width="100%" cellspacing="1" cellpadding="2">
												<tr>
													<td colspan="2" class="heading">Hide Student Details</td>

													<td colspan="2" class="heading"><html:radio
														property="isHide" value="true"
														styleId="hidedetailsRadio"/> Yes<html:radio
														property="isHide" value="false"
														styleId="hidedetailsRadio1" onclick="validateHideDetails()"/>No</td>
													<td class="heading"></td>
													<td colspan="3" class="heading">
													<div align="right"></div>
													</td>
												...
												<tr>
													...
													<table width="82" border="0" cellspacing="0"
														...
														<tr>
															<td width="60">
															<div align="left"><html:text
																property="hidedetailsDate"
																styleId="hidedetailsDate" maxlength="10" ></html:text></div>
															</td>
															<td width="40"><script language="JavaScript">
													new tcal( {
														// form name
													...
													<td width="21%" class="row-even"><html:textarea
														property="hidedetailReasons"
														styleId="hidedetailReasons"
														onkeypress="return imposeMaxLength(event,this.value)" ></html:textarea>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" border="0" align="center" cellpadding="0"
										...
										<td class="row-odd"> TC Approved:</td>
										<td class="row-even" colspan="6">
											<html:radio property="applicantDetails.isTcApproved" name="studentEditForm" styleId="isTcApproved" value="true"><bean:message key="knowledgepro.applicationform.yes.label"/></html:radio>
											<html:radio property="applicantDetails.isTcApproved" name="studentEditForm" styleId="isTcApproved" value="false"><bean:message key="knowledgepro.applicationform.No.label"/></html:radio>
										</td>
										</tr>
									</table>
									</td>
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="51%" height="45" align="left"><html:button property="" onclick="cancelMe('initStudentEditAfterSubmit')" styleClass="formbutton" value="Cancel"></html:button></td>
			</tr>
		</table>
		</td>
	</tr>
...
document.getElementById("nccgrade").value=document.getElementById("nccgrade1").value;
