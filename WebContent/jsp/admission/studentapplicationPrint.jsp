...
<html:form action="/AdmissionStatus" method="POST">
	    ...
	    <table width="100%">
	      <tr>
	        <td width="50%">
	          <table >
	           <tr>
	            <td>Reg. No</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.applnNo"/></td>
	           </tr>
	           <tr>
	...
	<tr>
	  <td class="title" align="center">APPLICATION FOR ADMISSION TO UNDERGRADUATE PROGRAMME - 2015<br></br></td>
	</tr>
	</logic:equal>

	<logic:equal value="2" name="admissionFormForm" property="applicantDetails.programType">
	<tr>
	  <td class="title" align="center">APPLICATION FOR ADMISSION TO POSTGRADUATE PROGRAMME - 2015<br></br></td>
	</tr>
	</logic:equal>
	    ...
	    <tr><td><p></p></td></tr>
	      ...
	      <td>
	        ...
	        <tr>
	     <td>1.</td><td class="algn">Name</td><td>: </td><td><nested:write name="admissionFormForm" property="applicantDetails.personalData.firstName"></nested:write>&nbsp;
	   ...
	   <tr>
	     <td>2.</td><td class="algn">Gender</td><td>: </td><td><logic:equal name="admissionFormForm" property="applicantDetails.personalData.gender" value="MALE"><bean:message key="admissionForm.studentinfo.sex.male.text"/></logic:equal>
	   ...
	   <tr>
	     <td>3.</td><td class="algn">Date of Birth</td><td>: </td><td><nested:write name="admissionFormForm" property="applicantDetails.personalData.dob"></nested:write></td>
	   </tr>
	   
	   <tr>
	     <td>4.</td><td class="algn">Nationality</td><td>: </td><td><bean:write	name="admissionFormForm" property="applicantDetails.personalData.citizenship" /></td>
	   </tr>
	   ...
	   <tr>
	     <td>9.</td><td class="algn">Name of Father</td><td>: </td><td><nested:write name="admissionFormForm" property="applicantDetails.titleOfFather"/>. 
											<nested:write name="admissionFormForm" property="applicantDetails.personalData.fatherName"></nested:write></td><td class="algn">Occupation</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.fatherOccupation" /></td>
	   </tr>
	   <tr>
	     <td>10.</td><td class="algn">Name of Mother</td><td>: </td><td><nested:write name="admissionFormForm" property="applicantDetails.titleOfMother"/>. 
											<nested:write name="admissionFormForm" property="applicantDetails.personalData.motherName"></nested:write></td><td class="algn">Occupation</td><td>: </td><td><bean:write
												                                                                                                    name="admissionFormForm"
												                                                             property="applicantDetails.personalData.motherOccupation" /></td>
	   </tr>
	   
	   <tr>
	     <td>11.</td><td class="algn">Permanent Address</td><td>: </td><td><nested:write name="admissionFormForm" property="applicantDetails.personalData.permanentAddressLine1"></nested:write></td></tr>
	   <tr>
	   <td></td><td></td><td> </td><td class="algn"><nested:write name="admissionFormForm" property="applicantDetails.personalData.permanentAddressLine2"></nested:write>,<nested:write name="admissionFormForm" property="applicantDetails.personalData.permanentCityName"></nested:write>
										</td>
	   </tr>
	   <tr>
	   ...
	   <tr>
	     <td>12.</td><td class="algn">Present Address</td><td>: </td><td><nested:write name="admissionFormForm" property="applicantDetails.personalData.currentAddressLine1"></nested:write></td></tr>
	   <tr>
	   <td></td><td></td><td> </td><td class="algn"><nested:write name="admissionFormForm" property="applicantDetails.personalData.currentAddressLine2"></nested:write>,
	   ...
	   <tr>
	     <td>13.</td><td class="algn">Phone Land</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.landlineNo"/></td>
	   </tr>
	   
	   <tr>
	     <td></td><td class="algn">Mobile</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.mobileNo"/></td>
	   </tr>
	   
	   <tr>
	     <td>14.</td><td class="algn">E - Mail</td><td>: </td><td><nested:write name="admissionFormForm" property="applicantDetails.personalData.email"></nested:write></td>
	   </tr>
	   ...
	   <tr>
	    ...
	    <tr>
	     <td>16.</td><td class="algn">Father Annual Income</td><td>: </td><td><nested:write name="admissionFormForm" property="applicantDetails.personalData.fatherIncome"></nested:write></td>
	   </tr>
	   <tr>
	     <td>17.</td><td class="algn">Claim for Reservation</td><td>: </td><td>
	   ...
	   <tr>
	     <td>18.</td>
	     	<td class="algn">is NCC</td>
	     	<td>: </td>
	     	<td>
	     		<logic:equal value="true" name="admissionFormForm" property="applicantDetails.personalData.ncccertificate">
	     		<bean:message key="knowledgepro.yes"/>
	     		<logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.nccgrades">
	     		,<bean:write name="admissionFormForm" property="applicantDetails.personalData.nccgrades"/>
	     		</logic:notEmpty>
	     		</logic:equal>
	     		<logic:equal value="false" name="admissionFormForm" property="applicantDetails.personalData.ncccertificate">
	   ...
	   <tr>
	     <td>19.</td>
	     <td class="algn">is NSS</td>
	     <td>: </td>
	     <td>
	     	<logic:equal value="true" name="admissionFormForm" property="applicantDetails.personalData.nsscertificate">
	     		<bean:message key="knowledgepro.yes"/>
	     		<logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.nssgrades">
	     		,<bean:write name="admissionFormForm" property="applicantDetails.personalData.nssgrades"/>
	     		</logic:notEmpty>
	     		</logic:equal>
	     		<logic:equal value="false" name="admissionFormForm" property="applicantDetails.personalData.nsscertificate">
	     		<bean:message key="knowledgepro.no"/>
	     		<logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.nssgrades">
	     		,<bean:write name="admissionFormForm" property="applicantDetails.personalData.nssgrades"/>
	     		</logic:notEmpty>
	...
	<tr>
	 <td>
	   <table>
	   	 ...
	   	 <logic:equal value="1" name="admissionFormForm" property="applicantDetails.programType">
	     <tr>
	       <td>18.</td><td>No. of chances taken to pass plus two</td><td>: </td><td><%=noofattempt %></td>
	     </tr>
	     </logic:equal>
	     
	   	 <logic:equal value="2" name="admissionFormForm" property="applicantDetails.programType">
	     <tr>
	       <td>18.</td><td>No. of chances taken to pass degree</td><td>: </td><td><%=noofattempt %></td>
	     </tr>
	     </logic:equal>

	     <tr><td><br></br></td></tr>
	     <tr>
	       <td>19.</td><td>Preference Details</td>
	    </tr>
	   </table>
	    </td>
    </tr>
    ...
    <logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.recommentedBy">
    <tr>
	     <td>20.</td><td class="algn">Recommended By</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.recommentedBy"/></td>
	 </tr>
	   </logic:notEmpty>
	    <logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.recommentedPersonDesignation">
	   <tr>
	     <td> 21.</td><td class="algn">Recommended Person Designation</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.recommentedPersonDesignation"/></td>
	   </tr>
	   </logic:notEmpty>
	   <logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.recommentedPersonMobile">
	   <tr>
	    <td> 22.</td><td class="algn">Recommended Person MobileNo</td><td>: </td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.recommentedPersonMobile"/></td>
	   </tr>
	   </logic:notEmpty>
	   <logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.nccgrades">
	   <tr>
	    <td> A.</td><td class="algn">NCC Grades</td><td>: </td><td width="10%">NCC ,</td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.nccgrades"/></td>
	   </tr>
	   </logic:notEmpty >
	   <logic:empty name="admissionFormForm" property="applicantDetails.personalData.nccgrades">
	    <tr>
	    <td> A.</td><td class="algn">NCC Grades</td><td>: </td><td></td>
	   </tr>
	   </logic:empty>
	   <logic:notEmpty name="admissionFormForm" property="applicantDetails.personalData.nssgrades">
	   <tr>
	    <td> B.</td><td class="algn">NSS Grades</td><td>: </td><td width="10%">NSS ,</td><td><bean:write name="admissionFormForm" property="applicantDetails.personalData.nssgrades"/></td>
	   </tr>
	   </logic:notEmpty >
	    <logic:empty name="admissionFormForm" property="applicantDetails.personalData.nssgrades">
	    <tr>
	    <td> B.</td><td class="algn">NSS Grades</td><td>: </td><td></td>
	   </tr>
	   </logic:empty>
	   </table></td></tr>
	   <tr>
