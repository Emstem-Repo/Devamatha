...
<html:form action="/AdmissionStatus" method="POST">
	...
	<tr>
	     <td align="left" class="mytabledata">Reg. No :  <bean:write name="admissionFormForm" property="applicantDetails.applnNo"/></td>
	     <td align="center" class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.mode"/> No :  <bean:write name="admissionFormForm" property="applicantDetails.journalNo"/></td>
	     <td align="right" class="mytabledata">Date :  <bean:write name="admissionFormForm" property="applicantDetails.challanDate"/></td>
	   </tr>
	...
	<tr>
	 ...
	 <table cellpadding="3" width="100%" border="0">
	   ...
	   <tr>
	     <td class="mytabledata">Name</td><td>: </td><td class="mytabledata"><nested:write name="admissionFormForm" property="applicantDetails.personalData.firstName"></nested:write>&nbsp;
				                    <nested:write name="admissionFormForm" property="applicantDetails.personalData.middleName"></nested:write>&nbsp;
				                    <nested:write name="admissionFormForm" property="applicantDetails.personalData.lastName"></nested:write></td><td>Photo</td><td></td><td rowspan="6"><img src='<%= request.getRequestURL().toString().replace(request.getRequestURI().substring(0), request.getContextPath()).concat("/PhotoServlet") %>'  height="150px" width="150px" /></td>
	   </tr>
	   
	   <tr>
	     <td class="mytabledata">Gender</td><td class="mytabledata">: </td><td class="mytabledata"><logic:equal name="admissionFormForm" property="applicantDetails.personalData.gender" value="MALE"><bean:message key="admissionForm.studentinfo.sex.male.text"/></logic:equal>
											<logic:equal name="admissionFormForm" property="applicantDetails.personalData.gender" value="FEMALE"><bean:message key="admissionForm.studentinfo.sex.female.text"/></logic:equal></td><td></td><td></td>
	   </tr>
	   
	   <tr>
	     <td class="mytabledata">Date of Birth</td><td class="mytabledata">: </td><td class="mytabledata"><nested:write name="admissionFormForm" property="applicantDetails.personalData.dob"></nested:write></td><td></td><td></td>
	   </tr>
	   
	   <tr>
	     <td class="mytabledata">Nationality</td><td class="mytabledata">: </td><td class="mytabledata"><bean:write	name="admissionFormForm" property="applicantDetails.personalData.citizenship" /></td><td></td><td></td>
	   </tr>
	   ...
	   <tr>
	     <td class="mytabledata">Phone-Land</td><td class="mytabledata">: </td><td class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.personalData.landlineNo"/></td><td class="mytabledata">Mobile</td><td class="mytabledata">:</td><td class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.personalData.mobileNo"/></td>
	   </tr>
	   
	   
	   <tr>
	     <td class="mytabledata">E - Mail</td><td class="mytabledata">: </td><td class="mytabledata"><nested:write name="admissionFormForm" property="applicantDetails.personalData.email"></nested:write></td><td></td><td></td><td></td>
	   </tr>
	...
	<td class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.bonsmark"/></td></tr>
	<tr><td class="mytabledata">Handicap Mark</td><td class="mytabledata">:</td>
	<td class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.handicapmark"/></td></tr> 
   ...
   <tr>
	...
	<tr>
	<td align="left" class="mytabledata">Admission Date: </td>
	</tr>
    <tr>
      <td>
       <table cellpadding="3" width="100%" align="center" border="1" class="mytable">
         <logic:equal value="true" name="admissionFormForm" property="applicantDetails.isRank">
           <tr class="title2">
             <td align="center">Preference No.</td><td align="center">Programme Allotted</td><td align="center">Category Under Which Allotment is Made</td><td align="center">Index Mark</td><td align="center">Rank</td>
           </tr>
           <tr>
            <td align="center" class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.pref"/></td><td align="center" class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.courseName"/></td><td align="center" class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.admittedThroughName"/></td><td align="center" class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.index"/></td><td align="center" class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.rank"/></td>
           	
           </tr>
          </logic:equal> 
          
           <logic:equal value="false" name="admissionFormForm" property="applicantDetails.isRank">
           <tr class="title2">
             <td align="center">Programme Allotted</td><td align="center">Category Under Which Allotment is Made</td>
           </tr>
           <tr>
           <td align="center" class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.courseName"/></td><td align="center" class="mytabledata"><bean:write name="admissionFormForm" property="applicantDetails.admittedThroughName"/></td>
