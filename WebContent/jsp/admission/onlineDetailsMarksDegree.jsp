                   ...
                   <table width="100%" cellspacing="1" cellpadding="2">
					...
					%>
                     ...
                     <%if(i<=3){%>
						...
						<td  class="row-even" >
						<nested:select property="<%=propertyName%>"  name="onlineApplicationForm" styleId='<%=propertyName%>' styleClass="combolarge" onchange='<%="dupsub("+i+");"%>' >
						...
						<td  class="row-even" >
						<nested:select property="<%=propertyName%>"  name="onlineApplicationForm" styleId='<%=propertyName%>' onchange='<%="displayOtherForSubject("+i+");"+"dupsub("+i+");" %>' styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
						...
						<td  class="row-even" >
						<nested:select disabled="false" property="<%=propertyName%>"  name="onlineApplicationForm" styleId='<%=propertyName%>' onchange='<%="displayOtherForSubject("+i+")" %>' styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
                   ...
                   <table width="100%" cellspacing="1" cellpadding="2">
					...
					%>
                     ...
                     <%if(i<=13){%>
						...
						<td  class="row-even" >
						<nested:select property="<%=propertyName%>"  name="onlineApplicationForm" styleId='<%=propertyName%>'  styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admCoreMap" name="onlineApplicationForm" label="value" value="key"/>
						...
						<td  class="row-even" >
						<nested:select disabled="true" property="<%=propertyName%>"  name="onlineApplicationForm" styleId='<%=propertyName%>' onchange='<%="displayOtherForSubject("+i+")" %>' styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admCommonMap" name="onlineApplicationForm" label="value" value="key"/>
