    ...
    <td>     <table width="100%" height="347"  border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                  ...
                  <tr>
					...
					%>
                     <tr>
                         <td  class="row-even" align="center"> <%=i %>
                         </td>
					...
					<tr>
						...
						<td class="row-odd" colspan="2" ><div align="right">TOTAL MARKS / TOTAL GRADEPOINTS:&nbsp;</div></td>
                 ...
                 <%-- 
                  <tr>
                    <td width="45%" height="35"><div align="right">
                        <html:button property="" onclick="submitAdmissionForm('submitDetailMarkConfirm')" styleClass="formbutton" value="Submit"></html:button>
                    </div></td>
                  ...
                  <tr>
                    <td width="45%" height="35" colspan="2"><div align="right">
                         <html:button property="" onclick="submitAdmissionForm('submitDetailMarkConfirm')" styleClass="btn" value="Submit"></html:button>
                    ...
                    <%--<html:button property=""  styleClass="formbutton" value="Cancel" onclick='submitConfirmCancelButton()'></html:button>--%>
                    &nbsp; <html:button property="" onclick="submitConfirmCancelButton()" styleClass="cancelbtn" value="Cancel"></html:button>
