                    ...
                    <tr>
                      ...
                      <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                          <tr >
                            ...
                            <td class="row-odd"><font style="font-size: 15px"><bean:message key="knowledgepro.hostel.photo"/></font></td>
                          </tr>
              ...
              <tr>
                <td height="10" class="body" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <html:submit styleClass="formbutton" property=""  onclick="cancelMe('initStudentEdit')" >Close</html:submit>
                      </div>
					  </td>
                      <td width="52%"></td>
                    </tr>
