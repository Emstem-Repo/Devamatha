...
<html:form action="/AdmissionStatus" method="POST">
	...
	<table width="100%" border="0"  cellpadding="3" cellspacing="0" bordercolor="#E0DFDB">		
	 <tr>
		...
		<%-- 
		  ...
		  --%> <img width="600" height="135"  src="images/admission/images/headerlogo.png" alt="Logo not available">
		</td>
	</tr>	
	<tr><td></td></tr>
	<tr>
	...
	<tr>
	  <td align="center" class="mytabledata">Memo to be Produced Before the Principal for Admission</td>
	</tr>
	 ...
	 <table cellpadding="3" width="100%" border="0">
	   ...
	   <%String noofattempt = ""; 
          ...
          <nested:iterate property="applicantDetails.ednQualificationList" id="ednQualList" indexId="count">
	   	...
	   	<td class="mytabledata"><bean:write name="admissionStatusForm" property="applicantDetails.personalData.subregligionName" /></td>
		<td class="mytabledata">Board of Qualifying Examination</td>
		<td class="mytabledata">:</td>
	   ...
	   <tr>
	     ...
	     <td class="mytabledata">: </td>
	     <td class="mytabledata"><bean:write name="admissionStatusForm" property="applicantDetails.personalData.mobileNo"/></td>
	   ...
	   <tr>
	     ...
	     <td class="mytabledata">: </td>
	     <td class="mytabledata"><nested:write property="applicantDetails.personalData.email"></nested:write></td>
	     <td class="mytabledata">Bonus Mark</td>
	     <td class="mytabledata">:</td>
	     <td class="mytabledata"><bean:write name="admissionStatusForm" property="applicantDetails.bonsmark"/></td>
	   </tr>
	...
	<tr>
	  <td align="center" class="title2">Statement of Plus Two Marks</td>
	</tr>
	</logic:equal>
	
 	<logic:equal value="2" name="admissionStatusForm" property="applicantDetails.programType">
	<tr>
	  <td align="center" class="title2">Statement of Degree Marks</td>
	</tr>
	</logic:equal>
    ...
    <tr>
      <td>
        <table cellpadding="3" width="100%" align="center" border="1" class="mytable">
           <tr class="title2">
             <td align="center">Preference No.</td><td align="center">Programme</td><td align="center">Category</td><td align="center">Status</td><td align="center">Fees</td><td align="center">Date and Time</td>
           </tr>
