...
function getStudentsDetails(){
	...
	document.getElementById("method").value = "getStudentsForCourseAssignment";
...
function cancelPage(){
	document.location.href="applicationEdit.do?method=initAssignCoursesToStudent";
}



function assignCoursesToStudent() {
	document.getElementById("method").value = "assignCoursesToStudent";
	document.applicationEditForm.submit();
...
<html:hidden property="method" styleId="method" value="initAssignCoursesToStudent"/>
...
<table width="100%" border="0">
		<tr>
			...
			Assign Courses To Student &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> Assign Courses To Student</strong></td>
			...
			<tr>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
										<tr>
										<td align="center" class="row-odd">Rank</td>
										...
										<td align="center" class="row-odd">Is Satisfied</td>
											...
											<nested:iterate id="to" property="studentList"	name="applicationEditForm" indexId="count">
												<tr>
													...
													<td align="center" class="row-even">
														<nested:radio property="isSatisfied" value='true'>YES</nested:radio>
														<nested:radio property="isSatisfied" value='false'>NO</nested:radio>
													</td>
