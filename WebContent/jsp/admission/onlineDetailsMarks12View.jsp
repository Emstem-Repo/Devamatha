              ...
              <tr>
                   ...
                   <table width="100%" cellspacing="1" cellpadding="2">
                     ...
                     <tr>
						...
						<td class="row-odd" width="25%"><div align="center">Subject Name </div></td>
					...
					for(int i=1;i<=CMSConstants.MAX_CANDIDATE_CLASS12_SUBJECTS;i++) {
						...
						String dynajs="updatetotalMarkClass12("+CMSConstants.MAX_CANDIDATE_CLASS12_SUBJECTS+")";
						String obtainMarkprop="detailMark.subject"+i+"ObtainedMarks";
						String dynajs2="updateObtainMarkClass12("+CMSConstants.MAX_CANDIDATE_CLASS12_SUBJECTS+")";
					...
					%>
                     ...
                     <%if(i==1){%>
						...
						<td  class="row-even" >
						<nested:select property="<%=propertyName%>" disabled="true" name="onlineApplicationForm" styleId='<%=propertyName%>' styleClass="combolarge">
                    			<html:option value="">--Select--</html:option>
                    			<html:optionsCollection property="admSubjectLangMap" name="onlineApplicationForm" label="value" value="key"/>
