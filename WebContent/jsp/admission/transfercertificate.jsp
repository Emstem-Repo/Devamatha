...
function printTc(studentId,classId)
{
	if(validateTC(studentId))
	{	
		...
		if(document.getElementById("tcDate")!=null){
			var tcDate=document.getElementById("tcDate").value;
		}
		var duplicate;
		var includeFail;
		...
		else
		{
			...
			var tcFor=document.getElementById("tcFor").value;
			if(document.getElementById("includeFailYes").checked)
			{
				includeFail="Yes";
			}
			else
		...
		{				
			url = "transferCertificate.do?method=rePrintTCByClass&classes="+classes+"&year="+year+"&fromUsn="+fromUsn+"&toUsn="+toUsn+"&formName=transferCertificateForm&pageType=1&tcType="+tcType+"&tcFor="+tcFor+"&includeFail="+includeFail+"&studentId="+studentId;
		}
		else
		{
			if(document.getElementById("toCollege").value=="Cjc")
				url = "transferCertificate.do?method=printTCForCjc&classes="+classes+"&year="+year+"&fromUsn="+fromUsn+"&toUsn="+toUsn+"&formName=transferCertificateForm&pageType=1&tcType="+tcType+"&tcFor="+tcFor+"&includeFail="+includeFail+"&studentId="+studentId;			
			else
				url = "transferCertificate.do?method=printTC&classes="+classes+"&year="+year+"&fromUsn="+fromUsn+"&toUsn="+toUsn+"&formName=transferCertificateForm&pageType=1&duplicate="+duplicate+"&tcDate="+tcDate+"&studentId="+studentId;
		}		
		myRef = window.open(url,"TC","left=20,top=20,width=600,height=500,toolbar=10,resizable=0,scrollbars=1");		
	}	
}
function getCandidatesForTCPrint(){
	var fromReg=document.getElementById("fromUsn").value;
	var toReg=document.getElementById("toUsn").value;
	var classes=document.getElementById("classes").value;
	var year=document.getElementById("academicYear").value;
	var studentName=document.getElementById("studentName").value;	
	document.getElementById("method").value = "getCandidatesForTCPrint";	
...
<script>
		function verifyTCNumbers() 
		{
			var classes=$('#classes').val();
			var year=$('#academicYear').val();
			var formName = $('#formName').val();
			var pageType = $('#pageType').val();
			var startingTCNumber = $('#startingTCNumber').val();
			var prefixForTCNumber = $('#prefixForTCNumber').val();
			var flag = true;
...
<html:form action="/transferCertificate" method="post">
	<html:hidden property="formName" value="transferCertificateForm" styleId="formName"/>
		                       						...
		                       						<td valign="top">
		                       							<table width="100%" cellspacing="1" cellpadding="2">
					                  						...
					                  						<tr>
					                  							...
					                  							<td class="row-even">
					                  								<html:select name="transferCertificateForm" styleId="tcType" property="tcType">
					                  									...
					                  									<html:option value="Duplicate(Discontinued)">Duplicate(Discontinued)</html:option>
					                  								</html:select>
					                  							</td>
					                  						</tr>
					                  						<tr>
					                						...
					                						<tr>
																...
																<logic:equal value="Christ" property="toCollege" name="transferCertificateForm">
																<td class="row-odd" align="center" style="display: none;"></td>
		                                                       <td class="row-even" style="display: none;"></td>
								...
								<nested:iterate id="bdForm" name="transferCertificateForm" property="allStudentsForTcPrint" indexId="count">
									<tr class="row-even"> 
										...
										<img src="images/print-icon.png"
													width="16" height="18"
													onclick="printTc(<bean:write name="bdForm" property="studentId"/>,<bean:write name="bdForm" property="classId"/>)" />
								 </td>
									</tr>
								</nested:iterate>
