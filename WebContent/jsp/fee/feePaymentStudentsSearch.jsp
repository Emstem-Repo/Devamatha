...
<html:form action="/FeePayment">
	<html:hidden property="method" styleId="method"
		value="displayFeePaymentDetails" />
	...
	<html:hidden property="optionalFeeSelectedIndex"
		styleId="optionalFeeSelectedIndex" />
	<input type="hidden" name="ligExemption"
		value='<bean:write	name="feePaymentForm"	property="ligExemption" />' />
	<input type="hidden" name="casteExemption"
		value='<bean:write name="feePaymentForm"	property="casteExemption" />' />
	<html:hidden property="admittedThroughName"
		styleId="admittedThroughName" />
									...
									<table width="100%" cellspacing="1" cellpadding="1">
										...
										<tr>
											...
											<td class="row-white" align="left"><bean:write
												property="year" name="feePaymentForm" /></td>
											<td class="row-odd" align="right"><bean:message
												key="knowledgepro.admission.className" />:</td>
											<td class="row-white" align="left"><bean:write
												property="className" name="feePaymentForm" /></td>
										</tr>

										<tr>
											<td width="19%" class="row-odd">
											<div align="right"><bean:message
												key="knowledgepro.fee.optionalfeegroup" />:</div>
											</td>
											<td width="34%" class="row-even" align="left"><html:select
												property="selectedfeeOptionalGroup" size="2" multiple="true"
												styleId="feeGroupId1" style="width:170px;height:100px">
												<html:optionsCollection name="feePaymentForm"
													property="feeOptionalGroupMap" label="value" value="key" />
											</html:select></td>
											<td width="19%" class="row-odd">
											<div align="right">Apply Fees Exemption:</div>
											</td>
											<td width="34%" class="row-even" align="left"><input
												type="radio" name="isFeeExemption" id="isFeeExemption_1"
												value="true" /> <bean:message key="knowledgepro.yes" /> <input
												type="radio" name="isFeeExemption" id="isFeeExemption_2"
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="1">
										...
										<logic:notEmpty property="studentListForFee"
											name="feePaymentForm">
											...
											<logic:iterate id="list" property="studentListForFee"
												name="feePaymentForm">
												<tr height="30px">
