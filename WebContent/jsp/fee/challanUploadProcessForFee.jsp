...
<html:hidden property="method" styleId="method" value="updateChallanUploadProcessForFee"/>
...
<table width="100%" border="0">
		<tr>
			...
			Fee Challan Upload Process &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> Fee Challan Upload Process</strong></td>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              <tr><td width="15%" class="row-odd" width="25%">
