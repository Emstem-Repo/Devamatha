...
<script type="text/javascript">
	function addFeeBillNumber() {
		document.getElementById("method").value = "addFeeBillNumber";
	}
	function editFeeBillNumber(id) {
		document.location.href = "FeeBillNumber.do?method=editFeeBillNumber&id="
				+ id;
	}
	function updateFeeBillNumber() {
			document.getElementById("method").value = "updateFeeBillNumber";
	}
	function reActivate() {
		var academicyear = document.getElementById("year").value;
		document.location.href = "FeeBillNumber.do?method=reActivateFeeBillNumber&academicYear=" + academicyear;
	}
	function deleteFeeBillNumber(id) {
		deleteConfirm = confirm("Are you sure want to delete this entry?")
		if (deleteConfirm) {
			document.location.href = "FeeBillNumber.do?method=deleteFeeBillNumber&id="
					+ id;
		}
	}
...
<html:form action="/FeeBillNumber" method="post">
	<html:hidden property="method" styleId="method" />
	<html:hidden property="formName" value="feeBillNumberForm" />
	<html:hidden property="id" />
	<html:hidden property="pageType" value="1" />
	<c:choose>
	<c:when test="${operation == 'edit'}">
			<html:hidden property="method" styleId="method"
				value="updateFeeBillNumber" />
		</c:when>
		</c:choose>
	<table width="99%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message
				key="knowledgepro.fee.feebillnumber" /> &gt;&gt;</span> </span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="heading_white"><bean:message
						key="knowledgepro.fee.feebillnumber" /></td>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<div align="right"><span class="Mandatory">*</span><bean:message
										key="knowledgepro.fee.billno.colon" /></div>
									</td>
									<td width="32%" height="25" class="row-even"><label></label>
									<span class="star"> <html:text property="billNo"
										styleId="bno" size="10" maxlength="10" /> </span></td>
									...
									<div align="left"><span class="star"> <input
										...
										value='<bean:write name="feeBillNumberForm" property="academicYear"/>' />
									...
									<div align="right"><c:choose>
										<c:when test="${operation == 'edit'}">
											<html:submit property="" styleClass="formbutton"
												onclick="updateFeeBillNumber()">
												<bean:message key="knowledgepro.update" />
											</html:submit>
										</c:when>
										<c:otherwise>
											<html:submit property="" styleClass="formbutton"
												onclick="addFeeBillNumber()">
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										<tr>
											...
											<td height="25" class="row-odd" align="center"><bean:message
												key="knowledgepro.fee.billno" /></td>
											<td height="25" class="row-odd" align="center"><bean:message
												key="knowledgepro.fee.concession.slip.book.year"/></td>
											<td class="row-odd">
											<div align="center"><bean:message
										...
										<logic:notEmpty name="feeBillNumberForm"
											property="feeBillNumberList">
											<logic:iterate id="fee" name="feeBillNumberForm"
												property="feeBillNumberList" indexId="count">
													...
													<c:when test="${temp == 0}">
														<tr>
															...
															<td width="41%" class="row-even" align="center"><bean:write
																name="fee" property="academicYear" /></td>
															<td width="6%" height="25" class="row-even">
															<div align="center"><img src="images/edit_icon.gif"
																width="16" height="18" style="cursor:pointer"
																onclick="editFeeBillNumber('<bean:write name="fee" property="id" />')" /></div>
															</td>
															<td width="6%" height="25" class="row-even">
															<div align="center"><img
																src="images/delete_icon.gif" width="16" height="16" style="cursor:pointer"
																onclick="deleteFeeBillNumber('<bean:write name="fee" property="id"/>')"></div>
															</td>
														</tr>
