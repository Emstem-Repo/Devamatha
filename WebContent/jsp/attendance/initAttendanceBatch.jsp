...
<script type="text/javascript">
	...
	function getMultipleSubject(classId) {
		...
		getSubjectByType("subjectMaps",selectedArray,"subject",updateSubject);
	}
...
<html:form action="/attendanceBatch" method="post">
	<html:hidden property="method" styleId="method" value="getPracticalBatchDetails" />
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td width="20%" class="row-even"><input type="hidden" 
										id="yr" name="yr"
										value='<bean:write name="attendanceBatchForm" property="year"/>' />
									...
									<td class="row-even">
									<html:select property="classesId" size="5" style="width: 200px;"
										styleId="class" onchange="getMultipleSubject(this.value)" multiple="multiple">
									...
									<td width="34%" class="row-even"><html:select style="width:275px"
										...
										<c:choose>
											...
											<c:otherwise>
												<c:if
													test="${attendanceBatchForm.subjectId != null && attendanceBatchForm.subjectId != ''}">
								...
								<tr>
								 <td height="25" class="row-odd">
				                  ...
				                  <td class="row-even" >
				                  <html:select  property="attendanceType" styleId="attendanceTypeId" name="attendanceBatchForm"  onchange="getMandatory(this.value)">
				                  <html:option value="">
											<bean:message key="knowledgepro.select" />-</html:option>
				                  	<logic:notEmpty name="attendanceBatchForm" property="attendanceTypes">
				                  	<html:optionsCollection name="attendanceBatchForm" property="attendanceTypes" label="value" value="key"/>
				                  	</logic:notEmpty>
				                  </html:select>
				                  </td>
								 <td class="row-odd" >
				                  ...
				                  <td class="row-even" >
				                  <html:select style="width:175px" name="attendanceBatchForm" property="activityAttendance" styleId="activityId" styleClass="comboMediumLarge">
				                    <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
				                    <logic:notEmpty name="attendanceBatchForm" property="activityMap">
				                    		<html:optionsCollection name="attendanceBatchForm" property="activityMap" label="value" value="key"/>
				                    		</logic:notEmpty>
				                    </html:select></td>
				                  <td class="row-odd"></td>
