...
function updateAttendanceTypeid(req) {
 ...
 function checkOtherDuty(val){
	 if (val=="other") {
		 document.getElementById("dutyOther").style.display = "block";
	}else{
		document.getElementById("dutyOther").style.display = "none";
		document.getElementById("platformOther").value=""
	}
	 
 }
function checkOtherPLatform(val){
	 if (val=="other") {
		 document.getElementById("platformOther").style.display = "block";
	}else{
   ...
   img.tcalIcon {
	...
	<div class="col-sm-12"  style="border-style: solid;border-color: #29953b;">
        <div class="form-group">
	       ...
	       <font color="red" size="4"><div id="errorMessage" >
               ...
               <div class="form-group">
                 <div class="col-sm-12">
                  ...
                  <!--  <div class="col-sm-3">
                                  <input class="form-control"  name="attendanceEntryForm" type="date" value="yyyy-mm-dd" id="example-date-input" onchange="getClasses()" >
                                    </div>--><!--            
                 <div class="col-sm-2"><html:text size="15" name="attendanceEntryForm" styleId="attendancedate" property="attendancedate" styleClass="form-control"/></div>
                  -->
                  
                  <div class="col-sm-2">
                    
                   <html:text  size="15" name="attendanceEntryForm" styleId="attendancedate" property="attendancedate" styleClass="form-control" style="width: 156px;"/>
         ...
         format: 'dd/mm/yyyy'
                 ...
                 <div class="col-sm-2"><span class="Mandatory" style="color:red;">*</span><b><bean:message key="knowledgepro.fee.academicyear"/>:</b></div>
		          <div class="col-sm-2">
					...
					<html:radio styleClass="rdio rdio-primary" property="timeTableFormat" value="no" onclick="changeJavaScript(this.value,true)"> No</html:radio>
					 </div>
                </div>
                </div>             
               <div class="form-group">
                 ...
                 <div class="col-sm-2">
                  ...
                  <c:choose>
                 	 ...
                 	 <c:otherwise>
                 	 	  <html:select name="attendanceEntryForm" size="5" styleId="teachers" property="teachers" multiple="multiple" style="width: 250px;" styleClass="form-control">
                 ...
                 <div class="col-sm-2">
			                  <c:choose>
			                  	<c:when test="${attendanceEntryForm.classMandatry == 'yes'}">
			                 		 <div id="classsdiv" align="right"><span class='MandatoryMark'style="color:red;">*</span><b><bean:message key="knowledgepro.attendanceentry.class"/>:</b></div>
			                 	 </c:when>
			                 	 <c:otherwise>
			                 	 	 <div id="classsdiv" align="right"><b><bean:message key="knowledgepro.attendanceentry.class"/>:</b></div>
			                 	 </c:otherwise>
			                  </c:choose>
			                  </div>
                		...
                		<div id="periodDisplayId">
		                  ...
		                  <c:choose>
		                  	<c:when test="${attendanceEntryForm.periodMandatory == 'yes'}">
		                  		<div id="perioddiv" align="right"><span class='MandatoryMark'style="color:red;">*</span><b><bean:message key="knowledgepro.attendanceentry.period"/>:</b></div>
		                  	</c:when>
		                  	<c:otherwise>
		                  	    <div id="perioddiv" align="right"><b><bean:message key="knowledgepro.attendanceentry.period"/>:</b></div>
		                  	</c:otherwise>
		                  </c:choose>
		                  </div>
		                  <div class="col-sm-2">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-2">
                  ...
                  <div class="col-sm-4"><label>
                    <html:select style="width: 158px;" property="subjectId" styleId="subjectId" styleClass="btn btn-white dropdown-toggle" onchange="getBatches1(this.value);getAttendanceTypeid(this.value);">
                       <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
                   ...
                   <c:choose>
                    ...
                    <c:otherwise>
                    	<div id="batchdiv"><font style="font-size: 15px"><b><bean:message key="knowledgepro.attendanceentry.batchname"/>:</b></font></div>
                    </c:otherwise>
                   </c:choose>
                   </div> 
                   <div class="col-sm-2">
                     <div >
                   <html:select name="attendanceEntryForm" styleId="batchId" property="batchIdsArray" styleClass="btn btn-white dropdown-toggle">
                  ...
                  <div align="right"  id="attendanceTypeId1" style="display: block;"><span class='MandatoryMark'>*</span><b><bean:message key="knowledgepro.attendanceentry.type"/>:</b></div>
                  </div>
                   <div class="col-sm-2" style="display: none"><div id="attendanceTypeId2" style="display: block;">
                 ...
                 <div class="col-sm-11">               
                  ...
                  <c:choose>
                  	<c:when test="${attendanceEntryForm.activityTypeMandatory == 'yes'}">
                  		<div id="activitydiv" align="right"><span class='MandatoryMark'style="color:red;">*</span><bean:message key="knowledgepro.attendanceentry.activitytype"/>:</div>
                    </c:when>
                    <c:otherwise>
                    ...
                    <div class="col-sm-2" style="display: none">
                  <html:select name="attendanceEntryForm" property="activityId" styleId="activityId" styleClass="comboMediumLarge" onchange="getBatchesForClassesActivity1()">
                    <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
                    ...
                    <div class="col-sm-2" style="display: none;"><div align="right" id="hoursHeld1" style="display: none;"><span class='MandatoryMark'>*</span><bean:message key="knowledgepro.attendanceentry.hoursheld"/>:</div></div>
                   <div class="col-sm-2" style="display: none;"><div id="hoursHeld2" style="display: none;">
                 ...
                 <div class="col-sm-11">               
                  ...
                  <html:select name="attendanceEntryForm" style="padding: 5px;margin-left: 20px;" property="dutyType" styleId="duty" styleClass="comboMediumLarge" onchange="checkOtherDuty(this.value);">
                   <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
                    ...
                    <div class="col-sm-2" >
                    	<div align="right"><b><bean:message key="knowledgepro.attendanceentry.platform"/>:</b></div>
                  </div>
                    <div class="col-sm-2" >
         	...
         	<div align="right"><b><bean:message key="knowledgepro.attendanceentry.topic.taught"/>:</b></div>
            </div>
            ...
            <div class="col-sm-12 text-center">
           	<button type="button" class="btn btn-success" value="  Next  >>  " onclick="submitData()"> Next  >></button>
            </div>
          </div>
          </div>
          </div>
