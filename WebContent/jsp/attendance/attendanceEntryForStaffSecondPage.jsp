...
<html:form action="/AttendanceEntryForStaff" method="post">
	...
	<html:hidden property="method" styleId="method" value="initAttendanceEntryThirdPage"/>
        ...
        <td valign="top" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <table width="100%" cellspacing="1" cellpadding="2">
                <tr >
                  <td height="25" class="row-odd" ><div align="right"><bean:message key="knowledgepro.attendanceentry.prefix"/>  :</div></td>
                  <td class="row-even" ><label>
                    <html:text property="prefix" name="attendanceEntryForm" maxlength="10" styleClass="TextBox"></html:text>
                  </label></td>
                  </tr>
                <tr >
                  <td height="25" class="row-odd" ><div align="right"><bean:message key="knowledgepro.attendanceentry.absentees"/>  :</div></td>
                  <td class="row-even" >
					<html:textarea property="absentees" name="attendanceEntryForm" cols="30" rows="3">
					</html:textarea>
                  </td>
                  </tr>
              </table>
