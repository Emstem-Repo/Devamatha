...
<script type="text/javascript">
	function getAttendanceMarks() {
		...
		document.getElementById("method").value = "getAttendanceMarks";
	...
	<table width="99%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message
				...
				key="knowledgepro.exam.attendanceMarks" />&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td height="35" align="center"><html:button property=""
								styleClass="formbutton" value="Search" onclick="getAttendanceMarks()"></html:button>
