  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/Tcenter.gif" class="heading_white" ><bean:message key="knowledgepro.attendanceentry.viewattendance"/></td>
          ...
          <tr>
            ...
            <td valign="top">
	            ...
	            <table width="100%" cellspacing="1" cellpadding="2">
	               ...
	               <td class="row-even" >
	               <html:text name="attendanceEntryForm" styleId="hoursHeld" property="hoursHeld" styleClass="TextBox" onkeypress="return isNumberKey(event)" maxlength="4" onblur="validNumber(this)"  disabled="true"/>
	               </td>
	               ...
	               <td class="row-odd" >
	                  ...
	                  <td class="row-even" >
	                  <html:select name="attendanceEntryForm" property="activityId" styleId="activityId" styleClass="combo" onchange="getBatches()" disabled="true">
	                    <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
      ...
      <tr>
        ...
        <tr >
          ...
          <tr>
            ...
            <html:button property="" styleClass="formbutton" value="Cancel" onclick="viewAttendanceFirstPage()"></html:button>
            </td>
