...
function changeList(searchvalue)
{
	...
	document.location.href = "CocurricularLeaveApproveEntry.do?method=searchCocurricularApplications&searchValue="+searchvalue;
	}
...
<html:form action="/CocurricularLeaveApproveEntry">	
    ...
    <c:choose>
		<c:when test="${stateOperation != null && stateOperation == 'View Rejected'}">
			<html:hidden property="method" styleId="method" value="approveCocurricularApplicationsByTeacher" />
		</c:when>
		<c:when test="${stateOperation != null && stateOperation == 'View Approved'}">
			<html:hidden property="method" styleId="method" value="cancelCocurricularApplicationsByTeacher" />
		</c:when>
		<c:otherwise>
			<html:hidden property="method" styleId="method" value="approveCocurricularApplicationsByTeacher" />	
		</c:otherwise>
		...
		<tr>
			<td class="Bredcrumbs">
			 ...
			 <span class="Bredcrumbs">&gt;&gt; <bean:message
				key="knowledgepro.attendance.approve.cocurricular.attendance.application.entry" /> &gt;&gt;</span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						...
						key="knowledgepro.attendance.approve.cocurricular.attendance.application.entry" /></strong></td>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr>
											...
											<div align="left"><bean:write
												...
												property="teacherName" /></div>
											</td>
											<td height="25" align="right" class="row-odd">
											<div align="right"><bean:message
												key="knowledgepro.attn.activity.activityname" /></div>
											</td>
											<td height="25" align="left" class="row-even">
											<div align="left"><bean:write
												name="cocurricularLeaveApproveForm" property="activityNames" />
											</div>
											</td>
										</tr>
										<tr>
				...
				<tr>
				 ...
				 <div align="right" style="padding-right: 100px;">  
						    ...
						    <option value="View Approved"> View Approved Application</option>
						    <option value="View Rejected "> View Rejected  Application</option>
						    </select>
						    </div>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<c:choose>
										<c:when
											test="${stateOperation != null && stateOperation == 'View Approved'}">
											<html:submit property="" styleClass="formbutton"
												value="Cancel Application" styleId="submitbutton">
											</html:submit>
										</c:when>
										<c:when
											test="${stateOperation != null && stateOperation == 'View Rejected'}">
											<html:submit property="" styleClass="formbutton"
												value="Re-Approve Application" styleId="submitbutton">
											</html:submit>
										</c:when>
										<c:otherwise>
											<html:submit property="" styleClass="formbutton"
												value="Approve Application" styleId="submitbutton">
											</html:submit>
										</c:otherwise>
									</c:choose></div>
									</td> 
