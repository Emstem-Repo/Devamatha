	            ...
	            <table width="100%" cellspacing="1" cellpadding="2">
	                <tr >
	                  ...
	                  <table width="82" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td width="60">
	                      <html:text name="attendanceEntryForm" size="15" styleId="attendancedate" property="attendancedate" styleClass="TextBox"/>
	                      </td>
	                ...
	                <tr >
	                  ...
	                  <td  class="row-even" >
	                   <html:select name="attendanceEntryForm" styleId="periods" property="periods" size="5" style="width:150px" multiple="multiple">
