...
function backPage() {
	document.location.href="AttendanceEntryForStaff.do?method=loadAttendanceEntrySecondPage";
}

function backToFirstPage() {
	document.location.href="AttendanceEntryForStaff.do?method=loadAttendanceEntryFirstPage";
}
