...
<html:hidden property="method" styleId="method" value="initAttendanceReEntrySecondPage"/>
	                       ...
	                       <table width="100%" cellspacing="1" cellpadding="2">
					        	<tr>
				        		   ...
				        		   <td class="row-even" align="left" width="25%">
				                           ...
				                           <html:select property="year" styleId="academicYear" name="attendanceReentryForm" styleClass="combo" onchange="getClasses(this.value)">
				                  ...
				                  <td class="row-odd" width="25%">
					               ...
					               <td class="row-even" width="25%">
					                  <html:select name="attendanceReentryForm" styleId="classes" property="classes">
					                  <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
				                ...
				                <tr>
									...
									<td class="row-even">
									<html:text name="attendanceReentryForm" property="fromDate" styleId="fromDate" size="10" maxlength="16"/>
							<script
							language="JavaScript">
							new tcal( {
								// form name
								'formname' :'attendanceReentryForm',
								// input name
				                ...
				                <tr>
				                	...
				                	<html:radio name="attendanceReentryForm" property="appNo" styleId="optional_1" value="1"/> App. No
					                <html:radio name="attendanceReentryForm" property="appNo" styleId="optional_2" value="2"/> Roll No
					                <html:radio name="attendanceReentryForm" property="appNo" styleId="optional_3" value="3"/> Reg. No
				                	</td>
