	                       ...
	                       <table width="100%" cellspacing="1" cellpadding="2">
					        <tr>
				                  ...
				                  <td class="row-odd" width="90">
					               ...
					               <td class="row-even" >
					                  <html:select name="attendanceEntryForm" styleId="classes" property="classes" size="5" style="width:120px" multiple="multiple">
					...
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                     ...
                     <tr>
                       ...
                       <td valign="top">
	                   	...
	                   	<table width="100%" cellspacing="1" cellpadding="2">
	                   	<tr><td style="height: 10px" align="center" colspan="8"></td></tr>
	                       <tr >
		                       ...
		                       <td width="10%" class="row-odd" ><div align="center">Teachers</div></td>
		                       <td width="10%" class="row-odd" ><div align="center"><bean:message key="knowledgepro.attendanceentry.subject"/></div></td>
		                       <td width="10%" class="row-odd" ><div align="center"><bean:message key="knowledgepro.attendanceentry.activity"/></div></td>
	                       ...
	                       <nested:iterate id="attendance" name="attendanceEntryForm" property="attendanceList" type="com.kp.cms.to.attendance.AttendanceTO" indexId="count">
		                       <c:choose>
	                           	 <c:when test="${temp == 0}">
				                       ...
				                       <td class="row-even" ><div align="center"><nested:write property="subject"/></div></td>
				                       <td class="row-even" ><div align="center"><nested:write property="activity"/></div></td>
				                       <td class="row-even" ><div align="center"><c:out value="${attendance.periods}" escapeXml="false"/></div></td>
				                       <td class="row-even" ><div align="center"><nested:write property="batch"/></div></td>
				                   </tr>
			                    ...
			                    <tr><nested:hidden property="id"></nested:hidden> 
				                       ...
				                       <td class="row-white" ><div align="center"><nested:write property="subject"/></div></td>
				                       <td class="row-white" ><div align="center"><nested:write property="activity"/></div></td>
				                       <td class="row-white" ><div align="center"><c:out value="${attendance.periods}" escapeXml="false"/></div></td>
				                       <td class="row-white" ><div align="center"><nested:write property="batch"/></div></td>
	                           </tr>
	                    		 <c:set var="temp" value="0"/>
					  	       </c:otherwise>
	                        </c:choose>
	                      ...
	                      <tr>
						   <td height="2" class="row-even" colspan="8"><div align="center"></div></td>
	                     </tr>
	                     <tr>
