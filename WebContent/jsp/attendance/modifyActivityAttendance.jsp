...
<script language="JavaScript">
	function editActivityAttendance(id) {
		document.location.href = "activityAttendance.do?method=getActivityAttendanceById&id=" + id;
	}
	...
	function deleteActivityAttendance(id) {
		deleteConfirm = confirm("Are you sure you want to cancel this entry?");
		if (deleteConfirm == true) {
		document.location.href = "activityAttendance.do?method=deleteCoCcurricularLeave&id=" + id;
		}
	}
</script>
<html:form action="/activityAttendance">
	...
	<html:hidden property="method" styleId="method" value="initModifyActivityAttendence"/>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"><bean:message key="knowledgepro.attendance.modifyactivityattendence" /></strong></td>
	                       ...
	                       <logic:iterate id="studentLeave" name="approveleaveForm" property="leaveList" type="com.kp.cms.to.attendance.StudentLeaveTO" indexId="count">
		                       <c:choose>
	                           	 <c:when test="${temp == 0}">
				                       ...
				                       <td class="row-even"><div align="center"><img src="images/edit_icon.gif" width="16" style="cursor:pointer" height="18" onclick="editActivityAttendance('<bean:write name="studentLeave" property="id"/>')"></div></td>
				                       <td class="row-even"><div align="center"><img src="images/delete_icon.gif" width="16" style="cursor:pointer" height="16" onclick="deleteActivityAttendance('<bean:write name="studentLeave" property="id"/>')"></div></td>
	                               </tr>
			                    ...
			                    <tr>
				                       ...
				                       <td class="row-white"><div align="center"><img src="images/edit_icon.gif" width="16" style="cursor:pointer" height="18" onclick="editActivityAttendance('<bean:write name="studentLeave" property="id"/>')"></div></td>
				                       <td class="row-white"><div align="center"><img src="images/delete_icon.gif" width="16" style="cursor:pointer" height="16" onclick="deleteActivityAttendance('<bean:write name="studentLeave" property="id"/>')"></div></td>
				                </tr>       
	                    		 <c:set var="temp" value="0"/>
					  	       </c:otherwise>
	                        </c:choose>
