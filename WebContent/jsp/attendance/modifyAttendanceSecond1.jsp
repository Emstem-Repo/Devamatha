...
<div class="panel-body">
               ...
               <div class="form-group">
                 <div class="col-sm-12">
	                 ...
	                 <span class='MandatoryMark'style="color:red;">*</span><b><bean:message key="knowledgepro.attendanceentry.type"/></b>:</div>
	                  ...
	                  <div class="col-sm-2"><span class='MandatoryMark'style="color:red;">*</span><b><bean:message key="knowledgepro.attendanceentry.date"/></b>:</div>
	                     ...
	                     <div class="col-sm-2">
	                      <html:text name="attendanceEntryForm" size="15" styleId="attendancedate" property="attendancedate" styleClass="form-control" readonly="true"/>
	                   </div>
                 ...
                 <div class="col-sm-12">
                    <div class="col-sm-2">
	                 ...
	                 <div class="col-sm-4"><span class='MandatoryMark'style="color:red;">*</span><b><bean:message key="knowledgepro.attendanceentry.hoursheld"/></b>:</div>
	                <div class="col-sm-2">
	               <html:text name="attendanceEntryForm" styleId="hoursHeld" property="hoursHeld" styleClass="form-control" onkeypress="return isNumberKey(event)" maxlength="4" onblur="validNumber(this)" readonly="true"/>
	                  </div>
	                  </div>
	                  </div>
	                   <div class="form-group">
                 <div class="col-sm-12">           
	                   ...
	                   <div class="col-sm-2">
	                  <html:select name="attendanceEntryForm" property="batchId" styleId="batchId" styleClass="form-control" disabled="true">
	                    <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
	                ...
	                <div class="col-sm-2">
	                  <c:choose>
	                   ...
	                   <div class="col-sm-2">
	                  <html:select name="attendanceEntryForm" property="activityId" styleId="activityId" styleClass="form-control" onchange="getBatches()">
	                    <html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
       ...
       <div class="col-sm-4">
         <label ><span style="background-color: green;"></span><input type='checkbox' disabled="disabled"></label><b> is for Present</b>
        &nbsp; &nbsp;
        <label ><span style="background-color: red;"></span><input type='checkbox' disabled="disabled"></label><b> is for Absent</b>
       &nbsp; &nbsp;
     ...
     <div class="col-sm-12">
                  ...
                  <table class="table table-bordered " width="100%" >
                      ...
                      <td align="center" style="width:20px;">
                        ...
                        <td align="center" style="width:300px;"><b><bean:message key="knowledgepro.attendance.studentname"/></b></td>
                        <!-- <td  align="center">
                        		<b>Reg No</b>
                        </td> -->
                        <td align="center">
               ...
               <table class="table table-bordered table-striped" width="100%" > 
                      <nested:iterate id="student"  name="lists" indexId="count1">
                                            <c:if test="${student.isModify == 'true'}">
                       <c:choose>
                 ...
                 <div class="col-sm-12">
                  ...
                  <table class="table table-bordered " width="100%" >
                      ...
                      <td align="center" style="width:77px;">
                        ...
                        <td align="center" style="width:602px;"><b><bean:message key="knowledgepro.attendance.studentname"/></b></td>
                        <!-- <td  align="center">
                        		<b>Reg No</b>
                        </td> -->
                        <td align="center">
            ...
            <html:button property="" styleClass="btn btn-primary" value="Update" onclick="updateData()"></html:button>
            <html:button property="" styleClass="btn btn-danger" value="Cancel" onclick="modifyAttendanceFirstPage()"></html:button>
            </div>
            </div>
</html:form>