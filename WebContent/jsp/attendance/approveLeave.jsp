	...
	<table width="99%" border="0">
		<tr>
			<td><span class="heading"><span class="Bredcrumbs"><bean:message
				key="knowledgepro.attendance" />&gt;&gt; <bean:message
				key="knowledgepro.attendance.approveleave" />&gt;&gt; </span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="heading_white"><bean:message
						key="knowledgepro.attendance.approveleave" /></td>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<tr>
											...
											<td align="left" width="29%" class="row-even"><html:select
												property="leaveType" styleClass="combo" styleId="leaveType">
												<html:option value="">
													<bean:message key="knowledgepro.admin.select" />
												</html:option>
												<html:optionsCollection property="leaveMap"
													name="approveleaveForm" label="value" value="key" />
											</html:select></td>
											<td class="row-odd">
											<td class="row-even">
										</tr>
		...
		'controlname' :'toDate'
						...
						<tr>
							<td height="35" align="center"><html:submit
								styleClass="formbutton"><bean:message key="knowledgepro.submit"/> </html:submit>&nbsp;&nbsp;&nbsp;<html:button
