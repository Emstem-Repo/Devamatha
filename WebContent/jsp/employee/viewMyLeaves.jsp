...
function initViewEmployee(){
	document.location.href = "employeeApplyLeave.do?method=initViewEmployeeLeave";
}
function ViewDepEmployee(){
	document.location.href = "employeeApplyLeave.do?method=initViewDepartmentEmpLeave";	
}
...
<html:form action="/employeeApplyLeave">
	...
	<table width="100%" border="0">
		...
		<tr>
					...
					<td colspan="4" class="heading" align="left">&nbsp;<bean:message
								    ...
								    <td height="25" colspan="4">
								        <table width="100%" cellspacing="1" cellpadding="2">
												<tr>
													...
													<bean:write name="employeeApplyLeaveForm" property="fingerPrintId" /></td>
													...
													<bean:write name="employeeApplyLeaveForm" property="employeeName" /></td>
													<td class="row-odd" align="center" width="16%"><bean:message
														key="employee.info.code" />
													</td>
													<td class="row-even" align="center" width="16%">
													<bean:write name="employeeApplyLeaveForm" property="empCode" /></td>
								...
								<tr>
									...
									<td height="25" colspan="4">
											<table width="100%" cellspacing="1" cellpadding="2">
												...
												<logic:notEmpty name="employeeApplyLeaveForm" property="applyLeaveTo">
												<logic:iterate name="employeeApplyLeaveForm"
													property="applyLeaveTo" id="leaveList" indexId="count">
															...
															<tr>
																...
																<td height="13" class="row-even" align="center">
																<bean:write
																	name="leaveList" property="isAm" />
																</td>
																<td width="13%" height="25" class="row-even" align="center">
																<bean:write
						...
						<tr>
							<td colspan="4" class="heading" align="left">&nbsp;
								Online Leave Application Status</td>
							</tr>
						<tr>
							<td valign="top" class="news">
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td height="25" colspan="4">
											<table width="100%" cellspacing="1" cellpadding="2">
												...
												<logic:notEmpty name="employeeApplyLeaveForm" property="empOnlineLeave">
												<logic:iterate name="employeeApplyLeaveForm"
													property="empOnlineLeave" id="list" indexId="count">
															...
															<tr>
																...
																<td height="25" class="row-even" align="center" width="13%">
																<bean:write name="list" property="empLeaveType" /></td>
																<td class="row-even" align="center" width="13%"><bean:write
																	name="list" property="fromDate" /></td>
																<td class="row-even" align="center" width="13%"><bean:write
																	name="list" property="toDate" /></td>
																<td class="row-even" align="center" width="13%"><bean:write
																	name="list" property="isHalfDay" /></td>
																<td height="13" class="row-even" align="center">
																<bean:write
																	name="list" property="isAm" />
																</td>
																<td width="13%" height="25" class="row-even" align="center">
																<bean:write
																	name="list" property="noOfDays" />
																</td>
																<td width="13%" height="25" class="row-even" align="center">
																<bean:write
																	name="list" property="status" />
																</td>
															</tr>
												</logic:iterate>
												</logic:notEmpty>
						...
						<tr>
							<td colspan="4" class="heading" align="left">&nbsp;<bean:message
								key="knowledgepro.employee.leave.summary" /></td>
						</tr>
						<tr>
							<td valign="top" class="news">
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									<td><img src="images/01.gif" width="5" height="5" /></td>
									<td width="1000" background="images/02.gif"></td>
									<td><img src="images/03.gif" width="5" height="5" /></td>
								</tr>
								<tr>
									<td width="5" background="images/left.gif"></td>
										...
										<tr>
											...
											<table width="100%" cellspacing="1" cellpadding="2">
												<tr>
													...
													<td class="row-odd" align="center" width="20%"><bean:message
														key="knowledgepro.employee.leave.sanctioned" /></td>
													<td class="row-odd" align="center" width="20%"><bean:message
														key="knowledgepro.employee.leave.balance" />
													</td>
												</tr>
												<logic:notEmpty name="employeeApplyLeaveForm" property="empLeaveTO">
												<logic:iterate name="employeeApplyLeaveForm"
													property="empLeaveTO" id="leaveTos" indexId="count">
													
															<tr>
																<td height="25" class="row-even" width="20%">
																<div align="center"><c:out value="${count+1}" /></div>
																</td>
																<td height="25" class="row-even" align="center" width="20%">
																<bean:write name="leaveTos" property="empLeaveTypeName" /></td>
																<td class="row-even" align="center" width="20%"><bean:write
																	name="leaveTos" property="leavesAllocated" /></td>
																<td class="row-even" align="center" width="20%"><bean:write
																	name="leaveTos" property="leavesSanctioned" /></td>
																<td class="row-even" align="center" width="20%"><bean:write
																	name="leaveTos" property="leavesRemaining" /></td>
															</tr>
												</logic:iterate>
												</logic:notEmpty>
											</table>
            ...
            <c:choose>
					<c:when test="${Operation == 'viewMyLeave'}">
						<html:button  value="Cancel" styleClass="formbutton" onclick="loginPage()" property=""></html:button>
					</c:when>
				</c:choose>
				 <c:choose>
					<c:when test="${Operation == 'viewEmpLeave'}">
						<html:button  value="Cancel" styleClass="formbutton" onclick="initViewEmployee()" property=""></html:button>
					</c:when>
				</c:choose>
				 <c:choose>
				     <c:when test="${Operation == 'viewDepEmpLeave' }">
				     <html:button  value="Cancel" styleClass="formbutton" onclick="ViewDepEmployee()" property=""></html:button>
				     </c:when>
				 </c:choose>
				</td>
          </tr>
