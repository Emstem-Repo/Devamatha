...
<script language="JavaScript" src="jsp/employee/employee.js"></script>

<html:form action="/EmployeeInfoEditDisplayNew" enctype="multipart/form-data" method="POST">
                    ...
                    <tr>
                      ...
                      <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
                          ...
                          <c:set var="temp" value="0" />
							<nested:iterate name="EmployeeInfoEditNewForm" property="userList" id="userList" indexId="count">
								<c:choose>
								<c:when test="${temp == 0}">
                    <tr>
                            ...
                            <c:out value="${count+1}" />
                             ...
                             <input type="hidden" id="userId" name="userId" value="<nested:write property="id"/>"/>
                            
                            <td width="20%" class="row-even">&nbsp;<nested:write name="userList" property="name"/></td>
                            <td width="20%" height="39" class="row-even">&nbsp;<nested:write  name="userList"  property="departmentName"/></td>
                            
                            <td width="20%" class="row-even" >&nbsp;<nested:write name="userList" property="designationName"/></td>
                         
                           
                            <td width="3%" class="row-even" align="center"><img src="images/edit_icon.gif"
										width="16" height="18"  style="cursor:pointer" 
										onclick="getDetailForEditNew('<nested:write name="userList" property="id"/>','loadEmployeeInfoNew')"></td>
                     ...
                     <tr >
                            ...
                            <td width="20%" class="row-white">&nbsp;<nested:write name="userList" property="name"/></td>
                            <td width="20%" height="39" class="row-white">&nbsp;<nested:write  name="userList"  property="departmentName"/></td>
                            
                            <td width="20%" class="row-white" >&nbsp;<nested:write name="userList" property="designationName"/></td>
