...
function forwardEmployeeLeave(){
	document.getElementById("method").value="forwardEmployeeLeave";
	document.employeeOnlineLeaveForm.submit();
}
function returnEmployeeLeave(){
	document.getElementById("method").value="returnEmployeeLeave";
	document.employeeOnlineLeaveForm.submit();
}
function clarifyEmployeeLeave(){
	document.getElementById("method").value="clarifyEmployeeLeave";
	document.employeeOnlineLeaveForm.submit();
}
...
function viewEmployeeLeaves(employeeId,empTypeId){
	document.location.href = "employeeOnlineLeave.do?method=viewEmployeeLeaves&empId="+employeeId+"&empTypeId="+empTypeId;
}

function viewReturnedRequestDocForApproval(){
	document.getElementById("method").value="viewReturnedRequestDocForApproval";
	document.employeeOnlineLeaveForm.submit();
}
</SCRIPT>

<html:form action="/employeeOnlineLeave">
	<html:hidden property="method" styleId="method" value="approveEmployeeLeave"/>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<tr>
					<td colspan="4" class="heading" align="left">&nbsp;Online Leave Application Status
					<div align="right"><a href="#" onclick="viewReturnedRequestDocForApproval()"> View Returned/Request Documents</a></div></td>
					</tr>
						<tr>
							<td valign="top" class="news">
												...
												<nested:iterate name="employeeOnlineLeaveForm"
													property="applyLeaveTo" id="leaveList" indexId="count">
															...
															<tr>
																...
																<td width="7%" height="25" class="row-even" align="center">
																<bean:write
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<td height="35" align="right">
								<html:submit  value="Approve" styleClass="formbutton"  property="" onclick="approveEmployeeLeave()"></html:submit>
								&nbsp;&nbsp;&nbsp; <html:button  value="Forward" styleClass="formbutton"  property="" onclick="forwardEmployeeLeave()"></html:button>
							</td>
							<td height="35" align="left">
								&nbsp;&nbsp;&nbsp;<html:button  value="Return" styleClass="formbutton" property="" onclick="displayReason()"></html:button>
								&nbsp;&nbsp;&nbsp;<html:button  value="Clarify/Meet" styleClass="formbutton" property="" onclick="displayReason()"></html:button>
