...
function returnEmployeeLeave(){
	document.getElementById("method").value="returnAuthorizationEmpLeave";
	document.employeeOnlineLeaveForm.submit();
}
function clarifyEmployeeLeave(){
	document.getElementById("method").value="requestDocEmpLeave";
	document.employeeOnlineLeaveForm.submit();
}
...
function viewEmployeeLeaves(employeeId,empTypeId){
	document.location.href = "employeeOnlineLeave.do?method=viewAuthorizedEmployeeLeaves&empId="+employeeId+"&empTypeId="+empTypeId;
}
function viewReturnedRequestDoc(){
	document.getElementById("method").value="viewReturnedRequestDoc";
	document.employeeOnlineLeaveForm.submit();
}
</SCRIPT>

<html:form action="/employeeOnlineLeave">
	<html:hidden property="method" styleId="method" value="authorizationEmployeeLeaves"/>
	<html:hidden property="formName" value="employeeOnlineLeaveForm" />
	<table width="100%" border="0">
		<tr>
			<td><span class="heading"> <bean:message
				key="knowledgepro.employee" /> <span class="Bredcrumbs">&gt;&gt;
			Pending Authorization&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> Pending Authorization</strong></td>
				...
				<tr>
					...
					<div align="right"><a href="#" onclick="viewReturnedRequestDoc()"> View Returned/Request Documents</a></div></td>
					</tr>
					<tr>
