...
<!--                            <td class="row-odd"><bean:message key="knowledgepro.admin.code"/></td>-->
...
<!--                             <td class="row-odd"><bean:message key="knowledgepro.hostel.photo"/></td>-->
                          ...
                          <c:set var="temp" value="0" />
							<nested:iterate name="EmployeeInfoViewForm" property="userList" indexId="count">
							<%-- 	<c:choose>
								<c:when test="${temp == 0}">
                    <tr>
                            ...
                            <td width="3%" class="row-even" >&nbsp;<nested:write property="dummyCode"/></td>
                     ...
                     <tr >
                            ...
                            <td width="3%" class="row-white" >&nbsp;<nested:write property="dummyCode"/></td>
