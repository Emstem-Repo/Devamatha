...
function getLeaveTypeDetails(){
	...
	if((empId!=null && empId!='')){
		var url = "employeeApplyLeave.do?method=getDetails&employeeId="+empId;
		myRef = window
...
function resetMessages() {
	document.location.href="employeeApplyLeave.do?method=initEmpApplyLeave";
}
...
<html:form action="/employeeApplyLeave">
	...
	<html:hidden property="empTypeId" styleId="empTypeId" name="employeeApplyLeaveForm" />
	<html:hidden property="employeeId" styleId="employeeId" name="employeeApplyLeaveForm" />
	<html:hidden property="halfDayDisplay" styleId="halfDayDisplay" name="employeeApplyLeaveForm" />
	<html:hidden property="focusValue" styleId="focusValue"/>
	<html:hidden property="amDisplay" styleId="amDisplay" name="employeeApplyLeaveForm" />
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"><bean:message key="knowledgepro.emp.applyLeave.display" /></strong></div>
					</td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<%-- <tr>
									<td height="25" class="row-odd"><div align="right" id="regLabel"><bean:message key="knowledgepro.employee.leave.employeeId"/>:</div></td>
		                             <td height="25" class="row-even" align="left"><span class="star">
		                               <html:text property="fingerPrintId" styleId="fingerPrintId" name="employeeApplyLeaveForm" maxlength="10" onblur="getEmpDetails()"/>
		                             </span></td>
		                             ...
		                             <span class="star">
		                               <html:text property="empCode" styleId="empCode" name="employeeApplyLeaveForm" maxlength="9" onblur="getEmpDetails()"/>
		                             </span></td>							
		                             <td class="row-even">
		                             	<div id="notValid"></div>
		                             </td>
							  	...
							  	<tr height="25">
							  		...
							  		<td class="row-even" align="left">
							  			<div id="empName">
							  				<bean:write name="employeeApplyLeaveForm" property="employeeName"/>
							  			</div>
							  		</td>
							  		<td class="row-odd" align="right">
							  			Department Name:
							  		...
							  		<td class="row-even" align="left">
							  			<div id="depName">
							  				<bean:write name="employeeApplyLeaveForm" property="departmentName"/>
							  			</div>
							  		</td>
							  		<td class="row-odd"  align="right">
							  			<!-- Designation: -->
							  		...
							  		<td class="row-even" align="left">
							  			<div id="desName">
							  				<%-- <bean:write name="employeeApplyLeaveForm" property="designationName"/> --%>
							  			</div>
							  		</td>
							  	</tr>
								<tr>
									<td height="25" class="row-odd">
									<div align="right"><span class="Mandatory">*</span>&nbsp;<bean:message key="knowledgepro.admin.template.Date" />:</div>
									</td>
									<td class="row-even">
									<html:text name="employeeApplyLeaveForm" property="startDate" styleId="startDate" size="10" maxlength="16" onchange="getLeaveTaken()"/>
									<script
									language="JavaScript">
									new tcal( {
										// form name
										'formname' :'employeeApplyLeaveForm',
										// input name
									...
									<td height="25" class="row-odd">
									<div align="right"><span class="Mandatory">*</span>&nbsp;<bean:message key="knowledgepro.admin.period.report" />:</div>
									</td>
									<td height="55px" class="row-even">
										<html:select property="period" styleId="leaveTypeId" styleClass="combo" multiple="true" style=" height:80px;">
										<html:option value="Hour 1">Hour 1</html:option>
										<html:option value="Hour 2">Hour 2</html:option>
										<html:option value="Hour 3">Hour 3</html:option>
										<html:option value="Hour 4">Hour 4</html:option>
										<html:option value="Hour 5">Hour 5</html:option>
									</html:select> 
									</td>
									...
									<html:select property="leaveTypeId" styleId="leaveTypeId" styleClass="combo">
										...
										<logic:notEmpty name="employeeApplyLeaveForm" property="leaveTypes">
											<html:optionsCollection property="leaveTypes" label="name" value="name" />
										</logic:notEmpty>
									</html:select> 
									</label></td>
								</tr>
								...
								<tr>
									...
									<td colspan="4" class="row-even"><a href="#" onclick="getLeaveTypeDetails()"> View Leaves</a> </td>
								</tr>
							</table>
							</td>
