...
<body>
<html:form action="/EmployeeInfoEditDisplay" enctype="multipart/form-data" method="POST">
...
<html:hidden property="formName" value="EmployeeInfoEditForm"/>
  ...
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.employee"/><span class="Bredcrumbs">&gt;&gt;<bean:message key="knowledgepro.employee.Edit" /> &gt;&gt;</span></span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        <td width="5"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="100%" background="images/Tcenter.gif" class="body" ><strong class="boxheader"><bean:message key="knowledgepro.employee.Edit" /></strong></td>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <tr class="row-white">
                    ...
                    <td width="20%" class="row-even"><html:text property="tempCode" styleId="tempCode" onkeypress="return imposeMaxLengthUID(event,this)"/></td>
                ...
                <td width="20%" height="25" class="row-even" >
                 <html:select property="tempStreamId" styleId="tempStreamId" onchange="searchStreamWise(this.value)">
					  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempStreamMap" name="EmployeeInfoEditForm">
             ...
             <td width="15%" height="25" class="row-odd"><div align="right"><bean:message key="knowledgepro.employee.Department"/>:</div></td>
                    ...
                    <html:select property="tempDepartmentId" styleId="tempDepartmentId">
					  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempDepartmentMap" name="EmployeeInfoEditForm">
              ...
              <tr>
                <td width="15%" height="25" class="row-odd"><div align="right"><bean:message key="knowledgepro.employee.designation"/>:</div></td>
                 <td width="20%" class="row-even"><html:select property="tempDesignationPfId" styleId="tempDesignationPfId">
				   	<html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempDesignationMap" name="EmployeeInfoEditForm">
                ...
                <td width="30%" class="row-even">
                 <html:select property="tempEmptypeId" styleId="tempEmptypeId">
					  <html:option value=""><bean:message key="knowledgepro.select"/></html:option>
						<logic:notEmpty property="tempEmpTypeMap" name="EmployeeInfoEditForm">
...
<logic:equal value="Yes" name="EmployeeInfoEditForm" property="isDirectpage">
<script>
console.log("varoole")
