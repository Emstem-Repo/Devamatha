...
function back(){
	document.location.href = "SubjectRuleCertificate.do?method=backTheoryEse";
}
</script>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<tr class="row-odd">
								...
								<td height="25" ><nested:text name="subjectRuleSettingsForm" property="pesto.totalMinimummumMarks" styleId="totalMinimummumMarks" size="10" maxlength="6" onkeypress="return isNumberKey(event)"/></td>
					...
					<table width="100%" border="0"  cellspacing="1" cellpadding="1">
						...
						<tr height="25">
							...
							<td class="row-even">
							<nested:text name="subjectRuleSettingsForm" property="pesto.finalInternalMinimumMarks" styleId="finalInternalMinimumMarks" size="10" maxlength="6" onkeypress="return isNumberKey(event)"/>
							</td>
