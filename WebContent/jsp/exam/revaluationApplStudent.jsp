...
function goToFirstPage() {
	document.location.href = "newSupplementaryImpApp.do?method=cancelRevaluationApplication";
}
function cancelFirstPage() {
	document.location.href = "newSupplementaryImpApp.do?method=initRevaluationApplication";
}
...
<html:form action="/newSupplementaryImpApp">
	...
	<html:hidden property="method" styleId="method" value="addRevaluationApplication" />
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<div align="right"><bean:message
										key="knowledgepro.exam.revaluationApplication" /></div>
									</td>
									<td class="row-even"><bean:write
										name="newSupplementaryImpApplicationForm"
										property="isRevaluation" /> </td>	
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
                                    ...
                                    <td rowspan="2" class="row-odd">Applied</td>
									...
									<tr>
										...
										<td class='<%=dynamicStyle%>'><nested:write
											property="subjectName" /></td>
												...
												<td class='<%=dynamicStyle%>'>
															  <input type="hidden"
																	 name="suppTo.subjectList[<c:out value='${count}'/>].tempChecked"
