...
function cancelAction(){
	document.location.href="subjectRuleSettings.do?method=cancelSubjectRuleSetting";
}
</script>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<tr class="row-odd">
								...
								<td height="25" ><nested:text name="subjectRuleSettingsForm" property="esto.totalMinimummumMarks" styleId="totalMinimummumMarks" size="10" maxlength="6" onkeypress="return isDecimalNumberKey(this.value,event)"/></td>
					...
					<table width="100%" border="0"  cellspacing="1" cellpadding="1">
						...
						<tr height="25">
							...
							<td class="row-even">
							<nested:text name="subjectRuleSettingsForm" property="esto.finalInternalMinimumMarks" styleId="finalInternalMinimumMarks" size="10" maxlength="6" onkeypress="return isDecimalNumberKey(this.value,event)"/>
							</td>
