...
<script type="text/javascript">
	function editRevApp(studentId) {
		document.location.href = "newSupplementaryImpApp.do?method=editStudentForRevaluation&student=" + studentId;
	}
	...
	function deleteRevApp(studentId, name) {
		deleteConfirm = confirm("Are you sure to delete " + name
				+ " this entry?");
		if (deleteConfirm) {
			document.location.href = "newSupplementaryImpApp.do?method=deleteRevaluationApp&student="
					+ studentId;
		}
	}
