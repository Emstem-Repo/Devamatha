...
<script type="text/javascript" language="javascript">
	...
	function getExamsByExamTypeAndYear() {
		if(document.getElementById("sup").checked==true)
...
<html:form action="/newSupplementaryImpApp">
	...
	<html:hidden property="examType" styleId="examType" value="Regular" />
	<table width="100%" border="0">
		<tr>
			<td><span class="heading"><bean:message
				key="knowledgepro.exam.exam" /> <span class="Bredcrumbs">&gt;&gt;
			<bean:message key="knowledgepro.exam.revaluation.application" />&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<tr>
									...
									<td>			<html:radio property="examType"
										styleId="examId" value="Regular"
										onclick="getExamsByExamTypeAndYear()" ></html:radio>
									Regular&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<tr>
									...
									<div align="right"><span class="mandatoryfield">*</span><bean:message
										key="knowledgepro.exam.revaluationApplication" /> :
									</div>
									</td>
									<td height="30" class="row-even"><html:select
										property="isRevaluation"
										styleId="isRevaluation">
										<html:option value="">Select</html:option>
										<html:option value="Revaluation">Revaluation</html:option>
										<html:option value="Scrutiny">Scrutiny</html:option>
										<html:option value="ChallengeValuation">Challenge Valuation</html:option>
									</html:select></td>
									<td class="row-odd">
