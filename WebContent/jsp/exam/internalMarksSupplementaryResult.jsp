...
function loadPage()
{
	document.location.href = "internalMarksSupplementary.do?method=initInternalMarkSupplementaryRetain";
}
</script>


<html:form action="/internalMarksSupplementary">
	<html:hidden property="formName" value="newInternalMarksSupplementaryForm" />
	<html:hidden property="pageType" value="1" />
	<html:hidden property="method" styleId="method" value="saveChangedMarks" />
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td height="30" class="row-even" colspan="4"><bean:write
										property="examName" name="newInternalMarksSupplementaryForm" />
									</td>
								...
								<tr>
									...
									<td width="26%" class="row-even"><bean:write
										property="courseName"
										name="newInternalMarksSupplementaryForm" /></td>

									<td width="18%" height="26" class="row-odd">
									<div align="right">Scheme :</div>
									</td>
									<td width="25%" class="row-even"><bean:write
										property="schemeNo" name="newInternalMarksSupplementaryForm" /></td>
								...
								<tr>
									...
									<td class="row-even"><bean:write property="registerNo" 
										name="newInternalMarksSupplementaryForm" /></td>
									<td class="row-odd">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="0">
								...
								<nested:iterate property="stuMarkList" indexId="count">
									<c:choose>
									...
									<td width="122" class="row-even"><nested:text
										property="theoryTotalSubInternalMarks" disabled="<%=flag%>" maxlength="3" onkeypress="return isNumberKey(event)"/></td>
									<%
											flag = true;
										%>
									<nested:equal value="B" property="isTheoryPrac">
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td width="1%"></td>
							<td width="1%"></td>
							<td width="46%"><html:button property="" styleClass="formbutton" onclick="loadPage()" value="Cancel"></html:button> </td>
						</tr>						
						<tr><td style="height: 10px" align="center" colspan="4"></td></tr>						
					</table>
					</td>
