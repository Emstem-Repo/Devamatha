						...
						<tr>
							...
							<table width="100%" border="0"  cellspacing="1" cellpadding="1">
								...
								<tr>
									...
									<tr>									
									<td class="row-even">
										<nested:text name="subjectRuleSettingsForm" property="teseTo.evalId1" styleId="evalId1" size="3" maxlength="6" onkeypress="return isNumberKey(event)"/><html:radio property="teseTo.reviewer" value="r1" styleId="r1" name="subjectRuleSettingsForm"/><br/>
										<nested:text name="subjectRuleSettingsForm" property="teseTo.evalId2" styleId="evalId2" size="3" maxlength="6" onkeypress="return isNumberKey(event)"/><html:radio property="teseTo.reviewer" value="r2" styleId="r2" name="subjectRuleSettingsForm"/><br/>
										<nested:text name="subjectRuleSettingsForm" property="teseTo.evalId3" styleId="evalId3" size="3" maxlength="6" onkeypress="return isNumberKey(event)" onkeyup="rev()"/><html:radio property="teseTo.reviewer" value="r3" styleId="r3" name="subjectRuleSettingsForm"/><br/>
										<nested:text name="subjectRuleSettingsForm" property="teseTo.evalId4" styleId="evalId4" size="3" maxlength="6" onkeypress="return isNumberKey(event)"/><html:radio property="teseTo.reviewer" value="r4" styleId="r4" name="subjectRuleSettingsForm"/><br/>
										<nested:text name="subjectRuleSettingsForm" property="teseTo.evalId5" styleId="evalId5" size="3" maxlength="6" onkeypress="return isNumberKey(event)"/><html:radio property="teseTo.reviewer" value="r5" styleId="r5" name="subjectRuleSettingsForm"/>
									</td>
									<td class="row-even" style="font-size:75pt; font-family: monospace;" valign="top">}</td>
									<td class="row-even" valign="middle" style="font-size:10pt;"><strong>Is Third Evaluator</strong></td>
									</tr>
									</table>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="row-even"> <nested:text name="subjectRuleSettingsForm" property="teseTo.supplementaryMinMarks" styleId="supplementaryMinMarks" size="10" maxlength="6" onkeypress="return isNumberKey(event)"/></td>
									<td class="row-odd">Supplementary Maximum Marks:</td>
									<td class="row-even"><nested:text name="subjectRuleSettingsForm" property="teseTo.supplementaryMaxMarks" styleId="supplementaryMaxMarks" size="10" maxlength="6" onkeypress="return isNumberKey(event)"/> </td>
								</tr>
							</table>
							</td>
							<td width="5" height="30" background="images/right.gif"></td>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="1">
								<tr>
									...
									<td class="row-even">
									<nested:text name="subjectRuleSettingsForm" property="teseTo.minimumMarksTheoryESE" styleId="minimumMarksTheoryESE" size="10" maxlength="6" onkeypress="return isDecimalNumberKey(this.value,event)"/>
									</td>
									<td class="row-odd">(Marks entered in)Entry Maximum mark :</td>
									<td class="row-even">
									<nested:text name="subjectRuleSettingsForm" property="teseTo.maximumEntryMarksTheoryESE" styleId="maximumEntryMarksTheoryESE" size="10" maxlength="6" onkeypress="return isNumberKey(event)"/>
									</td>
									<td class="row-odd">Maximum Mark:</td>
									<td class="row-even">
									<nested:text name="subjectRuleSettingsForm" property="teseTo.maximumMarksTheoryESE" styleId="maximumMarksTheoryESE" size="10" maxlength="6" onkeypress="return isNumberKey(event)"/>
									</td>
								</tr>
							</table>
							</td>
					...
					<table width="100%" border="0"  cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<table width="100%" border="0"  cellspacing="1" cellpadding="1">
								...
								<td class="row-even"> <nested:text name="subjectRuleSettingsForm" property="teseTo.minimumTheoryFinalMarksTheoryESE" styleId="minimumTheoryFinalMarksTheoryESE" size="10" maxlength="6" onkeypress="return isDecimalNumberKey(this.value,event)"/></td>
								<td class="row-odd">Maximum Marks:</td>
								<td class="row-even"><nested:text name="subjectRuleSettingsForm" property="teseTo.maximumTheoryFinalMarksTheoryESE" styleId="maximumTheoryFinalMarksTheoryESE" size="10" maxlength="6" onkeypress="return isNumberKey(event)"/> </td>
								</tr>
							</table>
							</td>
							<td width="5" height="30" background="images/right.gif"></td>
...
<script type="text/javascript">
var eval3=document.getElementById("evalId3");
var r3=document.getElementById("r3");
if(eval3.value!=null || eval3.value!=""){
	r3.checked=true;	
}
for(var i=1;i<=5;i++){
	if(i!=3)
