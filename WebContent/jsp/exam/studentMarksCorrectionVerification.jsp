...
<html:form action="/studentMarksCorrection" method="POST" enctype="multipart/form-data">
	...
	<html:hidden property="method" styleId="method" value="verifyUserPassword" />
	...
	<table width="99%" border="0">
		<tr>
			...
			&gt;&gt; Student Marks Correction&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									<td class="row-odd">
									<div align="right"><span class="Mandatory">*</span> Verification Password:</div>
									</td>
									<td class="row-even">
										<html:password styleId="verifyPassword" property="verifyPassword" name="newStudentMarksCorrectionForm" size="10"></html:password>
									</td>
								</tr>
							</table>
							</td>
