...
<html:form action="/uploadExamInternal" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="updateInternalOverAllMarks" />
	<html:hidden property="formName" value="uploadInternalOverAllForm" />
	<html:hidden property="pageType" styleId="pageType" value="1" />
	<table width="98%" border="0">
		<tr>
			<td><span class="Bredcrumbs"><bean:message key="knowledgepro.exam" />
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.exam.internal.overall.label" /> &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> <bean:message key="knowledgepro.exam.internal.overall.label" /></strong></div></td>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<html:button property="" styleClass="formbutton" onclick="reset()">
