...
<html:form action="/ExamSubjectDefinitionCourseWise" method="POST">
	<html:hidden property="method" value="copySubjectDefinitionCoursewiseByYear" />
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td class="row-even" width="25%"><input type="hidden"
										id="year" name="year"
										value='<bean:write name="ExamSubjectDefCourseForm" property="toYear"/>' />
									<html:select property="toYear" styleId="copyAcademicYear" styleClass="combo">
										<html:option value="" >
