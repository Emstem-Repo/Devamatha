...
<html:form action="/securedMarksEntry">
	<html:hidden property="formName" value="newSecuredMarksEntryForm" styleId="formName" />
	...
	<input type="hidden" id="typeExam" name="type" value='<bean:write name="newSecuredMarksEntryForm" property="examType"/>' />
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
								 <td width="16%" height="25" class="row-odd">
									...
									<input
										...
										value="<bean:write name="newSecuredMarksEntryForm" property="academicYear"/>" />
									<html:select
									...
									<td class="row-even" ><html:select
										name="newSecuredMarksEntryForm" property="examId"
								...
								<tr>
									...
									<td height="12" class="row-even"><html:select
										...
										name="newSecuredMarksEntryForm" style="width:450px"
									...
									<td class="row-even"><html:select
										...
										styleId="subjectType" name="newSecuredMarksEntryForm"
										style="width:90px" onchange="displayEvaluAndAnswerScript(this.value)">
										<html:option value=""><bean:message key="knowledgepro.select" /></html:option>
									<logic:notEmpty name="newSecuredMarksEntryForm"	property="subjectTypeList">
										<html:optionsCollection property="subjectTypeList" name="newSecuredMarksEntryForm" label="value" value="key" />
											</logic:notEmpty>
									</html:select></td>
								</tr>
								<tr>
									...
									<td height="25" class="row-even"><html:select
										...
										styleId="evaluatorType" name="newSecuredMarksEntryForm"
										style="width:120px">
											<html:option value="">
									...
									<html:select property="answerScriptType" styleClass="combo" styleId="answerScriptType" name="newSecuredMarksEntryForm"
										style="width:120px">
										<html:option value="">
											<bean:message key="knowledgepro.select" />
												<logic:notEmpty name="newSecuredMarksEntryForm"
