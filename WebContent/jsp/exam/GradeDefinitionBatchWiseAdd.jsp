...
function editGDAdd(id) {
	document.location.href = "GradeDefinitionBatchWise.do?method=editGDAdd&id="+id;
...
function deleteGDAdd(id,name) {
	...
	if(deleteConfirm)
	{
	   document.location.href = "GradeDefinitionBatchWise.do?method=deleteGDAdd&id="+id;
	}
}
...
function resetMessages() {
	...
	document.getElementById("fromBatch").value =document.getElementById("orgfromBatch").value;
...
function reActivate(id) {
	document.location.href = "GradeDefinitionBatchWise.do?method=reActivateGDAdd&id="+id;
}
function update(){
	document.getElementById("method").value="updateGDAdd";
}
function closeScreen(){
	document.location.href = "GradeDefinitionBatchWise.do?method=initGradeDefinitionBatchWise";
}
</script>
...
<html:form action="/GradeDefinitionBatchWise.do">
	...
	<c:choose>
		<c:when
			...
			<html:hidden property="orgfromBatch" styleId="orgfromBatch" />
	...
	<table width="100%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; <bean:message key="knowledgepro.exam.gradeDefinitionFromWise" />&gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td background="images/Tcenter.gif" class="body"><strong
						class="boxheader"> <bean:message key="knowledgepro.exam.gradeDefinitionFromWise" /></strong></td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<nested:iterate name="GradeDefinitionBatchWiseForm"
											property="listExamCourseGroup" id="listExamCourseGroup"
											type="com.kp.cms.to.exam.GradeDefinitionBatchWisTo">
										<tr>
									   			<nested:write name="listExamCourseGroup" property="course" />
									   			<br></br>
									   			</tr>
										</nested:iterate>
									</table>
								...
								<tr>
								<td width="10%" height="15" class="row-odd"><div align="right"><span class="Mandatory">*</span> 
								<bean:message key="knowledgepro.cancelattendance.Frombatches" /> :</div></td>
								<td width="17%" height="5" class="row-even"><bean:write name="listExamCourseGroup" property="fromBatch"/></td>
								</tr>
							</table>
							</logic:notEmpty>
							</td>
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										<tr>
											...
											<td width="25%" height="25" class="row-odd" align="left"><bean:message
												key="knowledgepro.exam.gradeDefinition.course" /></td>
											<td width="5%" height="25" class="row-odd" align="left"><bean:message
												key="knowledgepro.cancelattendance.Frombatches" /></td>
											<td width="5%" height="25" class="row-odd" align="left"><bean:message
										...
										<logic:notEmpty name="GradeDefinitionBatchWiseForm" property="listGradeDefinition">
										<logic:iterate name="GradeDefinitionBatchWiseForm"
											property="listGradeDefinition" id="listGradeDefinition"
											type="com.kp.cms.to.exam.GradeDefinitionBatchWiseTO"
											indexId="count">
											<c:choose>
												<c:when test="${temp == 0}">
													<tr>
