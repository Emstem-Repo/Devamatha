...
function getExamName() {
	...
	var year=document.getElementById("appliedYear").value;
...
<html:form action="/excelUpload" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="saveChallanUploadDataForExam" />
	...
	<table width="98%" border="0">
		<tr>
			...
			<span class="Bredcrumbs">&gt;&gt; Challan Data Upload For Exam &gt;&gt;</span></span></td>
		</tr>
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<div align="left"><strong class="boxheader"> Challan Data Upload For Exam</strong></div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										...
										<!--<tr class="row-white">
											...
											<html:select name="excelDataForm" property="applicationYear" styleId="appliedYear" styleClass="combo" onchange="getExamNames()">
              ...
              <!--<td height="25" class="row-odd" width="25%">
											...
											<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
											<logic:notEmpty name="excelDataForm" property="examMap">
												<html:optionsCollection property="examMap" name="excelDataForm" label="value" value="key" />
											</logic:notEmpty>
											</html:select></td>
