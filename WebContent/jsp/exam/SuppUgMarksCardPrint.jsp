...
<tr height="30px"></tr>
						<tr height="21px" width="100%">
								<td class="row-print" align="center" width="100%" fontsize="30" font-family= verdana><b> <b><bean:write name="loginform" property="marksCardTo.semString"/> SEMESTER <bean:write name="loginform" property="marksCardTo.examName"/>  </b> </td>
