...
<html:form action="/internalMarksEntry" method="POST" enctype="multipart/form-data">
	<html:hidden property="method" styleId="method" value="viewTeacherExamDetails" />
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td height="25" class="row-even" align="left" width="50%"> 
										<html:select property="empId" styleId="teacher" name="internalMarksEntryForm" styleClass="combo">
											<html:option value="">Select</html:option>
											<logic:notEmpty property="employeeMap" name="internalMarksEntryForm">
												<html:optionsCollection property="employeeMap" name="internalMarksEntryForm" label="value" value="key"/>
											</logic:notEmpty>
										</html:select>
									</td>
								</tr>
