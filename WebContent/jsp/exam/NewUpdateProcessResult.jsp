...
<html:form action="/updateProcess">
	...
	<html:hidden property="validateProcess" styleId="validateProcess" name="newUpdateProccessForm"/>
	<html:hidden property="validateMsg" styleId="validateMsg" name="newUpdateProccessForm"/>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td width="27%" class="row-even"><bean:write
										property="processName" name="newUpdateProccessForm" /></td>
									...
									<td width="28%" height="25" class="row-even"><bean:write
										property="examName" name="newUpdateProccessForm" /></td>
								</tr>
								<tr>
									...
									<td class="row-even" colspan="3"><bean:write
										property="academicYear" name="newUpdateProccessForm" /></td>
