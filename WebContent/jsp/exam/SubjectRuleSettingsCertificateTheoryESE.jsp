...
function back(){
	document.location.href = "SubjectRuleCertificate.do?method=backTheoryInternal";
}
</script>
						...
						<tr>
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="1">
								<tr>
									...
									<td class="row-even">
									<nested:text name="subjectRuleSettingsForm" property="teseTo.minimumMarksTheoryESE" styleId="minimumMarksTheoryESE" size="10" maxlength="6" onkeypress="return isNumberKey(event)"/>
									</td>
					...
					<table width="100%" border="0"  cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<table width="100%" border="0"  cellspacing="1" cellpadding="1">
								...
								<td class="row-even"> <nested:text name="subjectRuleSettingsForm" property="teseTo.minimumTheoryFinalMarksTheoryESE" styleId="minimumTheoryFinalMarksTheoryESE" size="10" maxlength="6" onkeypress="return isNumberKey(event)"/></td>
