...
<html:form action="/newSupplementaryImpApp">
	...
	<nested:iterate property="mainList" indexId="count2"  name="newSupplementaryImpApplicationForm">
		...
		<!--<tr>
		 ...
		 <td width="30%" style="text-align: center;">Course</td>
		 ...
		 <nested:iterate property="toList" indexId="count" id="list">
		<c:choose>
			<c:when test="${list.tempChecked}">
			 <tr>
		 <td style="padding: 4px;"><nested:write  property="sectionName" /></td>
		 <td style="padding: 4px;"><nested:write  property="subjectName" /></td>
		 </tr>	

			</c:when>
			<c:when test="${list.tempPracticalChecked}">
			 <tr>
		<td style="padding: 4px;"><nested:write  property="sectionName" /></td>
		 <td style="padding: 4px;"><nested:write  property="subjectName" /></td>
		 </tr>	
