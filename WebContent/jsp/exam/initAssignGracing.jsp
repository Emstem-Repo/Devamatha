...
<html:form action="/examGraceMark" method="post">
	<html:hidden property="method" value="assigningGracing" />
	<html:hidden property="formName" value="examGracingForm" />
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td width="30%" class="row-even"><input type="hidden"
										id="yr" name="yr"
										value='<bean:write name="examGracingForm" property="academicYear"/>' />
									<html:select property="academicYear"
										styleId="academicYear" styleClass="combo">
										<html:option value="">
									...
									<td width="25%" class="row-even">
											<html:select property="schemeId" styleClass="combo"
								styleId="schemeId">
								<html:option value="">
									<bean:message key="knowledgepro.admin.select" />
								</html:option>
								...
								property="registerNumber" styleClass="TextBox"
								styleId="registerNumber" size="26" maxlength="50" /></td>
								<td width="20%" height="25" class="row-odd">
								<div align="right"><span class="Mandatory">*</span>Percentage:</div>
									</td>
									<td class="row-even" ><html:text
								property="percentage" styleClass="TextBox"
								styleId="percentage" size="26" maxlength="50" /></td>
								</tr>
								<tr>
								<td width="20%" height="25" class="row-odd">
								<div align="right"><span class="Mandatory">*</span>Remark:</div>
									</td>
									<td class="row-even" > <html:text
								property="remark" styleClass="TextBox"
								styleId="remark" size="26" maxlength="50" /></td>
								<td width="20%" height="25" class="row-odd">
								<div align="right"><span class="Mandatory">*</span>Only for passed subjects:</div>
									</td>
									<td class="row-even" > 
	                                   <html:radio property="onlyPass" value="false" >No &nbsp;&nbsp;</html:radio>
			                           <html:radio property="onlyPass" value="true"  >Yes</html:radio>									
									</td>
								</tr>
							</table>
							</td>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<table width="100%" cellspacing="1" cellpadding="2">
										...
										<logic:notEmpty name="examGracingForm"
											property="academicYearList">
											<logic:iterate id="academicYr" name="examGracingForm"
