...
<html:form action="/ProgressCard">
	...
	<html:hidden property="method" styleId="method" value="getStudentList" />
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<tr>
									<td height="25" width="25%" class="row-odd"><div align="right"><span class="Mandatory">*</span> <bean:message
									...
									<td width="25%" height="25" class="row-odd"><div align="right"><span class="Mandatory">*</span> Class :</div></td>
									<td width="25%" height="25" colspan="6" class="row-even">
								...
								<td width="20%" class="row-odd">
									...
									<html:text property="dynamicSize" name="adminMarksCardForm" styleClass="TextBox"></html:text>
