...
<SCRIPT>
	...
	function getSubjectsByExamName(examId){
		...
		if(document.getElementById("reg").checked){
			examType=document.getElementById("reg").value;
...
<html:form action="/ExamSecuredMarksVerification.do">
	...
	<html:hidden property="method" styleId="method" value="onSubmitGrid1" />
	...
	<table width="99%" border="0">
		...
		<tr>
			...
			&gt;&gt; Student Marks Verification Printing &gt;&gt;</span></span></td>
		...
		<tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					Marks Verification Printing</td>
						...
						<tr>
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								...
								<tr>
									...
									<div align="Center"><input type="radio" name="examType"
										id="reg" value="Regular" checked="checked"
										onchange="getExamName()" /> <script
										type="text/javascript">
	var examType = "__tag_177$26_";
	if (examType == "true") {
		document.getElementById("examType").checked = true;
	}
</script>
									Regular&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="examType" id="sup"
										value="Supplementary" onchange="getExamName()" />
									Supplementary&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="examType" id="int"
										value="Internal" onchange="getExamName()" />Internal
								...
								<td height="25" class="row-odd"><div align="right"><span class="Mandatory">*</span> <bean:message
									...
									<input
										...
										value="<bean:write name="ExamSecuredMarksVerificationForm" property="year"/>" />
									<html:select 
									...
									<td class="row-even" ><html:select
										...
										styleId="examName" styleClass="combo"
										onchange="getSubjectsByExamName(this.value)">
										<html:option value="">
									...
									<td class="row-even"><html:hidden property="dummyCheckBox"
										...
										styleId="check" onclick="getCheck(this.value)" /> <script
										type="text/javascript">
								...
								<tr>
									...
									<div align="left"><input type="radio" name="sCodeName"
										id="sCodeName_1" value="sCode" checked="checked"
										onclick= getSCodeName(this.value); /> Subject
									Code&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="sCodeName" id="sCodeName_2"
										value="sName" onclick= getSCodeName(this.value); /> Subject
									Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									</div>
									</td>
									<td colspan="2">
									...
									<table width="100%" height="100%">
										<tr>
											...
											<td class="row-even"><html:select property="schemeNo"
								...
								<tr>
									<td height="25" class="row-odd">
										<div align="right" id="divhide">Exam</div>
										</td>
										<td  class="row-even" colspan="4">
										<div id="divhide1">
										<html:radio property="isPreviousExam" name="ExamSecuredMarksVerificationForm" value="true" styleId="isPreviousExam_1">Previous</html:radio>
										<html:radio property="isPreviousExam" name="ExamSecuredMarksVerificationForm" value="false" styleId="isPreviousExam_2">Current</html:radio>
										</div>
		    						</td>
								</tr>
							</table>
