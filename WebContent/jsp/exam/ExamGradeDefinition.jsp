...
function editGD(id) {
	document.location.href = "ExamGradeDefinition.do?method=editGCD&id="+id;
...
function deleteGD(id,name) {
	...
	if(deleteConfirm)
	{
		document.location.href = "ExamGradeDefinition.do?method=deleteGCD&id="+id;
	}
}
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td background="images/Tcenter.gif" class="body" ><strong class="boxheader"> <bean:message key="knowledgepro.exam.gradeDefinition" /></strong></td>
            ...
            <td valign="top"><table width="100%" cellspacing="1" cellpadding="2">
              <tr >
                ...
                <td  height="5" class="row-even"><nested:select
										...
										<nested:optionsCollection name="ExamGradeDefinitionForm"
					...
					<td valign="top">
						<table width="100%" cellspacing="1" cellpadding="2">
							...
							<c:set var="temp" value="0" />
								<logic:iterate name="ExamGradeDefinitionForm" property="listExamCourseGroup" id="listExamCourseGroup" type="com.kp.cms.to.exam.KeyValueTO"	indexId="count">
								<c:choose>
	    							<c:when test="${temp == 0}">
									<tr>
