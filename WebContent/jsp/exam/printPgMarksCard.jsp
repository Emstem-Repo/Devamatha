...
<tr height="30px"></tr>
							<tr height="21px">
								<td  align="center" width="100%" fontsize="30" font-family= verdana><b> <bean:write name="loginform" property="marksCardTo.semString"/> SEMESTER <bean:write name="loginform" property="marksCardTo.ugorpg"/> EXAMINATION <bean:write name="loginform" property="marksCardTo.monthYear"/></b> </td>
...
<br/>
		...
		<tr>
			...
			<table class="row-print" width="167px" height="85px" align="left"
				border="1" rules="all">
				<tr>
					...
					<logic:iterate id="gradePointDefEntry" name="loginform"
						...
						<tr>
							<td colspan="1" class="row-print"><bean:write
								property="startPercentage" name="gradePointDefEntry" /> to <bean:write
								property="endPercentage" name="gradePointDefEntry" /></td>
							<td colspan="1" class="row-print"><bean:write
								property="grade" name="gradePointDefEntry" /> <logic:notEmpty
								property="interpretation" name="gradePointDefEntry"> - </logic:notEmpty>
							<bean:write property="interpretation" name="gradePointDefEntry" /></td>
