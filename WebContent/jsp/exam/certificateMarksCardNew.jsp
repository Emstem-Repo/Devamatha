						...
						<tr>
							...
							<tr>
								<td colspan="2">
						            ...
						            <tr height="21px">
									<td height="20" width="50%" class="studentrow-odd" align="left" ><span class="Mandatory">*</span>Results Type</td>
									<td height="20" width="50%" class="studentrow-even" align="left" class="tdIMGRegular">
									<html:radio property="resultType" styleId="resultType" value="Semester" name="loginform" onclick="getHideSuppExam()">Semester Result</html:radio>
									<html:radio property="resultType" styleId="resultType"  value="ProgramPart" name="loginform" onclick="getHideRegularExam()">Programme Part Result</html:radio>
								</td>
