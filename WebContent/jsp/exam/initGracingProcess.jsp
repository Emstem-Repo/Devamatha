...
<html:form action="/examGraceMark" method="post">
	<html:hidden property="method" value="gracingProcess" />
							...
							<table width="100%" cellspacing="1" cellpadding="2">
								<tr>
									...
									<td width="30%" class="row-even"><input type="hidden"
										id="yr2" name="yr2"
										value='<bean:write name="examGracingForm" property="appliedYear"/>' />
									<html:select property="appliedYear"
										styleId="appliedYear" styleClass="combo">
										<html:option value="">
