...
<script type="text/javascript">
	...
	function deleteModule(modId, modName) {
		...
		if (deleteConfirm == true) {
			document.location.href = "Modules.do?method=deleteModule&id="
					+ modId + "&name=" + modName;
		}
	}
	...
	/*
	function reActivate() {
		document.location.href = "Modules.do?method=ActivateModule";
...
<html:form action="/Modules" method="post" focus="modulename">
	<c:choose>
	...
	<html:hidden property="formName" value="moduleForm" />
					...
					<tr>
						...
						<tr>
							...
							<td width="19%" height="25" class="row-even"><html:text
								...
								size="16" maxlength="25" /> <span class="star"></span></td>
