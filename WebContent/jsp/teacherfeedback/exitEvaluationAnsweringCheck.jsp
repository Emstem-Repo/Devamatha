		...
		if( flag==1 )
		 {
			 alert("Please give feedback for all questions.");
			 	...
			 	document.getElementById("method").value="submitExitEvaluationDetails";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr >
					...
					<td background="images/st_Tcenter.gif" class="body"><strong
						class="boxheader">Exit Evaluation</strong></td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<table width="476" border="0" align="center">
						  <tbody>
						    <tr >
						      <td class="heading" height="50" align="left" style="font-size: 14px;color:#8B0000;"><b>Name of Student (Not Compulsory)</b></td>
						      <td style="font-size: 14px;color:#8B0000;">:</td>
						      <td class="heading" style="font-size: 14px;color:#8B0000;"><bean:write property="studentName" name="evaluationStudentFeedbackForm"/></td>
						    </tr>
						    <tr >
						      <td align="left" class="heading" style="font-size: 14px;color:#8B0000;"><b>Name of Programme Completed:</b></td>
						      <td style="font-size: 14px;color:#8B0000;">:</td>
						      <td class="heading" style="font-size: 14px;color:#8B0000;"><bean:write property="courseName" name="evaluationStudentFeedbackForm"/></td>
						    </tr>
						    </tbody>
						</table>
						<br/><br/>
									...
									<tr>
									  <logic:notEmpty name="evaluationStudentFeedbackForm" property="questionListTo">
											...
											<c:set var="count" value="0"></c:set>
												<nested:iterate id="list" name="evaluationStudentFeedbackForm" property="exitEvalQuestionList" indexId="count"> 
															...
															<td width="3%" class="heading" align="left" style="font-size: 12px;"><c:out value="${count + 1}."/></td>
							                   				<td width="42%" class="heading" style="font-size: 12px;"> <bean:write name="list" property="question"/></td>
							                   				<td width="55%" align="center" style="font-size: 12px;" >
							                   										<%
																					String id="answer1_"+count;
																					%>
							                   				<fieldset style="align:center;">							                   				
							                   				<input type="hidden" name="exitEvalQuestionList[<c:out value='${count}'/>].checked" id="value_<c:out value='${count}'/>"/>
							                   				<input type="radio" style="display:none;" id="answer_<c:out value='${count}'/>_1" name="exitEvalQuestionList[<c:out value='${count}'/>].checked" value="1" onclick="setCheckedValues(<c:out value='${count}'/>,this.value)"/>
											                ...
											                <input type="radio" style="display:none;" id="answer_<c:out value='${count}'/>_2" name="exitEvalQuestionList[<c:out value='${count}'/>].checked" value="2" onclick="setCheckedValues(<c:out value='${count}'/>,this.value)" />
											                ...
											                <input type="radio" style="display:none;" id="answer_<c:out value='${count}'/>_3" name="exitEvalQuestionList[<c:out value='${count}'/>].checked" value="3" onclick="setCheckedValues(<c:out value='${count}'/>,this.value)"/>
											                ...
											                <input type="radio" style="display:none;" id="answer_<c:out value='${count}'/>_4" name="exitEvalQuestionList[<c:out value='${count}'/>].checked" value="4" onclick="setCheckedValues(<c:out value='${count}'/>,this.value)"/>
											                ...
											                <input type="radio" style="display:none;" id="answer_<c:out value='${count}'/>_5" name="exitEvalQuestionList[<c:out value='${count}'/>].checked" value="5" onclick="setCheckedValues(<c:out value='${count}'/>,this.value)"/>
											                ...
											                Remark: &nbsp;&nbsp; <nested:text property="remark" styleId="<%=id %>"/> 
							                   				</fieldset>
							                   				</td>
															 </tr> 
										...
										<% if(CMSConstants.LINK_FOR_CJC){ %>
										 ...
										 <td width="65%"><html:textarea property="exitEvalAdditionalInfo" style="width: 83%" styleId="remarks" cols="80" rows="8" onkeypress="return imposeMaxLength1(this, 499);" onkeyup="len_display(this,0,'long_len')"></html:textarea>
										 ...
										 <td width="65%"><html:textarea property="exitEvalRemarks" style="width: 83%" styleId="remarks" cols="80" rows="8" onkeypress="return imposeMaxLength1(this, 499);" onkeyup="len_display1(this,0,'long_len1')"></html:textarea>
										...
										<%}else { %>
										 ...
										 <td width="65%"><html:textarea property="exitEvalRemarks" style="width: 83%" styleId="remarks" cols="80" rows="8" onkeypress="return imposeMaxLength1(this, 499);" onkeyup="len_display2(this,0,'long_len2')"></html:textarea>
						...
						<tr>
			                   ...
			                   <% if(CMSConstants.LINK_FOR_CJC){ %>
			                   	<html:button property="" value="Next" styleClass="classname" onclick="submitDetailsForCJC()" />&nbsp; <html:button property="" value="Close" styleClass="classname" onclick="cancelAction()"></html:button>
			                   <%}else{ %>
								<html:button property="" value="Next" styleClass="classname" onclick="submitDetails()" />&nbsp; <html:button property="" value="Close" styleClass="classname" onclick="cancelAction()"></html:button>
								<%} %>
								</div></td>
			                 </tr>
					</table>
