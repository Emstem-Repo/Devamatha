...
function editDetails(id){
	document.location.href = "evaTeacherFeedbackOpenConnection.do?method=editOpenConnectionDetails&id=" + id;
}
function deleteDetails(id){
	deleteConfirm = confirm("Are you sure you want to delete this entry?")
	if (deleteConfirm == true) {
		document.location.href = "evaTeacherFeedbackOpenConnection.do?method=deleteOpenConnection&id=" + id;
	}
}
function cancel() {
...
function getClassesAndSession(year){
	document.location.href = "evaTeacherFeedbackOpenConnection.do?method=getClassesAndSession&academicYear=" + year;	
}
function getDetailsBySessionId(sessionId){
	var year=document.getElementById("year").value;
	document.location.href = "evaTeacherFeedbackOpenConnection.do?method=getClassesAndSession&academicYear=" + year+"&sessionId="+sessionId;	
}
...
<html:form action="/evaTeacherFeedbackOpenConnection" method="POST">
<html:hidden property="formName" value="evaTeacherFeedbackOpenConnectionForm" />
...
<table width="99%" border="0">
  ...
  <tr>
    <td><span class="Bredcrumbs">Faculty Evaluation <span class="Bredcrumbs">&gt;&gt; Teacher Evaluation Open Session</span> </span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="heading_white" >Teacher Evaluation Open Session  </td>
        ...
        <td valign="top" class="news"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <% boolean disable=false;%>
					<logic:equal value="true" name="evaTeacherFeedbackOpenConnectionForm" property="flag">
							<% disable=true;%>
					</logic:equal>
              <tr >
              <td height="25" class="row-odd"><div align="right"><span class="Mandatory">*</span>&nbsp;<bean:message key="knowledgepro.admin.year" />:</div></td>
              <td align="left" height="25" class="row-even"><input type="hidden" id="tempyear" name="tempyear" 	value="<bean:write name="evaTeacherFeedbackOpenConnectionForm" property="academicYear"/>" />
			...
			<html:optionsCollection name="classMap" label="value" value="key" styleClass="comboBig" />
             ...
             <tr>
              ...
              <td align="left" width="30%" class="row-even"><input type="hidden" id="tempSession" name="tempSession" 	value="<bean:write name="evaTeacherFeedbackOpenConnectionForm" property="sessionId"/>" />
            ...
            <td align="left" width="30%" class="row-even"><input type="hidden" id="tempSpecializationId" name="tempSpecializationId" value="<bean:write name="evaTeacherFeedbackOpenConnectionForm" property="specializationId"/>" />
             ...
             <tr>
									...
									<td class="row-even" width="25%"><input type="hidden" id="startDate1" name="startDate1" value='<bean:write name="evaTeacherFeedbackOpenConnectionForm" property="startDate"/>'/>
									<html:text name="evaTeacherFeedbackOpenConnectionForm" property="startDate" styleId="startDate" size="10" maxlength="16"/>
									<script
									language="JavaScript">
									new tcal( {
										// form name
										'formname' :'evaTeacherFeedbackOpenConnectionForm',
										// input name
									...
									<input type="hidden" id="endDate1" name="endDate1" value='<bean:write name="evaTeacherFeedbackOpenConnectionForm" property="endDate"/>'/>
          ...
          <logic:notEmpty name="evaTeacherFeedbackOpenConnectionForm" property="openConnectionTo">
          <tr>
            <td height="45" colspan="4" ><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <logic:iterate id="CME" name="evaTeacherFeedbackOpenConnectionForm" property="openConnectionTo" indexId="count">
                <c:choose>
                   <c:when test="${temp == 0}">
                   	<tr>
