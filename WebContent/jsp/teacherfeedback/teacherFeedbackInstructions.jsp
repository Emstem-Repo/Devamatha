...
function addLeaveAppInstructions() {
	document.getElementById("method").value="addTeacherFeedbackInstructions";
}
...
function deleteInstructions(id) {
	...
	if(deleteConfirm)
		document.location.href = "teacherFeedbackInstruction.do?method=deleteTeacherFeedbackInstructions&id="+id;
}
...
function editInstructions(id){
	document.getElementById("NWID").value=id;
	document.location.href = "teacherFeedbackInstruction.do?method=editTeacherFeedbackInstructions&id="+id;
}
</script>
<html:form action="/teacherFeedbackInstruction" method="POST">
<html:hidden property="id" styleId="NWID"/>
<html:hidden property="formName" value="teacherFeedbackInstructionsForm" />
<html:hidden property="pageType" value="1" />
<c:choose>
		<c:when test=""></c:when>
	</c:choose>
	<c:choose>
		<c:when test="${instructions != null && instructions == 'edit'}">
			<html:hidden property="method" styleId="method" value="updateTeacherFeedbackInstructions" />
		</c:when>
		<c:otherwise>
			<html:hidden property="method" styleId="method" value="addTeacherFeedbackInstructions" />
		</c:otherwise>
	</c:choose>
<table width="99%" border="0">
  
  <tr>
    <td><span class="Bredcrumbs"><bean:message key="knowledgepro.teacherFeedBack"/> <span class="Bredcrumbs">&gt;&gt; Teacher Feedback Instructions &gt;&gt;</span> </span></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td background="images/Tcenter.gif" class="heading_white" >Teacher Feedback Instructions</td>
          ...
          <tr bgcolor="#FFFFFF">
            <td width="100%" height="20" colspan="4"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <c:choose>
								<c:when
									test="${instructions != null && instructions == 'edit'}">
          ...
          <tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <logic:notEmpty name="teacherFeedbackInstructionsForm" property="teacherFeedbackInsToList">
                <logic:iterate id="INS" name="teacherFeedbackInstructionsForm" property="teacherFeedbackInsToList" indexId="count">
                <c:choose>
                   <c:when test="${temp == 0}">
                   	<tr>
						...
						width="16" height="18" style="cursor:pointer" onclick="editInstructions('<bean:write name="INS" property="id"/>')"> </div> </td>
                   		<td width="6%" height="25" class="row-even" ><div align="center">
                   			<img src="images/delete_icon.gif" width="16" height="16" style="cursor:pointer" onclick="deleteInstructions('<bean:write name="INS" property="id"/>')"></div></td>
					</tr>
