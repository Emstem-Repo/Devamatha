...
<script type="text/javascript" language="javascript">
	function getClasses(){
		...
		getClassByAcademicYear("classMap" ,academicYear,"classes",updateClassNames);
	}
	...
	function getStudent(){
		...
		//document.location.href = "studentSemesterFeeDetails.do?method=getStudent";
	}
</script>
<html:form action="/UpdateStudentData" method="post">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="9"><img src="images/Tright_03_01.gif" width="9"
						height="29"></td>
					<td background="images/Tcenter.gif" class="heading_white">Update Student Data
					</td>
				...
				<tr>
					...
					<FONT color="red" size="1px"><bean:write name="updateStudentDataForm" property="errorMessage"/></FONT>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<tr>
									...
									<td width="25%" colspan="2" class="row-even" width="25%">
									<input
										type="hidden" id="tempyear" name="appliedYear"
										value="<bean:write name="updateStudentDataForm" property="academicYear"/>" />
									<html:select
										property="academicYear" styleClass="body"
										styleId="academicYear"  onchange="getClasses()">
									...
									<html:select property="classId"  name="updateStudentDataForm"  styleId="classes">
										<html:option value=""><bean:message key="knowledgepro.admin.select"/></html:option>
										<logic:notEmpty name="updateStudentDataForm" property="classMap">
											<html:optionsCollection property="classMap" name="updateStudentDataForm" label="value" value="key" />
										</logic:notEmpty>
									</html:select></td>
								</tr>
							</table>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<html:button property="" styleClass="formbutton" value="Search" onclick="getStudent()"></html:button></td>
