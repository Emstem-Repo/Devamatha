		...
		if( flag==1 )
		 {
			 ...
			 alert("Please give remarks");
			 	...
			 	document.getElementById("method").value="submitFacultyAndAubjectWiseEvaluationDetails";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr >
					...
					<td background="images/st_Tcenter.gif" class="body"><strong
						class="boxheader">Subject Evaluation</strong></td>
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						cellspacing="0">
		                <tr>
						<td align="left" class="heading"><bean:write property="subjectNo" name="evaluationStudentFeedbackForm" /> of Subjects <bean:write property="studentFeedbackSubjectWiseTotalSubjects" name="evaluationStudentFeedbackForm"/></td>
						</tr>
						<tr><td>
						...
						<tr>
							<td>
								<table width="100%" border="1"  cellpadding="2" cellspacing="1" >
									<tr>
									   <logic:notEmpty name="evaluationStudentFeedbackForm" property="questionListSubjectWiseTo">
											<td width="50%" valign="top" bgcolor="#E3EBE5" >
											<c:set var="count1" value="0"></c:set>
												<nested:iterate id="qun" name="evaluationStudentFeedbackForm" property="questionListSubjectWiseTo" indexId="count"> 
															...
															<td width="3%" class="heading" align="left" style="font-size: 12px;"><c:out value="${count + 1}."/></td>
							                   				...
							                   				<input type="hidden" name="questionListSubjectWiseTo[<c:out value='${count}'/>].checked" id="value_<c:out value='${count}'/>"/>
							                   				<input type="radio" style="display:none;" id="answer_<c:out value='${count}'/>_1" name="questionListSubjectWiseTo[<c:out value='${count}'/>].checked" value="1" onclick="setCheckedValues(<c:out value='${count}'/>,this.value)"/>
											                ...
											                <input type="radio" style="display:none;" id="answer_<c:out value='${count}'/>_2" name="questionListSubjectWiseTo[<c:out value='${count}'/>].checked" value="2" onclick="setCheckedValues(<c:out value='${count}'/>,this.value)" />
											                ...
											                <input type="radio" style="display:none;" id="answer_<c:out value='${count}'/>_3" name="questionListSubjectWiseTo[<c:out value='${count}'/>].checked" value="3" onclick="setCheckedValues(<c:out value='${count}'/>,this.value)"/>
											                ...
											                <input type="radio" style="display:none;" id="answer_<c:out value='${count}'/>_4" name="questionListSubjectWiseTo[<c:out value='${count}'/>].checked" value="4" onclick="setCheckedValues(<c:out value='${count}'/>,this.value)"/>
											                ...
											                <input type="radio" style="display:none;" id="answer_<c:out value='${count}'/>_5" name="questionListSubjectWiseTo[<c:out value='${count}'/>].checked" value="5" onclick="setCheckedValues(<c:out value='${count}'/>,this.value)"/>
