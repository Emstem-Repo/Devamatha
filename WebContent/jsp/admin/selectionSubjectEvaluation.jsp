...
<link rel="stylesheet" type="text/css" href="css/styles.css"/>
	...
	function cancelAction() {
		closeConfirm = confirm("Are you sure you want to close the Faculty Evaluation and Subject Evaluation?");
...
<html:hidden property="method" styleId="method" value="getSubjectWiseAnsweringCheck" />
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						cellspacing="0">
						<tr>
						 <logic:notEmpty name="evaluationStudentFeedbackForm" property="studentFeedbackSubjectWise">
            <td valign="top" class="news">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <logic:iterate id="eva" name="evaluationStudentFeedbackForm" property="studentFeedbackSubjectWise" indexId="count">
                ...
                <tr class="row-white" >
			                   ...
			                   <td colspan="3" height="50"><div align="center">
								<html:submit value="Start" styleClass="classname"></html:submit>&nbsp; <html:button property="" value="Close" styleClass="classname" onclick="cancelAction()"></html:button>
								</div></td>
        	...
        	<logic:empty name="evaluationStudentFeedbackForm" property="studentFeedbackSubjectWise">
          ...
          <tr>
				<td height="26"></td>
				 <td  height="60"><div align="center">
								 <html:button property="" styleClass="classname" value="Close"  onclick="cancelAction()"></html:button>
								</div></td>
								<td  ></td>
			</tr>
