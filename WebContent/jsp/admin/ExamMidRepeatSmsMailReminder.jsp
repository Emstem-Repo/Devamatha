...
<table width="100%" border="0">
  <tr>
	...
	<td><span class="Bredcrumbs"><bean:message key="knowledgepro.admin" /><span class="Bredcrumbs">&gt;&gt;
			SMS, Mail Fee Payment Reminder &gt;&gt;</span></span></td>  
    <td valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        <td width="9"><img src="images/Tright_03_01.gif" width="9" height="29"></td>
        <td width="100%" background="images/Tcenter.gif" class="body" ><strong class="boxheader"> SMS, Mail Fee Payment Reminder</strong></td>
      ...
      <tr>
        ...
        <td height="20" valign="top" background="images/Tright_03_03.gif"></td>
        <td class="heading">
			SMS, Mail Fee Payement Reminder Sent<br>
